...
```mermaid
flowchart TD
    A[01 - Introduction & Setup<br/>Giao diện, navigation, vật liệu, ánh sáng] --> B[02 - Modular Dungeon<br/>Box modelling, bevel, mirror modifier]
    B --> C[03 - Low-Poly Dinosaur<br/>Modelling từ reference, shader nodes]
