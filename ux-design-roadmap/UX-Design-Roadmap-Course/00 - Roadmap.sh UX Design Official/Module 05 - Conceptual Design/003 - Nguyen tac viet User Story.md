# 003 - Nguyên tắc viết User Story
...
## 1. Tóm tắt
Bài này tập trung vào **Nguyên tắc viết User Story** trong lộ trình UX Design. Sau bài học, bạn nên hiểu ý nghĩa của khái niệm, biết khi nào dùng nó và tạo được một artifact nhỏ để áp dụng vào project cuối khóa.

## 2. Mục tiêu học tập
- Chuyển **Nguyên tắc viết User Story** thành yêu cầu, user story hoặc flow rõ ràng.
...
- Tôi có thể giải thích **Nguyên tắc viết User Story** cho một người mới học UX không?
...
## 7. Tổng kết
**Nguyên tắc viết User Story** là một mảnh trong quy trình UX từ hiểu người dùng đến đo lường tác động. Hãy gắn bài học với một artifact cụ thể để kiến thức không dừng ở lý thuyết.
