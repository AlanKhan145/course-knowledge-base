...
## 1. Tóm tắt
Bài này tập trung vào **Dual Process Theory** trong lộ trình UX Design. Sau bài học, bạn nên hiểu ý nghĩa của khái niệm, biết khi nào dùng nó và tạo được một artifact nhỏ để áp dụng vào project cuối khóa.

## 2. Mục tiêu học tập
- Giải thích được **Dual Process Theory** trong bối cảnh ra quyết định của người dùng.
...
- Tôi có thể giải thích **Dual Process Theory** cho một người mới học UX không?
...
## 7. Tổng kết
**Dual Process Theory** là một mảnh trong quy trình UX từ hiểu người dùng đến đo lường tác động. Hãy gắn bài học với một artifact cụ thể để kiến thức không dừng ở lý thuyết.
