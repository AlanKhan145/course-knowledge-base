[![Diet and Nutrition Coach Certification: Online Certificate | Udemy](https://images.openai.com/static-rsc-4/I-G3Y_XNEwQXoZiFMiToLAOjC8AMRWpDanV0WAw3dapvvC8X2uAC-PmOr460uDDsKD7FwGhtAkObjr8OZGY6LwvTMks2wA2hnJbFlLY6gNbg1PPTVzG6k1U5SCeDntk0pe1K_jHhw6ZAnYIBKAnP8_fGHUMsy8De-TjNVEe_MiA?purpose=inline)](https://www.udemy.com/course/diet-nutrition-coach-certification-beginner-to-advanced/?srsltid=AfmBOorrsiY-Z4Iy7S1v8jOrRT6vaDfhrtPBhhzXPcvKc0YXLol4S538&utm_source=chatgpt.com)
...
```mermaid
flowchart LR
    A["Thiếu niên gầy<br/>khoảng 185 cm — 68 kg"]
    B["Sao chép bạn bè<br/>trong phòng gym"]
    C["Ít kết quả<br/>không cải thiện dinh dưỡng"]
    D["Bắt đầu nghiên cứu<br/>tập luyện và dinh dưỡng"]
    E["Bulking<br/>tăng sức mạnh và cơ bắp"]
    F["Ăn dư quá nhiều<br/>tăng thêm nhiều mỡ"]
    G["Cutting<br/>giảm mỡ và giữ cơ"]
    H["Gặp trở ngại<br/>và những lần chững lại"]
    I["Chuyển sang phương pháp<br/>đơn giản và bền vững"]
    J["Xây dựng chương trình riêng<br/>và hướng dẫn người khác"]
...
```mermaid
flowchart TD
    A["Bằng chứng khoa học<br/>nghiên cứu, tổng quan, hướng dẫn chuyên môn"]
    B["Kinh nghiệm chuyên môn<br/>làm việc với nhiều học viên"]
    C["Kinh nghiệm cá nhân<br/>điều từng xảy ra với một người"]

    A --> D["Quyết định thực tế"]
    B --> D
    C --> D

    D --> E["Điều chỉnh theo<br/>mục tiêu, sở thích và sức khỏe cá nhân"]
```
