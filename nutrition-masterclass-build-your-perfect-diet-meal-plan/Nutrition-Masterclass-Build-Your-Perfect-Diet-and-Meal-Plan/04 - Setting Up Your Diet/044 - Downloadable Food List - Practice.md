...
```mermaid
flowchart TD
    A[Macronutrient Food List] --> B[Nguồn protein]
    A --> C[Nguồn carbohydrate]
    A --> D[Nguồn chất béo]

    B --> B1[Trứng]
    B --> B2[Thịt nạc]
    B --> B3[Ức gà]
    B --> B4[Đậu và các loại đậu]
    B --> B5[Cá và hải sản]
    B --> B6[Đậu nành]

    C --> C1[Ngũ cốc nguyên hạt]
    C --> C2[Đậu và các loại đậu]
    C --> C3[Trái cây]
    C --> C4[Khoai]
    C --> C5[Rau và salad]

    D --> D1[Chất béo bão hòa]
    D --> D2[Chất béo không bão hòa]
```
...
```mermaid
flowchart LR
    A[Chọn nguồn carbohydrate] --> B{Loại thực phẩm}

    B --> C[Ngũ cốc nguyên hạt]
    B --> D[Đậu và các loại đậu]
    B --> E[Trái cây]
    B --> F[Khoai]
    B --> G[Rau và salad]
    ...
    C --> C2[Gạo]
    C --> C3[Quinoa]
    C --> C4[Mì hoặc bánh mì nguyên hạt]
```
...
```mermaid
flowchart TD
    A[Thực phẩm] --> B[Có thể cung cấp nhiều macronutrient]
...
```mermaid
flowchart LR
    A[Chọn protein chính] --> B[Chọn carbohydrate]
    B --> C[Thêm rau hoặc salad]
    C --> D[Chọn nguồn chất béo]
