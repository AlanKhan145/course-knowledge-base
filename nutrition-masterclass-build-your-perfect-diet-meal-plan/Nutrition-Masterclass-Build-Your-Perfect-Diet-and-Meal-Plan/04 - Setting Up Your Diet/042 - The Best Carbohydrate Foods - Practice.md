[![New U.S. nutrition guidance emphasizes importance of healthier eating | American Heart Association](https://images.openai.com/static-rsc-4/208L7PzDPD331NtRNMmBcHvWIhMp4AgTZem-99eYWrS55x22jwgRqB2n8gjSJKQsCGsVNTVbCqTMXTSF6rwjIACXbFD7-lBA1nRr5_cNgxgrs2yrOopxjd6-xwdYGFqTFJ9UHuTtP_cdDW_XwBX3s59ypZB1Rj29iD5ZdfF73H8?purpose=inline)](https://www.heart.org/en/around-the-aha/new-us-nutrition-guidance-emphasizes-importance-of-healthier-eating?utm_source=chatgpt.com)
...
![Các nguồn carbohydrate giàu chất xơ gồm trái cây, rau củ, ngũ cốc và đậu](https://commons.wikimedia.org/wiki/Special\:FilePath/Fruit%2C%20Vegetables%20and%20Grain%20NCI%20Visuals%20Online.jpg?width=1200)
...
```mermaid
flowchart TD
    A[Nguồn carbohydrate] --> B[Ngũ cốc nguyên hạt]
    A --> C[Trái cây nguyên quả]
    A --> D[Các loại đậu]
    A --> E[Rau củ giàu tinh bột]

    B --> B1[Yến mạch]
    B --> B2[Gạo lứt]
    B --> B3[Bánh mì nguyên cám]
    B --> B4[Mì nguyên cám]
...
```mermaid
flowchart TD
    A[Chọn một thực phẩm carbohydrate] --> B{Có phải thực phẩm nguyên chất hoặc ít chế biến?}

    B -->|Có| C{Có chất xơ, vitamin hoặc khoáng chất?}
    B -->|Không| D[Kiểm tra kỹ nhãn thành phần]

    C -->|Có| E{Có nhiều đường bổ sung không?}
    C -->|Không đáng kể| F[Có thể dùng nhưng nên kết hợp với thực phẩm giàu dinh dưỡng]

    E -->|Không hoặc ít| G[Lựa chọn ưu tiên]
    E -->|Có nhiều| H[Giới hạn tần suất hoặc khẩu phần]

    D --> I{Ngũ cốc nguyên hạt có đứng đầu danh sách không?}
    I -->|Có| G
    I -->|Không| H
```
...
![Biểu đồ rừng về lượng ngũ cốc nguyên hạt và nguy cơ tử vong do mọi nguyên nhân](https://oncotarget-cdn.atl1.digitaloceanspaces.com/article/11491/figure/173772/11491-173772-1-PB.jpg)
