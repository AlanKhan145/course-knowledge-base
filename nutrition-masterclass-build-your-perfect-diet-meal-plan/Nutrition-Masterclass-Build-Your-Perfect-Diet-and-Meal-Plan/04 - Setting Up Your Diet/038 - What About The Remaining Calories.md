...
![Minh họa ba chất dinh dưỡng đa lượng và lượng calorie trên mỗi gram](https://groups.oist.jp/sites/default/files/imce/u111828/Macros-101.png)
...
```mermaid
flowchart TD
    A[Tổng mục tiêu: 2.600 kcal] --> B[Protein: 145 g]
    A --> C[Chất béo: 60 g]
    A --> D[Carbohydrate: 270 g]

    B --> E[580 kcal]
    C --> F[540 kcal]
    D --> G[1.080 kcal]

    E --> H[Tổng đã dùng: 2.200 kcal]
    F --> H
    G --> H

    H --> I[Còn lại: 400 kcal]
    I --> J[Thêm carbohydrate]
    I --> K[Thêm chất béo]
    I --> L[Kết hợp carbohydrate và chất béo]
```
...
![Biểu đồ meta-regression giữa lượng protein và thay đổi khối không mỡ](https://bjsm.bmj.com/content/bjsports/early/2018/01/18/bjsports-2017-097608/F5.large.jpg)
...
![Nguồn carbohydrate và chất béo có thể dùng để hoàn thiện khẩu phần](https://kintore123.com/wp-content/uploads/2025/10/batch_Image_fx-3-47.jpg)
...
```mermaid
flowchart TD
    A[Đã đáp ứng protein?] -->|Chưa| B[Tăng protein đến mức phù hợp]
    A -->|Rồi| C[Đã đáp ứng chất béo tối thiểu?]

    C -->|Chưa| D[Bổ sung chất béo từ nguồn phù hợp]
    C -->|Rồi| E{Mục tiêu ưu tiên là gì?}

    E -->|Hiệu suất tập luyện| F[Ưu tiên carbohydrate]
    E -->|Khó ăn đủ calorie| G[Tăng một phần chất béo]
    E -->|Muốn cân bằng| H[Kết hợp carbohydrate và chất béo]
    E -->|Khó tiêu hóa| I[Chọn nguồn dung nạp tốt hơn]

    F --> J[Theo dõi 2–3 tuần]
    G --> J
    H --> J
    I --> J

    J --> K[Đánh giá cân nặng, cảm giác đói và hiệu suất]
```
