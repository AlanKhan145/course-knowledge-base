[![Postprandial Aminoacidemia Following the Ingestion of Alternative and Sustainable Proteins in Humans: A Narrative Review | MDPI](https://images.openai.com/static-rsc-4/WKXL-K4izFOh1qRZ6wZsJ07tEF7NccfbS1zVkQ_IrYM0peTjuA8WjXOhylyhmehf3rd3Q8KsDihS2qhLEsyCR8JBqJvT78cA0CpaTvjTVB8TvXEkhfAbBeoUUr3GWUgVTNOVi1K-gE0Qj0i9o5iqUz8mI7-KuOQDCb6rcxCRgzk?purpose=inline)](https://www.mdpi.com/2072-6643/17/2/211?utm_source=chatgpt.com)
...
![Các nguồn thực phẩm giàu protein](https://commons.wikimedia.org/wiki/Special\:FilePath/Protein-rich_Foods.jpg)
...
```mermaid
flowchart TD
    A[Nhập cân nặng cơ thể] --> B{Mức độ tập luyện?}

    B -->|Người mới hoặc hoạt động vừa| C[Chọn khoảng 0,8 g/lb]
    B -->|Tập thường xuyên, khối lượng cao| D[Chọn 0,8–0,9 g/lb]
    B -->|Rất nạc và tập cường độ cao| E[Chọn gần 1 g/lb]

    C --> F[Tính tổng protein mỗi ngày]
    D --> F
    E --> F

    F --> G[Theo dõi trong 2–4 tuần]
    G --> H{Có duy trì được đều đặn?}
    H -->|Có| I[Tiếp tục]
    H -->|Không| J[Giảm về mức dễ tuân thủ hơn]
```
...
![Tập kháng lực và tổng hợp protein cơ](https://commons.wikimedia.org/wiki/Special\:FilePath/Resistance_exercise-induced_muscle_protein_synthesis.jpg)
...
```mermaid
flowchart LR
    A[Tổng calorie phù hợp] --> D[Kết quả dài hạn]
    B[Đủ protein] --> D
    C[Tập luyện có tiến bộ] --> D
    E[Ngủ và phục hồi] --> D
```
