...
![Minh họa sử dụng công cụ trực tuyến để lập kế hoạch calorie và cân nặng](https://newsinhealth.nih.gov/sites/newsinhealth/files/2016/January/illustration-man-working-laptop_0.jpg)
...
```mermaid
flowchart LR
    A[Calorie nạp vào] --> C{So sánh với TDEE}
    B[TDEE<br/>Calorie tiêu hao] --> C

    C -->|Nạp vào ≈ TDEE| D[Cân bằng trung tính<br/>Cân nặng có xu hướng ổn định]
    C -->|Nạp vào < TDEE| E[Thâm hụt calorie<br/>Cân nặng có xu hướng giảm]
    C -->|Nạp vào > TDEE| F[Thặng dư calorie<br/>Cân nặng có xu hướng tăng]
```
...
![Sơ đồ nghiên cứu về các thành phần của tổng năng lượng tiêu hao hằng ngày](https://www.frontiersin.org/files/Articles/97566/xml-images/fnut-01-00005-g001.webp)
...
```mermaid
flowchart TD
    A[Ước tính TDEE ban đầu] --> B[Ăn gần mức đó trong 10–14 ngày]
    B --> C[Cân trong điều kiện giống nhau]
    C --> D[Tính trung bình cân nặng theo tuần]
    D --> E{Xu hướng cân nặng}

    E -->|Đang giảm| F[TDEE thật có thể cao hơn lượng đang ăn<br/>Tăng khoảng 100 kcal]
    E -->|Đang tăng| G[TDEE thật có thể thấp hơn lượng đang ăn<br/>Giảm khoảng 100 kcal]
    E -->|Gần ổn định| H[Đã tìm được mức maintenance gần đúng]
