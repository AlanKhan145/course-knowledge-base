...
![Tập kháng lực với tạ đòn](https://commons.wikimedia.org/wiki/Special\:FilePath/Bench%20Press.jpg?width=1200)
...
```mermaid
flowchart LR
    A[Tập kháng lực] --> D[Kích thích thích nghi]
    B[Dinh dưỡng đầy đủ] --> D
    C[Ngủ và phục hồi] --> D
    D --> E[Tăng sức mạnh]
    D --> F[Tăng kích thước cơ]
    E --> G[Tiếp tục quá tải tăng tiến]
    F --> G
    G --> A
```
...
| ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| ![Barbell squat](https://commons.wikimedia.org/wiki/Special\:FilePath/Barbell%20pad%20back%20squat.jpg?width=600) | ![Bench press](https://commons.wikimedia.org/wiki/Special\:FilePath/Bench%20Press.jpg?width=600)                            |
| **Deadlift**                                                                                                      | **Overhead press**                                                                                                          |
| ![Deadlift](https://commons.wikimedia.org/wiki/Special\:FilePath/Deadlift.JPG?width=600)                          | ![Overhead press](https://commons.wikimedia.org/wiki/Special\:FilePath/How%20to%20do%20an%20Overhead%20Press.jpg?width=600) |
...
```mermaid
flowchart TD
    A[Chọn mức tạ làm được khoảng 6 lần mỗi hiệp] --> B[Tập và ghi lại kết quả]
    B --> C{Đạt 10 lần ở cả 3 hiệp<br/>với kỹ thuật tốt?}
    C -- Chưa --> D[Giữ nguyên mức tạ<br/>cố gắng tăng 1–2 lần lặp]
    D --> B
    C -- Rồi --> E[Tăng tạ khoảng 2,5–5%]
    E --> F[Quay lại khoảng 6–8 lần mỗi hiệp]
    F --> B
```
...
![Các thực phẩm giàu protein](https://commons.wikimedia.org/wiki/Special\:FilePath/Protein-rich%20Foods.jpg?width=1200)
...
```mermaid
flowchart LR
    A[Buổi tập] --> B[Tín hiệu thích nghi]
    B --> C[Tổng hợp protein cơ tăng]
    D[Protein và năng lượng] --> C
    E[Ngủ và ngày nghỉ] --> C
    C --> F[Phục hồi]
    F --> G[Cơ khỏe và lớn hơn theo thời gian]
```
...
```mermaid
flowchart TD
    A[Theo dõi 2–3 tuần] --> B{Cân nặng và sức mạnh có tăng?}
    B -- Có, vòng eo ổn định --> C[Giữ nguyên calorie]
    B -- Không thay đổi --> D[Tăng khoảng 100–150 kcal/ngày]
    B -- Tăng cân quá nhanh,<br/>vòng eo tăng mạnh --> E[Giảm khoảng 100–200 kcal/ngày]
    C --> A
    D --> A
    E --> A
```
