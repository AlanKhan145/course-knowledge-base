...
![Muối ăn là nguồn natri phổ biến](https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Table_salt_with_salt_shaker_V1.jpg/960px-Table_salt_with_salt_shaker_V1.jpg)
...
```mermaid
flowchart TD
    A[Natri Na⁺ chủ yếu ở ngoài tế bào] --> B[Chênh lệch điện thế màng]
    B --> C[Dẫn truyền xung thần kinh]
    B --> D[Kích hoạt hoạt động cơ]

    A --> E[Áp suất thẩm thấu]
    E --> F[Cân bằng nước và dịch ngoại bào]
    F --> G[Thể tích tuần hoàn và huyết áp]

    A --> H[Chênh lệch nồng độ Na⁺]
    H --> I[Vận chuyển glucose và axit amin qua màng]
```

### 2.5. Bơm natri–kali

![Sơ đồ bơm natri–kali qua màng tế bào](https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/0308_Sodium_Potassium_Pump.jpg/960px-0308_Sodium_Potassium_Pump.jpg)
...
```mermaid
flowchart LR
    A[Đọc nhãn] --> B[Xác định nguồn natri lớn nhất]
    B --> C[Thay một món mỗi tuần]
    C --> D[Giảm dần gia vị mặn]
    D --> E[Theo dõi huyết áp và duy trì]
```
