...
![Các thực phẩm giàu phốt pho như cá, thịt, sữa, trứng, hạt và đậu](https://images.surferseo.art/5ee88659-ee70-4302-858d-5e1d47bc9b3a.png)
...
```mermaid
flowchart LR
    A[Phốt pho từ thực phẩm] --> B[Hấp thu dưới dạng phosphate]
    B --> C[Máu và dịch cơ thể]
    C --> D[ATP và chuyển hóa năng lượng]
    C --> E[DNA, RNA và màng tế bào]
    C --> F[Kết hợp với canxi]
    F --> G[Hydroxyapatite]
    G --> H[Xương và răng]
    C --> I[Thận điều chỉnh và bài tiết lượng dư]
```

![Sơ đồ hình thành và điều hòa hydroxyapatite](https://media.springernature.com/m312/springer-static/image/art%3A10.1038%2Fs41574-022-00682-7/MediaObjects/41574_2022_682_Fig1_HTML.png)
