...
[![Vitamins & Minerals from Food Sources](https://images.openai.com/static-rsc-4/wiD58HxCp_auWRBU3ZNCENqqBiiFCIeqXygOjlYONVk-QJZhU-caUgM1UHEHl_eq9UpfrXihQTKTM4ug8FZ0DVDkGcopKGc223QaKs9oXmicgx7MrOXsFEBwOtN9v4Yqku0rLvEHwIRxE7hmyoBryGwP2_vqANSYBMwamo3UCxk?purpose=inline)](https://www.m-pathnaturopathy.com.au/post/vitamins-minerals-from-food-sources?utm_source=chatgpt.com)
| Thuộc tính       | Nội dung                         |
| ---------------- | -------------------------------- |
...
![Sơ đồ các nhóm chất dinh dưỡng](https://upload.wikimedia.org/wikipedia/commons/d/d2/Food_Nutrient_Group_Chart.png)
...
```mermaid
flowchart TD
    A[Vi chất dinh dưỡng] --> B[Vitamin]
    A --> C[Khoáng chất]

    B --> B1[Vitamin tan trong nước]
    B --> B2[Vitamin tan trong chất béo]

    B1 --> B3[Vitamin nhóm B và vitamin C]
    B2 --> B4[Vitamin A, D, E, K]

    C --> C1[Khoáng chất đa lượng]
    C --> C2[Khoáng chất vi lượng]

    C1 --> C3[Canxi, phospho, magie, natri, kali, chloride]
    C2 --> C4[Sắt, kẽm, đồng, iod, selenium, mangan...]
```
...
```mermaid
flowchart LR
    A[Khẩu phần thiếu hoặc hấp thu kém] --> B[Dự trữ vi chất giảm]
    B --> C[Enzyme và quá trình sinh lý hoạt động kém]
    C --> D[Mệt mỏi, giảm miễn dịch hoặc giảm hiệu suất]
    D --> E[Thiếu hụt kéo dài và bệnh lý]
```
...
![Bản đồ minh họa tỷ lệ thiếu vitamin A ở trẻ em](https://upload.wikimedia.org/wikipedia/commons/e/e5/Prevalence-of-vitamin-a-deficiency-in-children.png)
...
```mermaid
flowchart LR
    A[Chọn nguồn protein] --> B[Thêm rau củ đa dạng]
    B --> C[Thêm carbohydrate ít tinh chế]
    C --> D[Thêm chất béo phù hợp]
    D --> E[Luân phiên thực phẩm trong tuần]
```
