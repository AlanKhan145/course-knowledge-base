...
![Các thực phẩm tự nhiên cung cấp vitamin C như ớt chuông, bông cải xanh và trái cây họ cam quýt](https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Crate_of_fruit_and_vegetables.jpg/960px-Crate_of_fruit_and_vegetables.jpg)
...
![Cấu trúc hóa học của axit ascorbic — vitamin C](https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Ascorbic_acid_structure.svg/500px-Ascorbic_acid_structure.svg.png)
...
```mermaid
flowchart TD
    A[Thực phẩm chứa vitamin C] --> B[Vitamin C được hấp thu]
    B --> C[Chống oxy hóa]
    B --> D[Tổng hợp collagen]
    B --> E[Hỗ trợ chức năng miễn dịch]
    B --> F[Tăng hấp thu sắt không heme]
    B --> G[Tạo L-carnitine và một số chất dẫn truyền thần kinh]

    D --> H[Da và mô liên kết]
    D --> I[Mạch máu và nướu]
    D --> J[Lành vết thương]

    F --> K[Hỗ trợ phòng thiếu sắt]
```
...
```mermaid
flowchart LR
    A[Rau củ tươi] --> B{Phương pháp chế biến}
    B -->|Ăn sống phù hợp| C[Giữ lại nhiều vitamin C]
    B -->|Hấp hoặc vi sóng nhanh| D[Thất thoát tương đối thấp]
    B -->|Luộc lâu nhiều nước| E[Thất thoát cao hơn]
    B -->|Bảo quản quá lâu| F[Vitamin C giảm dần]
```
