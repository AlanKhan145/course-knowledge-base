...
![Các thực phẩm giàu đồng: hải sản có vỏ, gan, các loại hạt, cacao và ngũ cốc](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/ARS_copper_rich_foods.jpg/960px-ARS_copper_rich_foods.jpg)
...
```mermaid
flowchart LR
    A[Đồng trong khẩu phần] --> B[Hấp thu ở ruột non]
    B --> C[Gan]
    C --> D[Ceruloplasmin]
    D --> E[Chuyển Fe²⁺ thành Fe³⁺]
    E --> F[Sắt gắn với transferrin]
    F --> G[Tủy xương sử dụng sắt]
    G --> H[Tổng hợp hemoglobin và hồng cầu]
```
...
![Cơ chế vận chuyển đồng trong tế bào và tế bào gan](https://www.frontiersin.org/files/Articles/711227/xml-images/fmolb-08-711227-g001.webp)
...
mindmap
  root((Đồng))
    Vai trò
      ...
      Chống oxy hóa
    Nhu cầu
      Người lớn 900 µg/ngày
      Thai kỳ 1000 µg/ngày
      Cho con bú 1300 µg/ngày
      UL người lớn 10 mg/ngày
    Nguồn
      Hải sản có vỏ
      Gan
      Các loại hạt
