...
[![Exploring Vitamin D Synthesis and Function in Cardiovascular Health: A Narrative Review](https://tse2.mm.bing.net/th/id/OIP.zq3HexHy_YqgpajHjxOKjwHaFt?r=0\&pid=Api)](https://www.mdpi.com/2076-3417/14/11/4339?utm_source=chatgpt.com)
...
```mermaid
flowchart LR
    A["Tia UVB từ ánh nắng"] --> B["Da: 7-dehydrocholesterol"]
    B --> C["Vitamin D₃"]
    D["Vitamin D₂/D₃ từ thức ăn hoặc viên bổ sung"] --> E["Máu"]
    C --> E
    E --> F["Gan"]
    F --> G["25(OH)D — calcidiol"]
    G --> H["Thận và một số mô"]
    H --> I["1,25(OH)₂D — calcitriol hoạt động"]
    I --> J["Tăng hấp thu canxi và phospho"]
    I --> K["Hỗ trợ xương, cơ, thần kinh và miễn dịch"]
```
...
![Sơ đồ tổng hợp vitamin D tại da và hoạt hóa ở gan, thận](https://commons.wikimedia.org/wiki/Special\:Redirect/file/614_Synthesis_of_Vitamin_D.jpg)

*Nguồn ảnh: OpenStax College, giấy phép CC BY 3.0.* ([Wikimedia Commons][2])

#### Ảnh khoa học: sinh tổng hợp vitamin D₂ và D₃

![Sơ đồ sinh tổng hợp vitamin D2 và vitamin D3](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Vitamin_D_biosynthesis.svg)
...
```mermaid
flowchart TD
    A["Duy trì vitamin D"] --> B["Thực phẩm"]
    A --> C["Hoạt động ngoài trời an toàn"]
    A --> D["Viên bổ sung khi cần"]
    B --> B1["Cá béo, trứng, nấm UV"]
    B --> B2["Sữa hoặc thực phẩm được tăng cường"]
    C --> C1["Không để cháy nắng"]
    D --> D1["Đúng đối tượng và đúng liều"]
    D --> D2["Theo chỉ định nếu đang điều trị thiếu"]
```
...
```mermaid
flowchart TD
    A["Bạn có khỏe mạnh và không thuộc nhóm nguy cơ?"] -->|Có| B["Đáp ứng lượng khuyến nghị; thường không cần xét nghiệm định kỳ"]
    A -->|Không| C["Có bệnh lý, nguy cơ cao hoặc dấu hiệu lâm sàng?"]
    C -->|Có| D["Trao đổi với bác sĩ về xét nghiệm 25(OH)D"]
    D --> E["Nếu thiếu: điều trị và theo dõi theo chỉ định"]
    C -->|Không rõ| F["Đánh giá chế độ ăn, thuốc đang dùng và mức tiếp xúc ánh nắng"]
```
