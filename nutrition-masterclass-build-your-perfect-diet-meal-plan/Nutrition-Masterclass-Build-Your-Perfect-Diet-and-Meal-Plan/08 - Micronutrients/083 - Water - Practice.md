...
![Vai trò của nước đối với cơ thể](https://d9-wret.s3.us-west-2.amazonaws.com/assets/palladium/production/s3fs-public/thumbnails/image/wss-property-water-in-you-body.png)
...
```mermaid
flowchart LR
    A[Tổng lượng nước hấp thụ] --> B[Nước lọc]
    A --> C[Đồ uống khác]
    A --> D[Nước trong thực phẩm]
    ...
    D --> D1[Rau củ]
    D --> D2[Trái cây]
    D --> D3[Cơm, thịt và thực phẩm chế biến]
```
...
```mermaid
flowchart TD
    A[Bắt đầu ngày hoặc buổi tập] --> B{Có nóng, vận động mạnh hoặc đang bệnh?}
    B -- Không --> C[Uống theo khát và trong bữa ăn]
    B -- Có --> D[Lập kế hoạch uống chủ động]
    D --> E[Theo dõi mồ hôi, cân nặng và triệu chứng]
    E --> F{Cân nặng tăng trong lúc tập?}
    F -- Có --> G[Giảm lượng nước uống]
    F -- Không --> H{Mất quá nhiều cân hoặc rất khát?}
    H -- Có --> I[Tăng nước và cân nhắc điện giải]
    H -- Không --> J[Duy trì kế hoạch hiện tại]
```
...
![Nước lọc và trái cây có thể được dùng làm đồ uống ít năng lượng](https://www.cdc.gov/healthy-weight-growth/media/images/waterpitcher.jpg)
