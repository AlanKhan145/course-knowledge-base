...
# 076 — Magnesium
[![Magnesium: foods, functions, how much do you need & more | Eufic](https://tse4.mm.bing.net/th/id/OIP.Plitb1Fz-WI7WaTRkN_mMAHaGH?r=0\&pid=Api)](https://www.eufic.org/en/vitamins-and-minerals/article/magnesium-foods-functions-how-much-do-you-need-more?utm_source=chatgpt.com)
...
```mermaid
flowchart TD
    MG[Magie Mg²⁺] --> A[Sản xuất ATP và năng lượng]
    MG --> B[Tổng hợp protein, DNA và RNA]
    MG --> C[Dẫn truyền thần kinh]
    MG --> D[Co và giãn cơ]
    MG --> E[Điều hòa đường huyết]
    MG --> F[Điều hòa huyết áp]
    MG --> G[Duy trì xương]
    MG --> H[Nhịp tim bình thường]
```
...
```mermaid
flowchart LR
    A[Magie từ thực phẩm] --> B[Hấp thu tại ruột]
    B --> C[Magie trong máu<br/>dưới 1% tổng lượng]
    C <--> D[Xương<br/>khoảng 50–60%]
    C <--> E[Cơ và mô mềm]
    C --> F[Thận]
    F --> G[Đào thải qua nước tiểu]
    F -->|Khi lượng magie thấp| C
```
...
![Sơ đồ hấp thu, dự trữ và đào thải magie trong cơ thể](https://mdpi-res.com/d_attachment/nutrients/nutrients-10-01202/article_deploy/html/images/nutrients-10-01202-g006.png)
...
![Các nguồn thực phẩm cung cấp magie](https://upload.wikimedia.org/wikipedia/commons/a/a1/FoodSourcesOfMagnesium.jpg)
