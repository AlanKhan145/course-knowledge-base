...
```mermaid
flowchart TD
    A[Kẽm từ thực phẩm] --> B[Hấp thu chủ yếu tại ruột non]
    B --> C[Phân phối đến tế bào và mô]

    C --> D[Enzyme và chuyển hóa]
    C --> E[Tổng hợp DNA và protein]
    C --> F[Điều hòa biểu hiện gene]
    C --> G[Tín hiệu tế bào]

    D --> H[Chuyển hóa carbohydrate và chất dinh dưỡng]
    E --> I[Tăng trưởng và phân chia tế bào]
    F --> J[Phát triển thai nhi và trẻ em]
    G --> K[Hoạt động miễn dịch]

    I --> L[Lành vết thương]
    K --> M[Đáp ứng với tác nhân gây bệnh]
    C --> N[Vị giác và khứu giác]
```
...
![Vai trò của kẽm trong quá trình lành vết thương](https://mdpi-res.com/d_attachment/nutrients/nutrients-10-00016/article_deploy/html/images/nutrients-10-00016-g001.png)
...
![Hàu là một trong những nguồn thực phẩm giàu kẽm nhất](https://commons.wikimedia.org/wiki/Special\:FilePath/Oysters%20%286984932105%29.jpg?width=1200)
...
![Hạt bí là nguồn kẽm phù hợp cho chế độ ăn thực vật](https://commons.wikimedia.org/wiki/Special\:FilePath/Pumpkin%20Seeds.jpg?width=1200)
...
```mermaid
flowchart LR
    A[Chọn thực phẩm giàu kẽm] --> B[Đậu + đậu phụ + hạt + ngũ cốc]
    B --> C[Ngâm hoặc nảy mầm]
    C --> D[Lên men khi phù hợp]
    D --> E[Ăn đa dạng trong ngày]
    E --> F[Đánh giá nguy cơ thiếu kẽm]
    F --> G{Có triệu chứng hoặc nguy cơ cao?}
    G -- Không --> H[Duy trì chế độ ăn]
    G -- Có --> I[Tư vấn bác sĩ hoặc chuyên gia dinh dưỡng]
```
