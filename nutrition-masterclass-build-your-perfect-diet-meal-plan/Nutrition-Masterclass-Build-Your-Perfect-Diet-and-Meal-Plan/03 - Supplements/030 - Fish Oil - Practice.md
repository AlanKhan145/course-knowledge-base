...
![Viên dầu cá omega-3](https://commons.wikimedia.org/wiki/Special\:FilePath/Omega_3_Fish_oil_softgel_capsules.jpg?width=1200)
...
```mermaid
flowchart LR
    A[Cá béo hoặc thực phẩm bổ sung] --> B[EPA và DHA]
    B --> C[Hấp thu tại ruột]
    C --> D[Đi vào màng tế bào]
    D --> E[Tham gia tạo phân tử truyền tín hiệu]
    D --> F[Ảnh hưởng chuyển hóa lipid]
    F --> G[Có thể làm giảm triglyceride]
    E --> H[Điều hòa phản ứng viêm]
```
...
![Phi lê cá hồi](https://commons.wikimedia.org/wiki/Special\:FilePath/Frozen_salmon_fillet.jpg?width=900)
...
```mermaid
flowchart TD
    A[Bạn có ăn cá béo khoảng 2 lần mỗi tuần?] -->|Có| B[Ưu tiên duy trì chế độ ăn]
    A -->|Không| C[Không thích cá, ăn chay hoặc khó tiếp cận cá]
    C --> D[Cân nhắc dầu cá hoặc dầu tảo]
    D --> E[Kiểm tra tổng EPA + DHA trên nhãn]
    E --> F{Có bệnh tim, triglyceride cao hoặc đang dùng thuốc?}
    F -->|Không| G[Dùng theo nhãn và mức tham chiếu dinh dưỡng]
    F -->|Có| H[Trao đổi với bác sĩ trước khi dùng]
```
...
![Bảng lựa chọn cá theo hàm lượng thủy ngân của FDA/EPA](https://www.fda.gov/files/AdviceAboutEatingFish-ChartThumbnail-October2021.png)
