...
```mermaid
flowchart TD
    A[Đang cân nhắc supplement] --> B{Mục tiêu chính?}

    B -->|Tập khỏe và tỉnh táo hơn| C[Pre-workout]
    B -->|Giảm mỡ| D[Fat burner]

    C --> E[Kiểm tra lượng caffeine]
    E --> F[Đánh giá giấc ngủ và khả năng dung nạp]

    D --> G{Đã có thâm hụt calorie?}
    G -->|Chưa| H[Ưu tiên sửa chế độ ăn]
    G -->|Có| I[Supplement chỉ hỗ trợ rất nhỏ]

    F --> J[Thử liều thấp nếu cần]
    I --> K[Cân nhắc chi phí và rủi ro]
```
...
![Mô hình phân tử caffeine](https://commons.wikimedia.org/wiki/Special\:FilePath/Caffeine%20molecule%20spacefill%20from%20xtal%20%281%29.png?width=900)
...
```mermaid
flowchart LR
    A[Fat burner] --> B[Tăng nhẹ tỉnh táo]
    A --> C[Tăng nhẹ sinh nhiệt]
    A --> D[Có thể giảm thèm ăn]

    B --> E[Ảnh hưởng nhỏ]
    C --> E
    D --> E

    F[Thâm hụt calorie] --> G[Động lực chính của giảm mỡ]
    H[Tập luyện và vận động] --> G
    I[Ngủ và duy trì chế độ ăn] --> G
...
![Quả cam đắng – nguồn tự nhiên chứa p-synephrine](https://commons.wikimedia.org/wiki/Special\:FilePath/Bitter%20orange%20-%20Citrus%20%C3%97%20aurantium%2003.jpg?width=900)
...
![Lá trà xanh](https://commons.wikimedia.org/wiki/Special\:FilePath/Green%20tea%20leaves.jpg?width=900)
...
![Biểu đồ glycerol sau khi sử dụng chiết xuất trà xanh và tập luyện](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4517022/bin/nutrients-07-05245-g003.jpg)
...
![Các loại trái cây họ cam quýt](https://commons.wikimedia.org/wiki/Special\:FilePath/Citrus%20fruits%20%28lemon%2C%20lime%2C%20orange%20and%20grapefruit%29.jpg?width=900)
