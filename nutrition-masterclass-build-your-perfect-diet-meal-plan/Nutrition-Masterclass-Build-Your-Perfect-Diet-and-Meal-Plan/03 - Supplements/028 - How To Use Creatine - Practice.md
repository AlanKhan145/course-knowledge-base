...
![Cấu trúc hóa học của creatine](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Creatine.svg)
...
```mermaid
flowchart LR
    A[Phosphocreatine trong cơ] -->|Cho nhóm phosphate| B[ADP]
    B --> C[ATP được tái tạo]
    C --> D[Co cơ và tạo lực]
    D --> E[ATP giảm thành ADP]
    E --> B
```

![Hệ thống creatine–phosphocreatine trong tế bào cơ](https://upload.wikimedia.org/wikipedia/commons/f/f6/Creatine_Phosphate_Shuttle_Diagram.png)
...
![Hai chiến lược sử dụng creatine: nạp và không nạp](https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs12970-021-00412-w/MediaObjects/12970_2021_412_Fig1_HTML.png)
...
```mermaid
flowchart TD
    A[Chọn 100% creatine monohydrate] --> B{Có cần bão hòa nhanh không?}

    B -->|Không| C[Uống 3–5 g mỗi ngày]
    B -->|Có| D[Uống khoảng 20 g/ngày trong 5–7 ngày]

    D --> E[Chia thành 4 lần, mỗi lần khoảng 5 g]
    E --> F[Chuyển sang 3–5 g/ngày]

    C --> G[Tiếp tục sử dụng mỗi ngày]
    F --> G

    G --> H[Kết hợp tập luyện, dinh dưỡng và ngủ đủ]
```
...
```mermaid
flowchart TD
    A[Tập luyện có tiến triển] --> E[Tăng sức mạnh và cơ bắp]
    B[Đủ protein và calorie] --> E
    C[Ngủ và phục hồi] --> E
    D[Creatine] --> E
