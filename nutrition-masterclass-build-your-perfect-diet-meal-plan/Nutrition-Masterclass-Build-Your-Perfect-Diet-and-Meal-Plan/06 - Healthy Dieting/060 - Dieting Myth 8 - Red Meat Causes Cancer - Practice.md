...
![Phân loại thịt đỏ và thịt chế biến theo IARC](https://news.cancerresearchuk.org/wp-content/uploads/2015/10/Infographic_red-processed-meat-risk.jpg)
...
```mermaid
flowchart LR
    A[IARC đánh giá bằng chứng] --> B{Bằng chứng ở người}
    B -->|Đủ mạnh| C[Nhóm 1<br/>Thịt chế biến]
    B -->|Hạn chế nhưng có cơ chế hỗ trợ| D[Nhóm 2A<br/>Thịt đỏ]

    C --> E[Biết chắc có nguy cơ]
    D --> F[Có khả năng có nguy cơ]

    E --> G[Không đồng nghĩa<br/>nguy hiểm ngang thuốc lá]
    F --> H[Không đồng nghĩa<br/>một bữa ăn sẽ gây ung thư]
```
...
```mermaid
flowchart TD
    A[Thịt đỏ hoặc thịt chế biến] --> B[Sắt heme]
    A --> C[Nitrit và nitrat]
    A --> D[Nấu nhiệt độ cao]
    A --> E[Khói và lửa trực tiếp]

    B --> F[Hợp chất N-nitroso]
    C --> F
    D --> G[HCA]
    E --> H[PAH]

    F --> I[Tổn thương tế bào hoặc DNA]
    G --> I
    H --> I

    I --> J[Nguy cơ tích lũy tăng<br/>khi ăn nhiều và thường xuyên]
```
...
![Thịt chế biến như bacon nên được ăn hạn chế](https://news.cancerresearchuk.org/wp-content/uploads/2021/03/frying-bacon.webp)
...
```mermaid
flowchart TD
    A[Chọn nguồn protein] --> B{Có phải thịt chế biến?}

    B -->|Có| C[Ăn rất ít hoặc chỉ thỉnh thoảng]
    B -->|Không| D{Có phải thịt đỏ?}

    D -->|Có| E[Theo dõi tổng lượng trong tuần]
    E --> F[Giữ khoảng 350–500 g thịt chín/tuần]
    F --> G[Chọn phần nạc]
    G --> H[Nấu nhiệt độ vừa<br/>tránh khói và cháy đen]

    D -->|Không| I[Cá, gia cầm, trứng hoặc đậu]
    C --> J[Tăng thực phẩm tươi và chất xơ]
    H --> J
    I --> J
```
