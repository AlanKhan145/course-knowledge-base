...
![Bữa sáng cân bằng có trứng, ngũ cốc nguyên hạt và rau củ](https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Breakfast_meal_-_MyPlate_20210810-FNS-UNC-0018.jpg/1280px-Breakfast_meal_-_MyPlate_20210810-FNS-UNC-0018.jpg)
...
```mermaid
flowchart LR
    A[Ăn trứng] --> B[Cholesterol từ thức ăn]
    B --> C[Hấp thu một phần tại ruột]
    C --> D[Gan điều chỉnh tổng hợp và thải trừ]
    D --> E{Phản ứng cá nhân}
    E -->|Đáp ứng thấp| F[LDL-C thay đổi ít]
    E -->|Đáp ứng cao hơn| G[LDL-C có thể tăng]
    F --> H[Đánh giá toàn bộ chế độ ăn]
    G --> H
    H --> I[Nguy cơ tim mạch tổng thể]
```
...
![Biểu đồ rừng về ảnh hưởng của lượng trứng cao hơn đối với LDL-C](https://www.mdpi.com/nutrients/nutrients-12-01995/article_deploy/html/images/nutrients-12-01995-g003.png)
