...
![Ví dụ bảng Nutrition Facts của FDA](https://www.fda.gov/files/nutrition-facts-label-download-image1.jpg)
...
```mermaid
flowchart LR
    A["Nhãn low-fat / diet"] --> B["Cảm giác sản phẩm lành mạnh hơn"]
    B --> C["Ước lượng calorie thấp hơn thực tế"]
    C --> D["Cho phép bản thân ăn khẩu phần lớn hơn"]
    D --> E["Tổng calorie tiêu thụ tăng"]
    E --> F["Thâm hụt calorie bị thu hẹp hoặc biến mất"]
```
...
![Minh họa thông điệp “Choose Low-Fat Snacks”](https://upload.wikimedia.org/wikipedia/commons/5/54/Low-fat_snacks.jpg)
