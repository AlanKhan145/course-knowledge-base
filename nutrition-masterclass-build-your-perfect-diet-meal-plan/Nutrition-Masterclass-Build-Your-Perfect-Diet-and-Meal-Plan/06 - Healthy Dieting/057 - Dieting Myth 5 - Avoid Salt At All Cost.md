...
![Muối ăn – cần thiết nhưng nên sử dụng có kiểm soát](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Table_Salt.jpg/960px-Table_Salt.jpg)
...
```mermaid
flowchart LR
    A[Ăn nhiều natri] --> B[Giữ nước và tăng thể tích dịch]
    B --> C[Tim và mạch máu chịu áp lực lớn hơn]
    C --> D[Huyết áp có thể tăng]
    D --> E[Tăng nguy cơ tim mạch và đột quỵ]
    D --> F[Tăng gánh nặng lên thận]
```
...
![Infographic của CDC về lượng natri tích lũy trong thực phẩm](https://www.cdc.gov/heart-disease/media/images/saul-t-sodium.jpg)
