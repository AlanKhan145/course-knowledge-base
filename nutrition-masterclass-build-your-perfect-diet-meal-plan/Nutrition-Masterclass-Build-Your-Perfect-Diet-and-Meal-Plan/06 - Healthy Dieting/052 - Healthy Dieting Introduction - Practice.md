[![Pyramid or plate, carbs or veggies: What really is the ideal diet? – The Irish Times](https://images.openai.com/static-rsc-4/y6ebtee-3coLoiW2KaRiG5Pw78aPAUe9_CvHUBRvbJ1-5r5r3hNmMFcIq_SyLLhSty_omUJDQZHGIFIswu7mPk7xpPrds45M5D2APxu9oWevo481mPM-zcZX7DMsY5TPD04ygJivQ8Xk2i6OtfI26N7opIX9mljK7KHQM5LYXas?purpose=inline)](https://www.irishtimes.com/life-and-style/food-and-drink/pyramid-or-plate-carbs-or-veggies-what-really-is-the-ideal-diet-1.3774719?utm_source=chatgpt.com)
...
![Các nhóm thực phẩm thường xuất hiện trong một chế độ ăn đa dạng](https://upload.wikimedia.org/wikipedia/commons/5/54/Healthy_food.jpg)
...
```mermaid
flowchart LR
    A[Chế độ ăn hằng ngày] --> B[Đủ năng lượng]
    A --> C[Đủ protein và chất béo thiết yếu]
    A --> D[Vitamin và khoáng chất]
    A --> E[Chất xơ và tiêu hóa]
    A --> F[Hiệu suất tập luyện]
    A --> G[Sức khỏe lâu dài]

    B --> H[Cơ thể hoạt động tốt]
    C --> H
    D --> H
    E --> H
    F --> H
...
```mermaid
flowchart TD
    A[Tuyên bố dinh dưỡng] --> B{Có nguồn nghiên cứu không?}

    B -- Không --> C[Chỉ xem là ý kiến hoặc kinh nghiệm]
    B -- Có --> D{Thiết kế nghiên cứu là gì?}

    D --> E[Tổng quan hệ thống hoặc phân tích gộp]
    D --> F[Thử nghiệm ngẫu nhiên có đối chứng]
    D --> G[Nghiên cứu quan sát]
    D --> H[Nghiên cứu cơ chế hoặc trên động vật]

    E --> I[Đánh giá tổng thể bằng chứng]
    F --> I
    G --> I
    H --> I

    I --> J{Kết quả có nhất quán và phù hợp đối tượng không?}
    J -- Có --> K[Có thể cân nhắc áp dụng]
    J -- Chưa rõ --> L[Thận trọng và tiếp tục theo dõi nghiên cứu]
```
...
![Mô hình đĩa ăn giúp hình dung tỷ lệ các nhóm thực phẩm](https://upload.wikimedia.org/wikipedia/commons/a/ae/Eatwell_Plate.svg)
