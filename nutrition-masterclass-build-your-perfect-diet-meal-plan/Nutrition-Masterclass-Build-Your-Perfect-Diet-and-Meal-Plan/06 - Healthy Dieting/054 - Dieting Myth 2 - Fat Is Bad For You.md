...
![Bơ và các loại hạt — nguồn chất béo không bão hòa](https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Healthy_Fats_-_Avocado_and_Nuts_-_50191958402.jpg/1280px-Healthy_Fats_-_Avocado_and_Nuts_-_50191958402.jpg)
...
```mermaid
flowchart LR
    A[Ăn thực phẩm có chất béo] --> B{Tổng năng lượng cả ngày}
    B -->|Phù hợp nhu cầu| C[Duy trì cân nặng]
    B -->|Thấp hơn nhu cầu| D[Giảm cân theo thời gian]
    B -->|Dư thừa kéo dài| E[Tăng dự trữ mỡ]

    F[Carbohydrate dư thừa] --> E
    G[Protein dư thừa] --> E
```
...
```mermaid
flowchart TD
    A[Chất béo trong khẩu phần] --> B[Không bão hòa]
    A --> C[Bão hòa]
    A --> D[Trans công nghiệp]
    ...
    C --> C1[Bơ và mỡ động vật]
    C --> C2[Dầu dừa và dầu cọ]
    C --> C3[Giới hạn và thay thế hợp lý]

    D --> D1[Dầu hydro hóa một phần]
    D --> D2[Thực phẩm chiên hoặc đóng gói]
    D --> D3[Hạn chế tối đa]
```
