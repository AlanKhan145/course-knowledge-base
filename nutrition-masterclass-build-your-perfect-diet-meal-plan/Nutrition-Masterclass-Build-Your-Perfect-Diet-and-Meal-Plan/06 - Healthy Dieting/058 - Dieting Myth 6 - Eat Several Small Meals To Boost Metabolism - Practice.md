...
![Một bữa ăn nhỏ gồm trái cây, ngũ cốc và sữa chua](https://upload.wikimedia.org/wikipedia/commons/e/e0/Healthy_Meal_Prep_%28Unsplash%29.jpg)
...
```mermaid
flowchart LR
    A[Tổng lượng thức ăn trong ngày] --> B[Chi phí tiêu hóa và hấp thu]
    B --> C[Tổng hiệu ứng nhiệt của thức ăn]

    D[Chia thành 3 bữa] --> B
    E[Chia thành 6 bữa] --> B

    C --> F[Năng lượng tiêu hao gần tương đương<br/>nếu calorie và chất dinh dưỡng giống nhau]
```
...
![Minh họa đo trao đổi chất khi nghỉ bằng lượng oxy tiêu thụ và CO2 tạo ra](https://upload.wikimedia.org/wikipedia/commons/a/a0/Resting_Metabolic_Rate.png)
...
![Biểu đồ tổng hợp ảnh hưởng của số bữa lên cân nặng, vòng eo, khối mỡ và năng lượng nạp vào](https://cdn.ncbi.nlm.nih.gov/pmc/blobs/1d14/7490164/c76b32605d85/nmaa056fig3.jpg)
...
```mermaid
flowchart TD
    A[Bạn thường đói như thế nào?] --> B{Bữa lớn có gây khó chịu?}

    B -->|Không| C[Thử 2–3 bữa chính]
    B -->|Có| D[Chia thành 3–5 bữa nhỏ hơn]

    C --> E{Có mất kiểm soát vì quá đói?}
    D --> F{Ăn vặt có làm vượt calorie?}

    E -->|Có| D
    E -->|Không| G[Duy trì lịch hiện tại]

    F -->|Có| C
    F -->|Không| G

    G --> H[Theo dõi cân nặng, vòng eo,<br/>năng lượng và hiệu suất tập]
```
...
![Người tập luyện sức mạnh bằng tạ đơn](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Woman_lifting_dumbbells_in_a_modern_gym_during_a_workout_session_focused_on_strength_training_and_fitness.jpg?width=1200)
