...
```mermaid
flowchart TD
    A[Bắt đầu tính macro] --> B[Đã xác định protein]
    B --> C{Biết tỷ lệ mỡ cơ thể?}

    C -->|Có| D[Tính FFM = cân nặng × 1 - tỷ lệ mỡ]
    D --> E[Fat tối thiểu ≈ 0,66 g × kg FFM]

    C -->|Không| F[Chọn 20–30% tổng calorie]
    F --> G[Fat g = calorie × tỷ lệ ÷ 9]

    E --> H{Đang tăng cân và khó ăn đủ?}
    G --> H

    H -->|Có| I[Tăng thêm fat không bão hòa]
    H -->|Không| J[Để carb lấp phần calorie còn lại]

    I --> K[Kiểm tra saturated fat dưới 10% calorie]
    J --> K

    K --> L[Theo dõi sức khỏe, cảm giác no và hiệu suất tập]
```
...
[![Cá hồi, quả bơ và rau xanh](https://images.pexels.com/photos/27137856/pexels-photo-27137856.jpeg?auto=compress\&cs=tinysrgb\&w=1200)](https://www.pexels.com/photo/avocado-and-salmon-with-herbs-27137856/)

*Các nguồn chất béo giàu dinh dưỡng như cá hồi và quả bơ. Ảnh: Rufina Rusakova/Pexels.* ([pexels.com][5])

### Quả bơ, dầu ô liu và hạt

[![Quả bơ, dầu ô liu và hạt](https://images.pexels.com/photos/3850668/pexels-photo-3850668.jpeg?auto=compress\&cs=tinysrgb\&w=1200)](https://www.pexels.com/photo/avocado-slice-on-table-3850668/)
