...
![Các nguồn thực phẩm giàu protein gồm trứng, thịt gà, đậu lăng và hạnh nhân](https://commons.wikimedia.org/wiki/Special\:FilePath/Protein-rich%20Foods.jpg?width=1200)
...
```mermaid
flowchart LR
    A[Nguồn thực phẩm] --> B[Tiêu hóa protein]
    B --> C[Giải phóng acid amin]
    C --> D{Đánh giá chất lượng}
    D --> E[Khả năng tiêu hóa]
    D --> F[Hàm lượng acid amin thiết yếu]
    D --> G[Acid amin giới hạn]
    E --> H[Acid amin cơ thể sử dụng được]
    F --> H
    G --> H
    H --> I[Tạo enzyme, hormone và mô cơ]
```
...
![Một muỗng whey protein](https://commons.wikimedia.org/wiki/Special\:FilePath/Whey%20Protein%20Scoop%20%2849935767168%29.jpg?width=1200)
...
![Các loại đậu cung cấp protein thực vật](https://commons.wikimedia.org/wiki/Special\:FilePath/Liat%20Portal%20for%20Foodie%20Disorder%20-%20Assorted%20Legumes.jpg?width=1200)
...
```mermaid
flowchart LR
    A[Ngũ cốc<br/>thường ít lysine] --> C[Khẩu phần đa dạng]
    B[Các loại đậu<br/>thường ít methionine] --> C
    C --> D[Hồ sơ acid amin cân đối hơn]
```
