...
![Bữa ăn trước khi tập với cơm, ức gà và rau](https://www.honourandglory.co.uk/images/blog/pre-workout-nutrition-boxing-what-to-eat-before-training-inline-1.jpg)
...
```mermaid
flowchart TD
    A[Tổng calorie trong ngày] --> B[Đủ protein, carbohydrate và chất béo]
    B --> C[Chất lượng thực phẩm và khả năng duy trì]
    C --> D[Phân bổ các bữa ăn]
    D --> E[Bữa ăn trước và sau khi tập]
    E --> F[Thực phẩm bổ sung]
```
...
```mermaid
flowchart LR
    A[Carbohydrate] --> B[Glucose trong máu]
    A --> C[Glycogen cơ và gan]
    B --> D[Năng lượng khi tập]
    C --> D

    E[Protein] --> F[Amino acid]
    F --> G[Hỗ trợ mô cơ]

    D --> H[Duy trì hiệu suất]
    G --> H
```
...
```mermaid
flowchart TD
    A[Còn bao lâu trước khi tập?] --> B{Trên 2 giờ?}
    B -->|Có| C[Bữa ăn đầy đủ]
    B -->|Không| D{Còn 60–120 phút?}
    D -->|Có| E[Bữa vừa hoặc nhỏ]
    D -->|Không| F{Còn 30–60 phút?}
    F -->|Có| G[Đồ ăn nhẹ, dễ tiêu]
    F -->|Không| H[Chỉ dùng lượng nhỏ nếu cần]
```
...
![Cơm, thịt gà và rau trước buổi tập](https://www.nutrizionesana.it/wp-content/uploads/2024/07/Pollo-alla-Griglia-con-Riso-Integrale-e-Verdure.webp)
...
![Yến mạch và chuối trước buổi tập](https://www.honourandglory.co.uk/images/blog/pre-workout-nutrition-boxing-what-to-eat-before-training/featuredImage.webp)
...
![Bổ sung nước trước buổi tập](https://www.honourandglory.co.uk/images/blog/pre-workout-nutrition-boxing-what-to-eat-before-training-inline-3.jpg)
