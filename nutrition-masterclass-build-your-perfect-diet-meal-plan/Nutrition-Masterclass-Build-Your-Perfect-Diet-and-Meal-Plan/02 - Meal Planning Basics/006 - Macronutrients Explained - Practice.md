[![What Are Macros? Here’s Everything You Should Know - Sukhi's](https://images.openai.com/static-rsc-4/KEDY_CBSI7i7aGd-bW3cY2iD-saX3nocO6h7aN93wcEJSIJVR1yrNpkLhhOhZEPs1v6uYC11cS_bnyWFbEdC8Em7ftlzIQqGbhFk5zqGAqtCwseeS9Iw9oGhRVh3mL0fpX-4DcnY7DRzuhYQhs8miTvfZZ_5S0ZJRonEyL39_3o?purpose=inline)](https://sukhis.com/what-are-macros/?utm_source=chatgpt.com)
...
![Bữa ăn cân bằng chứa nhiều nhóm chất dinh dưỡng](https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format\&fit=crop\&fm=jpg\&q=80\&w=1600)
...
```mermaid
flowchart TD
    A[Chất dinh dưỡng] --> B[Macronutrients<br/>Cần với lượng lớn]
    A --> C[Micronutrients<br/>Cần với lượng nhỏ]

    B --> D[Protein<br/>4 kcal/g]
    B --> E[Carbohydrate<br/>4 kcal/g]
    B --> F[Chất béo<br/>9 kcal/g]
...
![Các thực phẩm giàu carbohydrate như bánh mì và ngũ cốc](https://images.unsplash.com/photo-1523294587484-bae6cc870010?auto=format\&fit=crop\&fm=jpg\&q=80\&w=1600)
...
```mermaid
flowchart LR
    A[Năng lượng nạp vào] --> D{So sánh}
    B[Năng lượng tiêu hao] --> D

    D -->|Nạp lớn hơn tiêu hao| E[Khối lượng cơ thể có xu hướng tăng]
    D -->|Nạp nhỏ hơn tiêu hao| F[Khối lượng cơ thể có xu hướng giảm]
    D -->|Gần tương đương| G[Khối lượng tương đối ổn định]
```
...
```mermaid
flowchart LR
    A[Xác định calorie mục tiêu] --> B[1. Đặt protein]
    B --> C[2. Đặt mức chất béo phù hợp]
    C --> D[3. Phân bổ calorie còn lại cho carbohydrate]
    D --> E[Theo dõi hiệu suất, cảm giác đói và tiến độ]
    E --> F[Điều chỉnh khi cần]
```
