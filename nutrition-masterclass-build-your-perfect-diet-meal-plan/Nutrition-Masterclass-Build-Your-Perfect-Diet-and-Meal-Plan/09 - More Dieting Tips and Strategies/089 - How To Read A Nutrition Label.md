...
[![The Lows and Highs of Percent Daily Value on the New Nutrition Facts Label | FDA](https://tse4.mm.bing.net/th/id/OIP.4dKySuYVXu45shopsrJnVgHaNc?r=0\&pid=Api)](https://www.fda.gov/food/new-nutrition-facts-label/lows-and-highs-percent-daily-value-new-nutrition-facts-label) 
...
![Mẫu nhãn dinh dưỡng FDA — bắt đầu bằng số khẩu phần và kích thước khẩu phần](https://www.fda.gov/files/New_NFL_ServingSizes.png)
...
```mermaid
flowchart TD
    A[1. Xem kích thước khẩu phần] --> B[2. Xác định mình thực sự ăn bao nhiêu]
    B --> C[3. Kiểm tra calo]
    C --> D[4. Đọc protein, carbohydrate và chất béo]
    D --> E[5. Kiểm tra chất xơ và đường bổ sung]
    E --> F[6. Kiểm tra chất béo bão hòa và natri]
    F --> G[7. Dùng %DV để đánh giá thấp hoặc cao]
    G --> H[8. Đọc danh sách thành phần]
    H --> I[9. So sánh với sản phẩm khác trên cùng cơ sở]
```
...
![Ví dụ FDA đánh dấu chất dinh dưỡng có %DV cao và thấp](https://www.fda.gov/files/Lasagna%20Label%202_0.png)
