...
![Bữa ăn gồm ngũ cốc, protein, sữa, rau và trái cây](https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Dinner_meal_-_MyPlate_20210810-FNS-UNC-0017.jpg/960px-Dinner_meal_-_MyPlate_20210810-FNS-UNC-0017.jpg)
...
![Minh họa cấu trúc xương trong bệnh loãng xương](https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Osteoporosis_in_Bones.jpg/960px-Osteoporosis_in_Bones.jpg)
...
```mermaid
flowchart TD
    A[Nền tảng ăn uống lành mạnh chung] --> B[Ước tính nhu cầu năng lượng]
    B --> C{Mục tiêu}
    C -->|Giảm mỡ| D[Thâm hụt năng lượng phù hợp]
    C -->|Duy trì| E[Cân bằng năng lượng]
    C -->|Tăng cơ/cân| F[Thặng dư năng lượng phù hợp]

    D --> G[Điều chỉnh protein, carb và chất béo]
    E --> G
    F --> G

    G --> H[Kiểm tra tuổi, vận động và thành phần cơ thể]
    H --> I[Kiểm tra giai đoạn sinh lý]
    I --> J[Kinh nguyệt / thai kỳ / cho con bú / mãn kinh]
    J --> K[Đánh giá sắt, canxi và vi chất liên quan]
    K --> L[Theo dõi cân nặng, sức khỏe và hiệu suất]
    L --> M[Điều chỉnh kế hoạch]
```
