...
[![10 Plants To Help Support Immune Function
– Goldthread Tonics](https://images.openai.com/static-rsc-4/3M3-5TX7fgSNiGRGhlfwF1aa33C39mhhBoM_7-_CeRBSf3jg1RivTZ4yBjuDs6EW2WBiHFbWJWLMC4aB8RaFt0j_n_OjakyiWALNkf_Gs9W1APHacN6u9SbtjSPG6pl1sdmMjaQk6gQXyycrtyvt7mOlxsLi8s0ql41b-co2Zuc?purpose=inline)](https://drinkgoldthread.com/blogs/plants-with-benefits/10-plants-to-help-support-immune-function?srsltid=AfmBOormYotE7akcqzNMppmIeyFNWjhVDYBdJqP-pxsg4c40EgCzfKWf&utm_source=chatgpt.com)
...
| Tỏi                                                                                          | Nguồn vitamin C                                                                                                         |
| -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| ![Củ tỏi](https://commons.wikimedia.org/wiki/Special\:FilePath/Garlic%20Bulbs.jpg?width=700) | ![Cam giàu vitamin C](https://commons.wikimedia.org/wiki/Special\:FilePath/Oranges%20gives%20Vitamin%20C.jpg?width=700) |
| *Tỏi — Allium sativum* ([Wikimedia Commons][1])                                              | *Cam và các loại trái cây có múi là nguồn vitamin C phổ biến.* ([Wikimedia Commons][2])                                 |

| Hoàng kỳ                                                                                                      | Spirulina                                                                                      |
| ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| ![Cây hoàng kỳ](https://commons.wikimedia.org/wiki/Special\:FilePath/Astragalus%20membranaceus.jpg?width=700) | ![Bột spirulina](https://commons.wikimedia.org/wiki/Special\:FilePath/Spirulina.jpg?width=700) |
...
```mermaid
flowchart TD
    A[Ăn uống đa dạng] --> F[Chức năng miễn dịch bình thường]
    B[Ngủ đủ và kiểm soát căng thẳng] --> F
    C[Vận động phù hợp] --> F
    D[Tiêm chủng và vệ sinh] --> F
    E[Điều trị bệnh nền] --> F

    G{Có thiếu chất hoặc chỉ định cụ thể?}
    G -->|Có| H[Bổ sung có mục tiêu]
    G -->|Không rõ| I[Đánh giá khẩu phần, xét nghiệm hoặc hỏi chuyên gia]
    G -->|Không| J[Không cần dùng liều cao thường xuyên]

    H --> K[Theo dõi hiệu quả và tác dụng phụ]
```
...
```mermaid
quadrantChart
    title Mức độ bằng chứng và mức độ cần thận trọng
    x-axis Bằng chứng hạn chế --> Bằng chứng tốt hơn
    y-axis Ít cần thận trọng --> Cần thận trọng cao
    quadrant-1 Có thể cân nhắc có giám sát
    quadrant-2 Thận trọng, bằng chứng còn yếu
    quadrant-3 Ưu tiên thực phẩm
    quadrant-4 Có bằng chứng cho tình huống cụ thể
    Tỏi: [0.28, 0.58]
    Kẽm: [0.76, 0.75]
    Vitamin C: [0.72, 0.35]
    Hoàng kỳ: [0.22, 0.82]
...
```mermaid
flowchart TD
    A[Bạn có chế độ ăn đa dạng không?] -->|Có| B[Có triệu chứng hoặc bệnh lý cụ thể?]
    A -->|Không| C[Cải thiện khẩu phần trước]

    B -->|Không| D[Thông thường không cần bộ sản phẩm tăng miễn dịch]
    B -->|Cảm lạnh mới khởi phát| E[Có thể hỏi dược sĩ về viên ngậm kẽm ngắn hạn]
    B -->|Viêm mũi dị ứng| F[Ưu tiên chẩn đoán và điều trị chuẩn]
    B -->|Nghi thiếu chất| G[Đánh giá khẩu phần hoặc xét nghiệm phù hợp]

    F --> H[Spirulina chỉ là lựa chọn bổ trợ, bằng chứng còn hạn chế]
    G --> I[Bổ sung đúng chất và đúng liều]
```
