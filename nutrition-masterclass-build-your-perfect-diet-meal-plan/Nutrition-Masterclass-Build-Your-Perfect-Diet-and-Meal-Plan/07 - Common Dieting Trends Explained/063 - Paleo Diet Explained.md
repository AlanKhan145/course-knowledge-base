...
![Các thực phẩm thường xuất hiện trong chế độ ăn Paleo](https://user-images.rightblogger.com/ai/50158396-2d11-4168-96d5-c7834b7464af/paleo-foods-plate-salmon-steak-eggs-veggies-fruits-nuts-d838975f.jpg)
...
```mermaid
flowchart TD
    A[Chế độ ăn Paleo] --> B[Ưu tiên thực phẩm ít chế biến]
    A --> C[Loại bỏ nhiều nhóm thực phẩm]

    B --> D[Nhiều rau và trái cây]
    B --> E[Nhiều protein]
    B --> F[Ít đường bổ sung]
    B --> G[Có thể dễ kiểm soát calorie hơn]

    C --> H[Không có ngũ cốc nguyên hạt]
    C --> I[Không có các loại đậu]
    C --> J[Không có sản phẩm từ sữa]

    D --> K[Lợi ích tiềm năng]
    E --> K
    F --> K
    G --> K

    H --> L[Nguy cơ thiếu chất xơ và carbohydrate]
    I --> M[Mất nguồn protein thực vật giá rẻ]
    J --> N[Cần thay thế calcium và vitamin D]
```
...
```mermaid
flowchart LR
    A[Giữ nguyên tắc tốt của Paleo] --> B[Nhiều rau]
    A --> C[Đủ protein]
    A --> D[Ít thực phẩm siêu chế biến]

    E[Không cần cứng nhắc] --> F[Có thể ăn yến mạch hoặc gạo]
    E --> G[Có thể ăn đậu]
    E --> H[Có thể dùng sữa nếu dung nạp tốt]

    B --> I[Chế độ ăn linh hoạt]
    C --> I
    D --> I
    F --> I
    G --> I
...
![Ví dụ ba bữa ăn theo phong cách Paleo](https://user-images.rightblogger.com/ai/50158396-2d11-4168-96d5-c7834b7464af/paleo-breakfast-lunch-dinner-meal-plates-1377cf78.jpg)
...
![Các nhóm thực phẩm trong chế độ ăn cân bằng](https://cdn.shopify.com/s/files/1/1352/4405/files/food_chart_copy.jpg?v=1639531768)
