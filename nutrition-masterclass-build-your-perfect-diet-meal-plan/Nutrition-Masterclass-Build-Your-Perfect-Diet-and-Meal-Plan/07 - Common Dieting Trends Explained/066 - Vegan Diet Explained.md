...
![Bữa ăn thuần chay cân bằng gồm gạo đen, đậu lăng, rau xanh và đậu phụ](https://commons.wikimedia.org/wiki/Special\:FilePath/Balanced%20Vegan%20Dinner.png)
...
```mermaid
flowchart LR
    A[Tập kháng lực] --> E[Tăng cơ và sức mạnh]
    B[Đủ năng lượng] --> E
    C[Đủ tổng protein] --> D[Đủ axit amin thiết yếu]
    D --> E
    F[Ngủ và phục hồi] --> E
```
...
```mermaid
flowchart TD
    A[Ngũ cốc<br/>gạo, yến mạch, mì] --> D[Hồ sơ axit amin đa dạng]
    B[Họ đậu<br/>đậu nành, đậu lăng, đậu gà] --> D
    C[Hạt và quả hạch<br/>mè, chia, đậu phộng] --> D
    D --> E[Đáp ứng nhu cầu protein trong ngày]
```
...
![Bowl thuần chay với đậu phụ và rau củ](https://commons.wikimedia.org/wiki/Special\:FilePath/Bali%20vegan%20bowl%20with%20tofu.jpg)
...
```mermaid
flowchart LR
    A[Nguồn protein chính] --> E[Bữa ăn cân bằng]
    B[Carbohydrate giàu chất xơ] --> E
    C[Rau củ và trái cây] --> E
    D[Chất béo không bão hòa] --> E
    F[Thực phẩm tăng cường vi chất] --> E
```
