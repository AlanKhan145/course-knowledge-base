...
```mermaid
flowchart LR
    A[Giảm mạnh carbohydrate] --> B[Giảm glucose và glycogen sẵn có]
    B --> C[Giảm insulin, tăng huy động chất béo]
    C --> D[Acid béo đi tới gan]
    D --> E[Gan tạo thể ketone]
    E --> F[Acetoacetate]
    E --> G[Beta-hydroxybutyrate]
    E --> H[Acetone]
    F --> I[Não và các mô sử dụng làm năng lượng]
    G --> I
```

![Sơ đồ quá trình ketogenesis](https://commons.wikimedia.org/wiki/Special\:FilePath/Ketogenesis.svg)
...
![Ví dụ một bữa ăn ít carbohydrate](https://commons.wikimedia.org/wiki/Special\:FilePath/Low%20carb%20breakfast.jpg)
