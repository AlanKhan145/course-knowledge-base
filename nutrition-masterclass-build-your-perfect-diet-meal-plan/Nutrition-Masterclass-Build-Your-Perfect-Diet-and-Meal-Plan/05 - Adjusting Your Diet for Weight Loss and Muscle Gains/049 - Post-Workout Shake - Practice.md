...
![Sinh tố chuối minh họa cho post-workout shake](https://upload.wikimedia.org/wikipedia/commons/6/6e/Banana_Smoothie.jpg)
...
![Mối quan hệ giữa amino acid, tín hiệu mTOR và tổng hợp protein cơ](https://cdn.ncbi.nlm.nih.gov/pmc/blobs/3f2f/3381813/3230dfc53382/tjp0590-1049-f1.jpg)
...
![Tập luyện làm kéo dài độ nhạy của cơ với dinh dưỡng](https://cdn.ncbi.nlm.nih.gov/pmc/blobs/3f2f/3381813/92314b3d5b59/tjp0590-1049-f2.jpg)
...
```mermaid
flowchart TD
    A[Kết thúc buổi tập] --> B{Có thể ăn bữa chính<br/>trong vài giờ tới?}
    B -->|Có| C[Ăn bữa đầy đủ<br/>protein + carb + rau]
    B -->|Không| D[Dùng post-workout shake]
    D --> E[20–40 g protein]
    D --> F[Thêm carb theo nhu cầu]
    D --> G[Điều chỉnh calorie theo mục tiêu]
    C --> H[Theo dõi tổng dinh dưỡng cả ngày]
    E --> H
    F --> H
    G --> H
```
