...
![Ảnh quét DEXA minh họa sự phân bố mỡ, mô nạc và xương](https://upload.wikimedia.org/wikipedia/commons/7/72/Picture1_fs.png)
...
![Bữa ăn cân bằng gồm cá, rau, đậu, ngũ cốc và trái cây](https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Dinner_meal_-_MyPlate_20210810-FNS-UNC-0017.jpg/960px-Dinner_meal_-_MyPlate_20210810-FNS-UNC-0017.jpg)
...
![Tập luyện với tạ nhẹ và bục aerobic](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Dumbell_aerobics.jpg/960px-Dumbell_aerobics.jpg)
...
```mermaid
flowchart TD
    A[Ước tính TDEE] --> B[Chọn thâm hụt khoảng 10–20%]
    B --> C[Đặt protein 1,6–2,2 g/kg]
    C --> D[Phân bổ chất béo và carbohydrate]
    D --> E[Duy trì tập kháng lực]
    E --> F[Theo dõi cân trung bình, vòng eo và sức mạnh]
    F --> G{Kết quả sau 2–3 tuần}
    G -->|Giảm phù hợp| H[Giữ nguyên kế hoạch]
    G -->|Không giảm| I[Giảm thêm 100–200 kcal hoặc tăng vận động]
    G -->|Giảm quá nhanh| J[Tăng 100–200 kcal]
    G -->|Sức mạnh giảm mạnh| K[Giảm mức thâm hụt và kiểm tra phục hồi]
```
