...
![Thực đơn meal prep gồm cơm, rau củ và thực phẩm giàu protein](https://images.pexels.com/photos/30635714/pexels-photo-30635714.jpeg?auto=compress\&cs=tinysrgb\&w=1200)
...
```mermaid
flowchart TD
    A[Xác định calorie duy trì] --> B{Mục tiêu hiện tại}
    B -->|Giảm mỡ| C[Giảm khẩu phần yến mạch, cơm, hạt và dầu]
    B -->|Duy trì| D[Giữ khẩu phần cân bằng]
    B -->|Tăng cơ| E[Tăng yến mạch, cơm, cá và chất béo]
    C --> F[Theo dõi cân nặng và hiệu suất 2–3 tuần]
    D --> F
    E --> F
    F --> G{Kết quả phù hợp?}
    G -->|Có| H[Tiếp tục kế hoạch]
    G -->|Không| I[Điều chỉnh khoảng 100–200 kcal]
    I --> F
```
...
![Hộp meal prep gồm cá, cơm, đậu và rau củ](https://images.pexels.com/photos/30635715/pexels-photo-30635715.jpeg?auto=compress\&cs=tinysrgb\&w=1200)
