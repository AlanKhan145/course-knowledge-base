[![筋トレ 食事メニュー 例：初心者でも安心！1週間で変わる理想の献立 - スポーツ専門メディアNext One Lab](https://images.openai.com/static-rsc-4/wroOpsRJUphiJQYave5AijwENesA0LiDLEIS7CT3iwMkPpqShmT7OZyiOoT9tWLyj29w0hsEwIaR7svAkQZai2XMwb94o9U-djU7vnny7gFg-lzLoor8o0JEHeWsSK7scMGDQGjBW3WaECDKrIZGhNE-Xax6kO18BkvS6nR65ms?purpose=inline)](https://www.nextonelab8o2.com/column/category/health_foods/column20250930-2/?utm_source=chatgpt.com)
...
```mermaid
flowchart LR
    A[Tập kháng lực] --> D[Tín hiệu tăng cơ]
    B[Protein đầy đủ] --> E[Nguyên liệu phục hồi]
    C[Năng lượng đầy đủ] --> F[Nguồn lực cho thích nghi]

    D --> G[Tăng khối lượng cơ]
    E --> G
    F --> G

    H[Dư calorie quá lớn] --> I[Tăng mỡ không cần thiết]
```
...
![Thay đổi độ dày cơ giữa nhóm duy trì, surplus 5% và surplus 15%](https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs40798-023-00651-y/MediaObjects/40798_2023_651_Fig1_HTML.png)
...
![Bữa ăn gồm thịt gà, cơm, bông cải xanh và khoai lang](https://commons.wikimedia.org/wiki/Special\:FilePath/Liat_Portal_for_Foodie_Disorder_-_Healthy_low-fat_chicken%2C_rice%2C_broccoli%2C_and_sweet_potato_plate.jpg?width=1200)
...
```mermaid
flowchart TD
    A[Xác định TDEE thực tế] --> B[Thêm khoảng 5-15% calorie]
    B --> C[Protein 1,6-2,2 g/kg]
    C --> D[Chất béo 0,5-1,5 g/kg]
    D --> E[Carbohydrate nhận calorie còn lại]
    E --> F[Theo dõi trong 14 ngày]

    F -->|Tăng quá chậm| G[Tăng 100-150 kcal]
    F -->|Đúng mục tiêu| H[Giữ nguyên]
    F -->|Tăng quá nhanh| I[Giảm 100-200 kcal]
