...
Bài học cuối cùng này cung cấp cho bạn các **tài nguyên bổ sung** để tiếp tục thực hành sau khi kết thúc khóa học, tổng hợp lại dưới dạng dễ tra cứu và tái sử dụng.
...
| Giao diện hiển thị tốt trên cả điện thoại và máy tính (responsive)    |                  |
...
| API Key (Anthropic/OpenAI/Google) | Kết nối AI thật vào ứng dụng                  | Bài 17            |
...
flowchart TD
    ...
    G --> H["8. Dùng AI Agent để mở rộng, bảo trì"]
```

## 6. Lời Kết

Cảm ơn bạn đã đồng hành cùng khóa học "Vibe Coding Cơ Bản Cho Người Mới Bắt Đầu". Từ con số 0, bạn đã có trong tay một quy trình hoàn chỉnh và bộ tài nguyên có thể tái sử dụng để tự tạo ra bất kỳ ứng dụng nào phục vụ công việc và cuộc sống của mình. Điều quan trọng nhất bây giờ là **tiếp tục thực hành** — mỗi dự án mới sẽ giúp bạn thành thạo hơn trong việc mô tả ý tưởng và làm việc cùng AI.
