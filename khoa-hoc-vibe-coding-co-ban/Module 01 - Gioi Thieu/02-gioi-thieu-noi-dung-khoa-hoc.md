...
```mermaid
flowchart TD
    A["Module 1: Giới thiệu khóa học"] --> B["Module 2: Khái niệm cơ bản về Vibe Coding"]
    B --> C["Module 3: Từ No-Code đến Vibe Coding và PRD"]
    C --> D["Module 4: Prompting từ UX/UI đến Code"]
    D --> E["Module 5: Thực hành dự án phục vụ công việc"]
    E --> F["Module 6: Tổng kết và tài nguyên bổ sung"]
```
...
```mermaid
flowchart TD
    A["Ý tưởng ban đầu"] --> B["Viết prompt"]
    B --> C["AI tạo bản đầu tiên"]
    C --> D["Kiểm tra giao diện và tính năng"]
    D --> E["Yêu cầu AI chỉnh sửa"]
    E --> F["Hoàn thiện app"]
```
