...
Bai nay giai thich **Maximum Tokens** trong boi canh AI Engineer hien dai. Sau bai hoc, ban nen biet topic nay giup xay AI app nao, nam o dau trong workflow va co the bien thanh prompt, API call, RAG pipeline, agent tool, multimodal feature hoac production checklist.

## 2. Muc tieu hoc tap

- Giai thich duoc Maximum Tokens bang ngon ngu cua ban.
...
- Maximum Tokens la mot phan cua workflow goi LLM trong ung dung.
...
- Toi co the giai thich **Maximum Tokens** trong 1-2 phut.
...
**Maximum Tokens** la mot moc trong lo trinh AI Engineer. Hay bien no thanh mot prompt, API route, RAG workflow, agent tool, multimodal demo, dashboard hoac portfolio note de kien thuc co cho bam.
