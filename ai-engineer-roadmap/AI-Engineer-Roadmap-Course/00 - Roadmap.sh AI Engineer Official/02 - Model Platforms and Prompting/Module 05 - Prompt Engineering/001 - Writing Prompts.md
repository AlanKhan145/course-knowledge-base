...
Bai nay giai thich **Writing Prompts** trong boi canh AI Engineer hien dai. Sau bai hoc, ban nen biet topic nay giup xay AI app nao, nam o dau trong workflow va co the bien thanh prompt, API call, RAG pipeline, agent tool, multimodal feature hoac production checklist.

## 2. Muc tieu hoc tap

- Giai thich duoc Writing Prompts bang ngon ngu cua ban.
...
- Writing Prompts giup model lam dung viec hon va tra output de dung trong app.
...
- Toi co the giai thich **Writing Prompts** trong 1-2 phut.
...
**Writing Prompts** la mot moc trong lo trinh AI Engineer. Hay bien no thanh mot prompt, API route, RAG workflow, agent tool, multimodal demo, dashboard hoac portfolio note de kien thuc co cho bam.
