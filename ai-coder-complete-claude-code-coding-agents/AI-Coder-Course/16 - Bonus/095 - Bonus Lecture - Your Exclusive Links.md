...
```mermaid id="8rkoe5"
flowchart TD
    A[AI Builder] --> B[AI Coder]
    B --> C[AI Leader]
    C --> D[AI Engineer Core Track]
    D --> E[AI Engineer Agentic Track]
    E --> F[AI Engineer Production Track]

    A --> A1[No-code agents<br/>Voice agents<br/>Business automations]
    B --> B1[Coding agents<br/>Claude Code<br/>Fast software delivery]
    C --> C1[Commercial AI impact<br/>Leadership<br/>Strategy]
    D --> D1[LLMs<br/>RAG<br/>QLoRA<br/>Core AI systems]
    E --> E1[Autonomous agents<br/>MCP<br/>Agentic workflows]
    F --> F1[Cloud deployment<br/>Scale<br/>Security<br/>Observability]
```
...
flowchart LR
    ...
    C --> D[Core Track]
    D --> E[Agentic Track]
    E --> F[Production Track]
    F --> G[Proficient AI Engineer]
```
