...
$$
\left( \hat{\beta}_0, \hat{\beta}_1 \right) = \operatorname*{arg,min}_{\beta_0,\beta_1} \sum_{i=1}^{n} \left[ y_i - \left( \beta_0 + \beta_1 x_i \right) \right]^2
$$
...
$$
\operatorname{Var} \left( \varepsilon_i \mid X_i \right) = \sigma^2
$$
...
* $\operatorname{SE}(\hat{\beta}_j)$ is its standard error.
...
$$
t = \frac{ \hat{\beta}_j }{ \operatorname{SE} \left( \hat{\beta}_j \right) }
$$
