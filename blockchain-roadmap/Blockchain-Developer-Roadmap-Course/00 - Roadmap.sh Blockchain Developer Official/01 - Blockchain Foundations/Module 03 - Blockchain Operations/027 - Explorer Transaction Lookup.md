# 027 - Explorer Transaction Lookup

**Hoc phan:** 01 - Blockchain Foundations
**Module:** Module 03 - Blockchain Operations
**Nhom noi dung:** Gas and Fees
**Nguon roadmap:** Blockchain Operations / Gas and Fees
**Loai bai:** lesson
...
Bai nay giai thich **Explorer Transaction Lookup** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Explorer Transaction Lookup bang ngon ngu cua ban.
...
- Explorer Transaction Lookup is part of the Gas and Fees topic in the Blockchain Developer roadmap.
...
1. Write a 5-line note explaining Explorer Transaction Lookup.
