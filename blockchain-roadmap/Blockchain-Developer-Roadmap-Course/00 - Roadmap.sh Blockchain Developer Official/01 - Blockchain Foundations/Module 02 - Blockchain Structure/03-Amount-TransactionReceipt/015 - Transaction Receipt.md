# 015 - Transaction Receipt

**Hoc phan:** 01 - Blockchain Foundations
**Module:** Module 02 - Blockchain Structure
**Nhom noi dung:** Transaction Structure
**Nguon roadmap:** Blockchain Structure / Transaction Structure
**Loai bai:** lesson
...
Bai nay giai thich **Transaction Receipt** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Transaction Receipt bang ngon ngu cua ban.
...
- Transaction Receipt is part of the Transaction Structure topic in the Blockchain Developer roadmap.
...
1. Write a 5-line note explaining Transaction Receipt.
