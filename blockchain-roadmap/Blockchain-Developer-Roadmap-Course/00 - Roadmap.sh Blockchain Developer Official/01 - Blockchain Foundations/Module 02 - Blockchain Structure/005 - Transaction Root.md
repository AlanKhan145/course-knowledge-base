# 005 - Transaction Root

**Hoc phan:** 01 - Blockchain Foundations
**Module:** Module 02 - Blockchain Structure
**Nhom noi dung:** Block Structure
**Nguon roadmap:** Blockchain Structure / Block Structure
**Loai bai:** lesson
...
Bai nay giai thich **Transaction Root** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Transaction Root bang ngon ngu cua ban.
...
- Transaction Root is part of the Block Structure topic in the Blockchain Developer roadmap.
...
1. Write a 5-line note explaining Transaction Root.
