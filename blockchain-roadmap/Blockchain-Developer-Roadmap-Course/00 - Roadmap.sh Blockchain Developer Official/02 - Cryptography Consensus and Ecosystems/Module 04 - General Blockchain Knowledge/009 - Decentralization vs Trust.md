# 009 - Decentralization vs Trust

**Hoc phan:** 02 - Cryptography Consensus and Ecosystems
**Module:** Module 04 - General Blockchain Knowledge
**Nhom noi dung:** Forks and Trust
**Nguon roadmap:** General Blockchain Knowledge / Forks and Trust
**Loai bai:** lesson
...
Bai nay giai thich **Decentralization vs Trust** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Decentralization vs Trust bang ngon ngu cua ban.
...
- Decentralization vs Trust is part of the Forks and Trust topic in the Blockchain Developer roadmap.
...
1. Write a 5-line note explaining Decentralization vs Trust.
