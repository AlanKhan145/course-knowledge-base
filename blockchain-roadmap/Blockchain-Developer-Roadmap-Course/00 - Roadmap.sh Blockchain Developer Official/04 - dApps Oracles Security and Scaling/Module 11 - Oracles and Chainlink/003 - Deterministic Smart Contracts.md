# 003 - Deterministic Smart Contracts

**Hoc phan:** 04 - dApps Oracles Security and Scaling
**Module:** Module 11 - Oracles and Chainlink
**Nhom noi dung:** Oracle Basics
**Nguon roadmap:** Oracles and Chainlink / Oracle Basics
...
Bai nay giai thich **Deterministic Smart Contracts** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Deterministic Smart Contracts bang ngon ngu cua ban.
...
- Deterministic Smart Contracts is part of the Oracle Basics topic in the Blockchain Developer roadmap.
