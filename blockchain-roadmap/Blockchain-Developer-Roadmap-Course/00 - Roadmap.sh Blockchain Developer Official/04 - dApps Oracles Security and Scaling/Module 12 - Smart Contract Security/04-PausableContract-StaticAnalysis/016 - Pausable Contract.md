# 016 - Pausable Contract

**Hoc phan:** 04 - dApps Oracles Security and Scaling
**Module:** Module 12 - Smart Contract Security
**Nhom noi dung:** Secure Design
**Nguon roadmap:** Smart Contract Security / Secure Design
**Loai bai:** security
...
Bai nay giai thich **Pausable Contract** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Pausable Contract bang ngon ngu cua ban.
...
- Pausable Contract is part of the Secure Design topic in the Blockchain Developer roadmap.
