# 004 - ERC-20 Token Contract

**Hoc phan:** 05 - Capstone and Portfolio
**Module:** Module 15 - Capstone and Portfolio
**Nhom noi dung:** Capstone Projects
**Nguon roadmap:** Capstone and Portfolio / Capstone Projects
**Loai bai:** project
...
Bai nay giai thich **ERC-20 Token Contract** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc ERC-20 Token Contract bang ngon ngu cua ban.
...
- ERC-20 Token Contract is part of the Capstone Projects topic in the Blockchain Developer roadmap.
- A good blockchain portfolio proves contract skill, frontend integration, tests and security awareness.
- Keep the demo small but complete enough for reviewers to run.
...
2. Write goal, contracts, tests, frontend, deploy steps and security notes.
