...
## 2. Mục tiêu học tập
- Hoàn thành project **Log Analysis Mini SOC** theo yêu cầu đã nêu.
- Tạo sản phẩm bàn giao có thể đưa vào portfolio.
- Viết lại quy trình, bằng chứng và bài học rút ra sau khi thực hành.

## 3. Yêu cầu thực hiện
- Thu thập Windows Event Logs hoặc Linux syslog
- Tìm failed login
- Tìm suspicious process
- Tạo timeline
...
- Tôi có thể giải thích **Log Analysis Mini SOC** trong 1-2 phút.
...
## 9. Tổng kết
**Log Analysis Mini SOC** là một project portfolio. Hoàn thành nó bằng bằng chứng rõ ràng, báo cáo ngắn gọn và checklist có thể tái sử dụng.
