...
![Hai người hỏi và chỉ đường](../../asset/lesson-06-asking-the-way-conversation.png)
...
```mermaid
flowchart LR
    A[Cần tìm địa điểm] --> B[Excuse me]
    B --> C[Hỏi vị trí hoặc đường đi]
    C --> D[Người kia chỉ đường]
    D --> E{Đã hiểu chưa?}
    E -->|Có| F[Xác nhận khoảng cách / phương tiện]
    E -->|Chưa| G[Hỏi lại chi tiết]
    G --> D
    F --> H[Cảm ơn và kết thúc]
```
...
![excuse me — hỏi đường lịch sự](../../asset/lesson-06-excuse-me.png)
...
![the way to — đường đến một địa điểm](../../asset/lesson-06-way-to.png)
...
![walk along — đi dọc theo con đường](../../asset/lesson-06-walk-along.png)
...
![park — công viên](../../asset/lesson-06-park.png)
...
![street — đường phố](../../asset/lesson-06-street.png)
...
![sea — biển](../../asset/lesson-06-sea.png)
...
![lake — hồ nước](../../asset/lesson-06-lake.png)
...
![city center — trung tâm thành phố](../../asset/lesson-06-center.png)
...
![short way — đường đi ngắn hơn](../../asset/lesson-06-short-way.png)
...
![take a bus — đi xe buýt](../../asset/lesson-06-take-a-bus.png)
...
![on foot — đi bộ](../../asset/lesson-06-on-foot.png)
...
![get off — xuống xe buýt](../../asset/lesson-06-get-off.png)
...
![opposite — hai địa điểm đối diện nhau](../../asset/lesson-06-opposite.png)
...
![turn right — rẽ phải](../../asset/lesson-06-turn-right.png)
...
![turn left — rẽ trái](../../asset/lesson-06-turn-left.png)
...
![crossing — chỗ giao nhau](../../asset/lesson-06-crossing.png)
...
![crossroads — ngã tư](../../asset/lesson-06-crossroads.png)
...
![bus terminal — bến xe](../../asset/lesson-06-terminal.png)
...
![nearest — địa điểm gần nhất](../../asset/lesson-06-nearest.png)
...
![station — nhà ga](../../asset/lesson-06-station.png)
...
![Mẫu câu Excuse me](../../asset/lesson-06-structure-excuse-me.png)
...
![Mẫu câu Where is](../../asset/lesson-06-structure-where-is.png)
...
![Mẫu câu tell me the way](../../asset/lesson-06-structure-tell-me-way.png)
...
![Mẫu câu How can I get to](../../asset/lesson-06-structure-how-can-i-get.png)
...
![Mẫu câu right way](../../asset/lesson-06-structure-right-way.png)
...
![Mẫu câu Turn right](../../asset/lesson-06-structure-turn-right.png)
...
![Mẫu câu Turn left](../../asset/lesson-06-structure-turn-left.png)
...
![Mẫu câu Go straight](../../asset/lesson-06-structure-go-straight.png)
...
![Mẫu câu How far](../../asset/lesson-06-structure-how-far.png)
...
![Mẫu câu How long](../../asset/lesson-06-structure-how-long.png)
...
![Mẫu câu Can I take a bus](../../asset/lesson-06-structure-take-bus.png)
...
![Mẫu câu on foot](../../asset/lesson-06-structure-on-foot.png)
...
![Mẫu câu bus number](../../asset/lesson-06-structure-bus-number.png)
...
![Mẫu câu get off](../../asset/lesson-06-structure-get-off.png)
...
![Mẫu câu Which bus](../../asset/lesson-06-structure-which-bus.png)
...
![Mẫu câu bus stop](../../asset/lesson-06-structure-bus-stop.png)
...
```mermaid
flowchart TD
    A[Cần thông tin địa điểm] --> B{Bạn cần biết gì?}
    B -->|Vị trí| C[Where is ...?]
    B -->|Cách đến đó| D[How can I get to ...?]
    B -->|Chỉ dẫn cụ thể| E[Can you tell me the way to ...?]
    B -->|Xác nhận đường đang đi| F[Is this the right way to ...?]
```
...
![Hội thoại hỏi đường đến khách sạn](../../asset/lesson-06-dialogue-hotel.png)
...
![Hội thoại hỏi xe buýt đến bảo tàng](../../asset/lesson-06-dialogue-museum.png)
...
![Hội thoại tìm nhà ga](../../asset/lesson-06-dialogue-station.png)
