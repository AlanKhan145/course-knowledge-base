...
![Hai người cùng trao đổi và đưa ra gợi ý](../../asset/lesson-05-suggestions-conversation.png)
...
```mermaid
flowchart LR
    A[Nêu vấn đề / tình huống] --> B[Xin phép góp ý]
    B --> C[Đưa ra gợi ý]
    C --> D{Người kia đồng ý?}
    D -->|Có| E[Xác nhận phương án]
    D -->|Chưa| F[Đưa ra phương án khác]
    F --> C
    E --> G[Chốt quyết định]
```
...
![suggestion — đưa ra một đề xuất](../../asset/lesson-05-suggestion.png)
...
![another idea — thêm một ý tưởng](../../asset/lesson-05-another.png)
...
![grandparents — ông bà](../../asset/lesson-05-grandparents.png)
...
![bring — mang theo một vật](../../asset/lesson-05-bring.png)
...
![pick — lựa chọn một phương án](../../asset/lesson-05-pick.png)
...
![interesting — một ý tưởng thú vị](../../asset/lesson-05-interesting.png)
...
![enjoy — tận hưởng cuộc sống](../../asset/lesson-05-enjoy.png)
...
![hate — không thích công việc](../../asset/lesson-05-hate.png)
...
![everything — nhiều điều trong cuộc sống](../../asset/lesson-05-everything.png)
...
![right — lựa chọn đúng](../../asset/lesson-05-right.png)
...
![motorbike — xe máy](../../asset/lesson-05-motorbike.png)
...
![put on — mặc áo](../../asset/lesson-05-put-on.png)
...
![shirt — áo sơ mi](../../asset/lesson-05-shirt.png)
...
![tomorrow — chuyển kế hoạch sang ngày mai](../../asset/lesson-05-tomorrow.png)
...
![give up smoking — bỏ thuốc lá](../../asset/lesson-05-give-up.png)
...
![morning exercises — tập thể dục buổi sáng](../../asset/lesson-05-morning-exercises.png)
...
![too much — ăn quá nhiều](../../asset/lesson-05-too-much.png)
...
![point — thêm một ý kiến](../../asset/lesson-05-point.png)
...
![Mẫu câu make a suggestion](../../asset/lesson-05-structure-make-suggestion.png)
...
![Mẫu câu another idea](../../asset/lesson-05-structure-another-idea.png)
...
![Mẫu câu one more point](../../asset/lesson-05-structure-one-more-point.png)
...
![Mẫu câu Why don't you](../../asset/lesson-05-structure-why-dont-you.png)
...
![Mẫu câu Let's](../../asset/lesson-05-structure-lets.png)
...
![Mẫu câu Shall we](../../asset/lesson-05-structure-shall-we.png)
...
![Mẫu câu Is it okay if](../../asset/lesson-05-structure-is-it-okay.png)
...
![Mẫu câu should](../../asset/lesson-05-structure-should.png)
...
![Mẫu câu If I were you](../../asset/lesson-05-structure-if-i-were-you.png)
...
![Mẫu câu It seems to me](../../asset/lesson-05-structure-it-seems-to-me.png)
...
```mermaid
flowchart TD
    A[Người kia cần ý kiến] --> B{Đang chọn giữa các phương án?}
    B -->|Có| C[Suggestion]
    B -->|Không, đang gặp vấn đề| D[Advice]
    C --> E[Let's / Why don't we / How about]
    D --> F[Should / If I were you / Had better]
```
...
![Hội thoại về công việc và lời khuyên](../../asset/lesson-05-dialogue-job-advice.png)
...
![Hội thoại chọn phương án](../../asset/lesson-05-dialogue-tomorrow.png)
...
![Hội thoại đưa lời khuyên](../../asset/lesson-05-dialogue-advice.png)
