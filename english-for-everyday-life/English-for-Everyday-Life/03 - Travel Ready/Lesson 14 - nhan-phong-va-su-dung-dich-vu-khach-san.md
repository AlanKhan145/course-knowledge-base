...
**Bối cảnh:** Đặt phòng, check-in, yêu cầu dịch vụ và check-out.
...
**A:** Đặt phòng, check-in, yêu cầu dịch vụ và check-out.  
...
Trong hôm nay, hãy viết hoặc nói một đoạn hội thoại 8 lượt cho tình huống **Nhận phòng và sử dụng dịch vụ khách sạn**. Dùng ít nhất 5 từ vựng mới và 3 mẫu câu trong bài.
