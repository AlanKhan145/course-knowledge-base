...
![Khách làm thủ tục nhận phòng tại quầy lễ tân](../../asset/lesson-14-hotel-check-in.png)
...
```mermaid
flowchart LR
    A[Đến khách sạn] --> B{Đã đặt phòng?}

    B -->|Có| C[Give reservation name]
    B -->|Chưa| D[Ask for an available room]

    C --> E[Confirm booking]
    D --> F[Choose room type]

    F --> G[Ask price and preferences]
    E --> H[Fill out the form]
    G --> H

    H --> I[Receive key / key card]

    I --> J[Stay at the hotel]

    J --> K{Need anything?}

    K -->|Housekeeping| L[Request cleaning / towels]
    K -->|Problem| M[Contact reception]
    K -->|Information| N[Ask about Wi-Fi / breakfast]

    L --> O[Check out]
    M --> O
    N --> O

    O --> P[Pay bill / Receive receipt]
```
...
![hotel — khách sạn](../../asset/lesson-14-hotel.png)
...
![reservation — đặt phòng khách sạn](../../asset/lesson-14-reservation.png)
...
![hotel reception — quầy lễ tân](../../asset/lesson-14-reception.png)
...
![receptionist — nhân viên lễ tân khách sạn](../../asset/lesson-14-receptionist.png)
...
![hotel room — phòng khách sạn](../../asset/lesson-14-room.png)
...
![standard hotel room](../../asset/lesson-14-standard-room.png)
...
![hotel suite](../../asset/lesson-14-suite.png)
...
![quiet hotel room](../../asset/lesson-14-quiet-room.png)
...
![available hotel room](../../asset/lesson-14-available-room.png)
...
![vacant hotel room](../../asset/lesson-14-vacant-room.png)
...
![occupied hotel room](../../asset/lesson-14-occupied.png)
...
![fully occupied hotel](../../asset/lesson-14-fully-occupied.png)
...
![twin room — phòng hai giường đơn](../../asset/lesson-14-twin-room.png)
...
![twin beds](../../asset/lesson-14-twin-beds.png)
...
![double hotel room](../../asset/lesson-14-double-room.png)
...
![well-equipped hotel room](../../asset/lesson-14-well-equipped.png)
...
![hotel facilities](../../asset/lesson-14-facilities.png)
...
![hotel amenities](../../asset/lesson-14-amenities.png)
...
![hotel room key](../../asset/lesson-14-key.png)
...
![hotel key card](../../asset/lesson-14-key-card.png)
...
![hotel registration form](../../asset/lesson-14-form.png)
...
![fill out hotel form](../../asset/lesson-14-fill-out-form.png)
...
![hotel stay](../../asset/lesson-14-stay.png)
...
![hotel room preference](../../asset/lesson-14-preference.png)
...
![hotel receipt](../../asset/lesson-14-receipt.png)
...
![hotel bill](../../asset/lesson-14-bill.png)
...
![hotel housekeeping](../../asset/lesson-14-housekeeping.png)
...
![hotel dry cleaning service](../../asset/lesson-14-dry-cleaning.png)
...
![hotel laundry service](../../asset/lesson-14-laundry-service.png)
...
![hotel check-in](../../asset/lesson-14-check-in.png)
...
![hotel check-out](../../asset/lesson-14-check-out.png)
...
![Do you have any rooms available](../../asset/lesson-14-structure-room-available.png)
...
![Do you have a cheap room](../../asset/lesson-14-structure-cheap-room.png)
...
![How much is the room](../../asset/lesson-14-structure-room-price.png)
...
![I'd like a quiet room](../../asset/lesson-14-structure-quiet-room.png)
...
![What kind of room would you like](../../asset/lesson-14-structure-room-type.png)
...
![Standard room or suite](../../asset/lesson-14-structure-standard-suite.png)
...
![We didn't make a reservation](../../asset/lesson-14-structure-no-reservation.png)
...
![I have a reservation](../../asset/lesson-14-structure-have-reservation.png)
...
![Are there just two of you](../../asset/lesson-14-structure-number-guests.png)
...
![How long would you like to stay](../../asset/lesson-14-structure-length-stay.png)
...
![Do you have any preferences](../../asset/lesson-14-structure-preferences.png)
...
![Fill out this form](../../asset/lesson-14-structure-fill-form.png)
...
![May I see the room first](../../asset/lesson-14-structure-see-room.png)
...
![Is the room well equipped](../../asset/lesson-14-structure-equipped.png)
...
![Here's your key card](../../asset/lesson-14-structure-key-card.png)
...
![Hotel Wi-Fi](../../asset/lesson-14-structure-wifi.png)
...
![Hotel breakfast](../../asset/lesson-14-structure-breakfast.png)
...
![Extra towels](../../asset/lesson-14-structure-towels.png)
...
![Hotel housekeeping request](../../asset/lesson-14-structure-housekeeping.png)
...
![Hotel room problem](../../asset/lesson-14-structure-room-problem.png)
...
![Change hotel room](../../asset/lesson-14-structure-change-room.png)
...
![Hotel laundry](../../asset/lesson-14-structure-laundry.png)
...
![Hotel check-out time](../../asset/lesson-14-structure-checkout-time.png)
...
![I'd like to check out](../../asset/lesson-14-structure-check-out.png)
...
![Hotel bill](../../asset/lesson-14-structure-bill.png)
...
![Hotel receipt request](../../asset/lesson-14-structure-receipt.png)
...
![Hội thoại nhận phòng khách sạn](../../asset/lesson-14-dialogue-check-in.png)
...
![Hội thoại có reservation](../../asset/lesson-14-dialogue-reservation.png)
...
![Hội thoại yêu cầu dịch vụ khách sạn](../../asset/lesson-14-dialogue-room-service.png)
...
![Hội thoại báo lỗi phòng khách sạn](../../asset/lesson-14-dialogue-room-problem.png)
...
![Hội thoại hỏi tiện nghi khách sạn](../../asset/lesson-14-dialogue-facilities.png)
...
![Hội thoại check-out](../../asset/lesson-14-dialogue-check-out.png)
...
flowchart LR
    ...
    B --> C[Choose room]
    C --> D[Ask about facilities]
    D --> E[Use hotel services]
    E --> F[Report a problem]
    F --> G[Problem solved]
    G --> H[Check-out]
    H --> I[Pay and receive receipt]
```
