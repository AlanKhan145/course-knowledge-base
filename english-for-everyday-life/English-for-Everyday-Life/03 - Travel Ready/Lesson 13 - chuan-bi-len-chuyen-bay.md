...
![Hành khách đang làm thủ tục check-in tại sân bay](../../asset/lesson-13-airport-check-in.png)
...
```mermaid
flowchart LR
    A[Đến sân bay] --> B[Tìm chuyến bay]
    B --> C[Tìm quầy check-in]
    C --> D[Đưa vé và hộ chiếu]
    D --> E{Có hành lý ký gửi?}

    E -->|Có| F[Cân và gửi hành lý]
    E -->|Không| G[Giữ hành lý xách tay]

    F --> H[Nhận boarding pass]
    G --> H

    H --> I[Kiểm tra gate và boarding time]
    I --> J[Đi đến cửa khởi hành]
    J --> K[Boarding]
```
...
![check in — làm thủ tục tại sân bay](../../asset/lesson-13-check-in.png)
...
![flight — chuyến bay](../../asset/lesson-13-flight.png)
...
![plane ticket — vé máy bay](../../asset/lesson-13-ticket.png)
...
![passport — hộ chiếu](../../asset/lesson-13-passport.png)
...
![luggage — hành lý tại sân bay](../../asset/lesson-13-luggage.png)
...
![suitcase — vali du lịch](../../asset/lesson-13-suitcase.png)
...
![carry-on — hành lý xách tay](../../asset/lesson-13-carry-on.png)
...
![checked baggage — hành lý ký gửi](../../asset/lesson-13-checked-baggage.png)
...
![airport counter — quầy làm thủ tục](../../asset/lesson-13-counter.png)
...
![information desk — quầy thông tin sân bay](../../asset/lesson-13-information-desk.png)
...
![boarding pass — thẻ lên máy bay](../../asset/lesson-13-boarding-pass.png)
...
![airport gate — cửa lên máy bay](../../asset/lesson-13-gate.png)
...
![depart — chuyến bay khởi hành](../../asset/lesson-13-depart.png)
...
![boarding — hành khách lên máy bay](../../asset/lesson-13-boarding.png)
...
![overweight luggage — hành lý quá cân](../../asset/lesson-13-overweight.png)
...
![baggage allowance — giới hạn hành lý](../../asset/lesson-13-baggage-allowance.png)
...
![I'd like to check in](../../asset/lesson-13-structure-check-in.png)
...
```mermaid
flowchart TD
    A[Airport] --> B[Check-in Counter]
    B --> C[Passport + Ticket]
    C --> D[Baggage]
    D --> E{Checked baggage?}

    E -->|Yes| F[Weigh and check baggage]
    E -->|No| G[Carry-on]
...
![Hội thoại check-in tại sân bay](../../asset/lesson-13-dialogue-check-in.png)
...
![Hội thoại hỏi quầy check-in](../../asset/lesson-13-dialogue-find-counter.png)
...
![Hội thoại hành lý quá cân](../../asset/lesson-13-dialogue-overweight-baggage.png)
...
![Hội thoại hỏi đường đến gate](../../asset/lesson-13-dialogue-find-gate.png)
