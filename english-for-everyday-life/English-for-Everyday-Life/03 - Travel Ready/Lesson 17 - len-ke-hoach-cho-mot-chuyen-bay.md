...
![Đặt vé máy bay tại đại lý du lịch](../../asset/lesson-17-booking-plane-ticket.png)
...
```mermaid
flowchart LR
    A[Cần đi máy bay] --> B[Liên hệ hãng bay / đại lý]
    B --> C[Cho biết điểm đến]
    C --> D[Chọn ngày bay]
    D --> E[Chọn loại vé]
    E --> F[Chọn hãng hàng không]
    F --> G[Chọn hạng ghế]
    G --> H[Kiểm tra giờ bay]
    H --> I[Kiểm tra điểm dừng]
    I --> J[Yêu cầu dịch vụ đặc biệt]
    J --> K[Kiểm tra giá / giảm giá]
    K --> L[Thanh toán]
    L --> M[Xác nhận đặt vé]
```
...
![Travel agency — đại lý du lịch](../../asset/lesson-17-travel-agency.png)
...
![Reserve — đặt chỗ trước](../../asset/lesson-17-reserve.png)
...
![Book a flight — đặt chuyến bay](../../asset/lesson-17-book-flight.png)
...
![Return ticket — vé khứ hồi](../../asset/lesson-17-return-ticket.png)
...
![Single ticket — vé một chiều](../../asset/lesson-17-single-ticket.png)
...
![Airline — hãng hàng không](../../asset/lesson-17-airline.png)
...
![Prefer an airline](../../asset/lesson-17-prefer.png)
...
![Check in at airport](../../asset/lesson-17-check-in.png)
...
![Vegetarian meal on a flight](../../asset/lesson-17-vegetarian-meal.png)
...
![Reconfirm flight](../../asset/lesson-17-reconfirm-flight.png)
...
![Air fare](../../asset/lesson-17-airfare.png)
...
![Flight departure board](../../asset/lesson-17-departure-time.png)
...
![Stopover flight](../../asset/lesson-17-stopover.png)
...
![Economy class](../../asset/lesson-17-economy-class.png)
...
![First class seat](../../asset/lesson-17-first-class.png)
...
![I'd like to book a ticket](../../asset/lesson-17-structure-book-ticket.png)
...
![Next flight](../../asset/lesson-17-structure-next-flight.png)
...
![Flight stopover](../../asset/lesson-17-structure-stopover.png)
...
![Vegetarian airline meal](../../asset/lesson-17-structure-vegetarian-meal.png)
...
![Reconfirm booking](../../asset/lesson-17-structure-reconfirm.png)
...
```mermaid
flowchart TD
    A[Destination] --> B[Date]
    B --> C[Single or Return]
    C --> D[Flight]
    D --> E[Airline]
    E --> F[Economy / Business / First]
    F --> G[Departure Time]
    G --> H[Direct / Stopover]
    H --> I[Meal / Special Request]
    I --> J[Fare]
    J --> K[Payment]
    K --> L[Confirmation]
```
...
![Đặt vé tại travel agency](../../asset/lesson-17-dialogue-travel-agency.png)
...
![Đặt vé một chiều](../../asset/lesson-17-dialogue-one-way-ticket.png)
...
![Kiểm tra lịch chuyến bay](../../asset/lesson-17-dialogue-next-flight.png)
...
![Thanh toán vé máy bay](../../asset/lesson-17-dialogue-payment.png)
...
![Xác nhận chuyến bay](../../asset/lesson-17-dialogue-confirm-flight.png)
