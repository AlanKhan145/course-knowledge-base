...
![Hành khách làm thủ tục nhập cảnh tại sân bay](../../asset/lesson-16-immigration-control.png)
...
```mermaid
flowchart LR
    A[Đến sân bay quốc tế] --> B[Immigration]
    B --> C[Passport / Arrival Card]
    C --> D{Purpose of visit?}

    D -->|Tourism| E[Sightseeing / Vacation]
    D -->|Business| F[Business trip]
    D -->|Other| G[Explain purpose]

    E --> H[Length of stay]
    F --> H
    G --> H

    H --> I[Accommodation / Return ticket]
    I --> J[Passport check]
    J --> K[Customs]

    K --> L{Anything to declare?}
    L -->|No| M[Nothing to declare]
    L -->|Yes| N[Declare goods]

    M --> O[Enter the country]
    N --> P[Luggage inspection]
    P --> O
```
...
![immigration — khu vực kiểm tra nhập cảnh](../../asset/lesson-16-immigration.png)
...
![immigration officer — nhân viên kiểm tra hộ chiếu](../../asset/lesson-16-immigration-officer.png)
...
![passport — hộ chiếu du lịch quốc tế](../../asset/lesson-16-passport.png)
...
![arrival card — thẻ thông tin nhập cảnh](../../asset/lesson-16-arrival-card.png)
...
![immigration form — mẫu khai thông tin nhập cảnh](../../asset/lesson-16-immigration-form.png)
...
![purpose of visit — câu hỏi tại quầy nhập cảnh](../../asset/lesson-16-purpose-of-visit.png)
...
![sightseeing — khách du lịch tham quan](../../asset/lesson-16-sightseeing.png)
...
![vacation — chuyến du lịch nghỉ dưỡng](../../asset/lesson-16-vacation.png)
...
![business trip — chuyến đi công tác](../../asset/lesson-16-business-trip.png)
...
![length of stay — thời gian ở lại quốc gia](../../asset/lesson-16-length-of-stay.png)
...
![return ticket — vé máy bay khứ hồi](../../asset/lesson-16-return-ticket.png)
...
![accommodation — khách sạn và nơi lưu trú](../../asset/lesson-16-accommodation.png)
...
![customs — khu vực kiểm tra hải quan](../../asset/lesson-16-customs.png)
...
![customs officer — nhân viên hải quan kiểm tra hành lý](../../asset/lesson-16-customs-officer.png)
...
![customs declaration — tờ khai hàng hóa](../../asset/lesson-16-customs-declaration.png)
...
![declare — khai báo hàng hóa tại hải quan](../../asset/lesson-16-declare.png)
...
![oral declaration — khai báo trực tiếp với hải quan](../../asset/lesson-16-oral-declaration.png)
...
![luggage — hành lý và vali tại sân bay](../../asset/lesson-16-luggage.png)
...
![examine luggage — kiểm tra hành lý](../../asset/lesson-16-examine-luggage.png)
...
![tour group — đoàn khách du lịch](../../asset/lesson-16-tour-group.png)
...
![travel agency — công ty tổ chức chuyến đi](../../asset/lesson-16-travel-agency.png)
...
![May I have your passport — yêu cầu xuất trình hộ chiếu](../../asset/lesson-16-structure-passport.png)
...
![Purpose of visit — câu hỏi nhập cảnh](../../asset/lesson-16-structure-purpose.png)
...
![How long will you stay — thời gian lưu trú](../../asset/lesson-16-structure-length-of-stay.png)
...
![Return ticket — xuất trình vé quay về](../../asset/lesson-16-structure-return-ticket.png)
...
![Anything to declare — khai báo hải quan](../../asset/lesson-16-structure-declare.png)
...
![Examine luggage — kiểm tra hành lý tại hải quan](../../asset/lesson-16-structure-examine-luggage.png)
...
```mermaid
flowchart TD
    A[International Arrival] --> B[Immigration]
    B --> B1[Passport]
    B --> B2[Visa]
    B --> B3[Purpose]
    B --> B4[Length of stay]
...
![Hội thoại tại quầy nhập cảnh](../../asset/lesson-16-dialogue-immigration.png)
...
![Du khách đi theo tour group](../../asset/lesson-16-dialogue-tour-group.png)
...
![Hội thoại khai báo hải quan](../../asset/lesson-16-dialogue-customs.png)
...
![Nothing to declare — qua khu vực hải quan](../../asset/lesson-16-dialogue-nothing-to-declare.png)
