# 001 - Advanced Frontend Orientation

**Hoc phan:** 05 - Advanced Frontend Foundation
**Module:** Module 19 - Advanced Frontend
**Nguon roadmap:** 13. Advanced Frontend
**Loai bai:** Overview
...
- Giai thich duoc Advanced Frontend Orientation bang ngon ngu cua ban.
- Nhan biet khi nao kien thuc nay xuat hien trong mot project frontend.
- Thuc hanh mot vi du nho va ghi lai loi thuong gap.

## 3. Khai niem chinh

- Advanced Frontend Orientation la mot moc kien thuc trong module Advanced Frontend.
...
- Toi co the giai thich **Advanced Frontend Orientation** trong 1-2 phut.
...
**Advanced Frontend Orientation** la mot vien gach trong lo trinh frontend. Dung bai nay nhu mot diem neo: hieu khai niem, lam vi du nho, roi gan no vao project that de kien thuc khong bi roi rac.
