...
**Module:** Module 01 - Internet
**Nguon roadmap:** 01. Internet
**Loai bai:** Lesson
...
Bai nay giai thich How does the internet work? trong boi canh lap trinh frontend hien dai. Sau bai hoc, ban nen hieu khai niem, biet vi sao no quan trong va co mot bai tap nho de dua vao project.

## 2. Muc tieu hoc tap

- Giai thich duoc How does the internet work? bang ngon ngu cua ban.
...
- Toi co the giai thich **How does the internet work?** trong 1-2 phut.
...
**How does the internet work?** la mot vien gach trong lo trinh frontend. Dung bai nay nhu mot diem neo: hieu khai niem, lam vi du nho, roi gan no vao project that de kien thuc khong bi roi rac.
