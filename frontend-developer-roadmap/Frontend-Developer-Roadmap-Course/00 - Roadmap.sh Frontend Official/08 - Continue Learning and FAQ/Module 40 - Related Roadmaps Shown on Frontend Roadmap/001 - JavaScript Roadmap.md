# 001 - JavaScript Roadmap

**Hoc phan:** 08 - Continue Learning and FAQ
**Module:** Module 40 - Related Roadmaps Shown on Frontend Roadmap
**Nguon roadmap:** 34. Related Roadmaps Shown on Frontend Roadmap
**Loai bai:** Related
...
Bai nay gioi thieu JavaScript Roadmap nhu mot lo trinh mo rong. Muc tieu la biet khi nao can di sau vao roadmap nay va cach bien no thanh ke hoach hoc co project.
...
- JavaScript Roadmap la lo trinh mo rong nen hoc sau khi nam module hien tai.
...
- Toi co the giai thich **JavaScript Roadmap** trong 1-2 phut.
...
**JavaScript Roadmap** la mot vien gach trong lo trinh frontend. Dung bai nay nhu mot diem neo: hieu khai niem, lam vi du nho, roi gan no vao project that de kien thuc khong bi roi rac.
