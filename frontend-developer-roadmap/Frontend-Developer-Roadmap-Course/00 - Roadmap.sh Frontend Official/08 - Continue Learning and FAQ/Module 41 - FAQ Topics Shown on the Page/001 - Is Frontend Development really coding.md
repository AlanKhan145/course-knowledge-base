# 001 - Is Frontend Development really coding?
...
Co. Frontend development la coding that su: ban viet HTML, CSS, JavaScript/TypeScript, lam viec voi API, state, performance, accessibility, security va deployment.
...
- Is Frontend Development really coding? la mot moc kien thuc trong module FAQ Topics Shown on the Page.
...
- Toi co the giai thich **Is Frontend Development really coding?** trong 1-2 phut.
...
**Is Frontend Development really coding?** la mot vien gach trong lo trinh frontend. Dung bai nay nhu mot diem neo: hieu khai niem, lam vi du nho, roi gan no vao project that de kien thuc khong bi roi rac.
