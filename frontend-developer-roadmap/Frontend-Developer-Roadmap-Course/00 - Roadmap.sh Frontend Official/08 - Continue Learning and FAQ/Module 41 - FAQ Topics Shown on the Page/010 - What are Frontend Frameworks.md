# 010 - What are Frontend Frameworks?
...
Frontend framework la bo cong cu va convention giup xay UI co component, state, routing, rendering va build workflow nhanh hon.
...
- What are Frontend Frameworks? la mot moc kien thuc trong module FAQ Topics Shown on the Page.
...
- Toi co the giai thich **What are Frontend Frameworks?** trong 1-2 phut.
...
**What are Frontend Frameworks?** la mot vien gach trong lo trinh frontend. Dung bai nay nhu mot diem neo: hieu khai niem, lam vi du nho, roi gan no vao project that de kien thuc khong bi roi rac.
