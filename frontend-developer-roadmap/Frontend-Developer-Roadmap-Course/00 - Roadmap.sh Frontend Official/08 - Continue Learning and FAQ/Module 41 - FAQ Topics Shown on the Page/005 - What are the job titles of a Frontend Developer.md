# 005 - What are the job titles of a Frontend Developer?
...
Cac title thuong gap gom Frontend Developer, Frontend Engineer, UI Engineer, Web Developer, React Developer, Angular Developer va Design Systems Engineer.
...
- What are the job titles of a Frontend Developer? la mot moc kien thuc trong module FAQ Topics Shown on the Page.
...
- Toi co the giai thich **What are the job titles of a Frontend Developer?** trong 1-2 phut.
...
**What are the job titles of a Frontend Developer?** la mot vien gach trong lo trinh frontend. Dung bai nay nhu mot diem neo: hieu khai niem, lam vi du nho, roi gan no vao project that de kien thuc khong bi roi rac.
