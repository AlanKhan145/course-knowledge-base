# 003 - How to prepare for a frontend developer interview?
...
Tap trung vao JavaScript, browser, HTML/CSS, accessibility, framework dang dung, testing, API, system thinking va kha nang giai thich trade-off.
...
- How to prepare for a frontend developer interview? la mot moc kien thuc trong module FAQ Topics Shown on the Page.
...
- Toi co the giai thich **How to prepare for a frontend developer interview?** trong 1-2 phut.
...
**How to prepare for a frontend developer interview?** la mot vien gach trong lo trinh frontend. Dung bai nay nhu mot diem neo: hieu khai niem, lam vi du nho, roi gan no vao project that de kien thuc khong bi roi rac.
