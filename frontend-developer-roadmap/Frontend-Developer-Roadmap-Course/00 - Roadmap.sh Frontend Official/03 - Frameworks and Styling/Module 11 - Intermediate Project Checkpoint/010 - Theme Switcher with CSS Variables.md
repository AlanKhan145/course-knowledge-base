# 010 - Theme Switcher with CSS Variables

**Hoc phan:** 03 - Frameworks and Styling
**Module:** Module 11 - Intermediate Project Checkpoint
**Nguon roadmap:** 11. Intermediate project ideas from roadmap.sh/frontend/projects
**Loai bai:** Project
...
- Xay dung mot phien ban hoan chinh cua **Theme Switcher with CSS Variables**.
- Chung minh ky nang tu module **Intermediate Project Checkpoint** va cac module truoc do.
