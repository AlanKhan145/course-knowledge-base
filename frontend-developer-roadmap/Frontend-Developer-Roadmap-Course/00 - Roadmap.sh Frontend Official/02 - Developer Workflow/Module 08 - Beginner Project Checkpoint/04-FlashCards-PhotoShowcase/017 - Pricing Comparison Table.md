# 017 - Pricing Comparison Table

**Hoc phan:** 02 - Developer Workflow
**Module:** Module 08 - Beginner Project Checkpoint
**Nguon roadmap:** 08. Beginner project ideas from roadmap.sh/frontend/projects
**Loai bai:** Project
...
- Xay dung mot phien ban hoan chinh cua **Pricing Comparison Table**.
- Chung minh ky nang tu module **Beginner Project Checkpoint** va cac module truoc do.
