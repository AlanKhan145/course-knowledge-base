# Module 05 — Forcefields — Bài 003: Charge Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 2:44 |
...
- Hiểu vai trò của **Charge Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Charge Forcefield**.
