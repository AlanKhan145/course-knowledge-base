# Module 05 — Forcefields — Bài 012: Drag Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 3:03 |
...
- Hiểu vai trò của **Drag Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Drag Forcefield**.
