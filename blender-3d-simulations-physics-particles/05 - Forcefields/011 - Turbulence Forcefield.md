# Module 05 — Forcefields — Bài 011: Turbulence Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 3:56 |
...
- Hiểu vai trò của **Turbulence Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Turbulence Forcefield**.
