# Module 05 — Forcefields — Bài 010: Curve Guide Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 13:54 |
...
- Hiểu vai trò của **Curve Guide Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Curve Guide Forcefield**.
