# Module 05 — Forcefields — Bài 007: Harmonic Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 7:27 |
...
- Hiểu vai trò của **Harmonic Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Harmonic Forcefield**.
