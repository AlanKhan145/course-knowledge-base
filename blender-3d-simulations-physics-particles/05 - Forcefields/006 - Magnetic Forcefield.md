# Module 05 — Forcefields — Bài 006: Magnetic Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 3:32 |
...
- Hiểu vai trò của **Magnetic Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Magnetic Forcefield**.
