# Module 05 — Forcefields — Bài 005: Vortex Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 6:32 |
...
- Hiểu vai trò của **Vortex Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Vortex Forcefield**.
