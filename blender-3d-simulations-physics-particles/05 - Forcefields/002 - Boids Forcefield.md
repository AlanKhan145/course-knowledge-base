# Module 05 — Forcefields — Bài 002: Boids Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 5:46 |
...
- Hiểu vai trò của **Boids Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Boids Forcefield**.
