# Module 05 — Forcefields — Bài 001: Force Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 27:38 |
...
- Hiểu vai trò của **Force Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Force Forcefield**.
