# Module 05 — Forcefields — Bài 013: Làm cỏ chuyển động theo gió

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 19:20 |
...
- Hiểu vai trò của **Làm cỏ chuyển động theo gió** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Làm cỏ chuyển động theo gió**.
