# Module 05 — Forcefields — Bài 008: Lennard-Jones Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 3:30 |
...
- Hiểu vai trò của **Lennard-Jones Forcefield** trong pipeline điều khiển hướng, nhiễu, xoáy và lực cản.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Lennard-Jones Forcefield**.
