# Module 03 — Cloth Physics — Bài 002: Internal Springs

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 17:04 |
...
- Hiểu vai trò của **Internal Springs** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
- Dựng một scene test nhỏ cho chủ đề “Internal Springs”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Internal Springs**.
2. Dựng một scene test nhỏ cho chủ đề “Internal Springs”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
