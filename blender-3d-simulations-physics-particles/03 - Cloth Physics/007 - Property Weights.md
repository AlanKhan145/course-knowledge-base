# Module 03 — Cloth Physics — Bài 007: Property Weights
...
- Hiểu vai trò của **Property Weights** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
- Dựng một scene test nhỏ cho chủ đề “Property Weights”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Property Weights**.
2. Dựng một scene test nhỏ cho chủ đề “Property Weights”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
