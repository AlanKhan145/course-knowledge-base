# Module 03 — Cloth Physics — Bài 004: Cloth Cache

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 10:53 |
...
- Hiểu vai trò của **Cloth Cache** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Cloth Cache**.
