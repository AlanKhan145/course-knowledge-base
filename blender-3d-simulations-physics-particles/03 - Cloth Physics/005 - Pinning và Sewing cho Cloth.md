# Module 03 — Cloth Physics — Bài 005: Pinning và Sewing cho Cloth
...
- Hiểu vai trò của **Pinning và Sewing cho Cloth** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Pinning và Sewing cho Cloth**.
