# Module 03 — Cloth Physics — Bài 010: Animation với Cloth
...
- Hiểu vai trò của **Animation với Cloth** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Animation với Cloth**.
