# Module 03 — Cloth Physics — Bài 008: Cloth Field Weights

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 4:43 |
...
- Hiểu vai trò của **Cloth Field Weights** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Cloth Field Weights**.
