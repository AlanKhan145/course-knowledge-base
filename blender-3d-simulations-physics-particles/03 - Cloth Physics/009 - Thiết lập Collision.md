# Module 03 — Cloth Physics — Bài 009: Thiết lập Collision

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 25:49 |
...
- Hiểu vai trò của **Thiết lập Collision** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
- Dựng một scene test nhỏ cho chủ đề “Thiết lập Collision”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Thiết lập Collision**.
2. Dựng một scene test nhỏ cho chủ đề “Thiết lập Collision”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
