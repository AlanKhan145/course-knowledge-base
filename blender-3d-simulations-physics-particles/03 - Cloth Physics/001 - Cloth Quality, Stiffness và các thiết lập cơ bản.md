# Module 03 — Cloth Physics — Bài 001: Cloth Quality, Stiffness và các thiết lập cơ bản

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 27:44 |
...
- Hiểu vai trò của **Cloth Quality, Stiffness và các thiết lập cơ bản** trong pipeline vải, biến dạng bề mặt và tương tác với collider.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Cloth Quality, Stiffness và các thiết lập cơ bản**.
