# Module 01 — Getting Started With Blender — Bài 006: Di chuyển và thao tác với Object

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 9:57 |
| Hệ thống | Blender interface, Object Mode, Edit Mode, transform và keyframe |
| Trọng tâm | nền tảng thao tác và kiểm tra animation |

> Đây là lesson note thực hành được biên soạn từ tên bài và curriculum. Không phải bản chép lời giảng.

## Mục tiêu bài học

- Hiểu vai trò của **Di chuyển và thao tác với Object** trong pipeline nền tảng thao tác và kiểm tra animation.
...
- Dựng một scene test nhỏ cho chủ đề “Di chuyển và thao tác với Object”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Di chuyển và thao tác với Object**.
2. Dựng một scene test nhỏ cho chủ đề “Di chuyển và thao tác với Object”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
3. Chạy lại từ đầu timeline, kiểm tra viewport từ góc camera và lưu một phiên bản ổn định.

## Lỗi thường gặp

- nhầm Object Mode với Edit Mode.
- đặt keyframe sai thuộc tính.
- chưa kiểm tra scale trước khi chuyển sang physics.
