# Module 01 — Getting Started With Blender — Bài 003: Tải xuống và cài đặt Blender

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 3:28 |
...
- Hiểu vai trò của **Tải xuống và cài đặt Blender** trong pipeline nền tảng thao tác và kiểm tra animation.
...
- Dựng một scene test nhỏ cho chủ đề “Tải xuống và cài đặt Blender”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Tải xuống và cài đặt Blender**.
2. Dựng một scene test nhỏ cho chủ đề “Tải xuống và cài đặt Blender”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
