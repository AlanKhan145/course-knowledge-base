# Module 01 — Getting Started With Blender — Bài 002: Giới thiệu khóa học

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 2:39 |
...
- Hiểu vai trò của **Giới thiệu khóa học** trong pipeline nền tảng thao tác và kiểm tra animation.
...
- Dựng một scene test nhỏ cho chủ đề “Giới thiệu khóa học”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Giới thiệu khóa học**.
2. Dựng một scene test nhỏ cho chủ đề “Giới thiệu khóa học”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
