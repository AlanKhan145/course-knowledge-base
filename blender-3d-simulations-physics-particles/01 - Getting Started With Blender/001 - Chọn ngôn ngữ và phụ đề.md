# Module 01 — Getting Started With Blender — Bài 001: Chọn ngôn ngữ và phụ đề

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 3:44 |
...
- Hiểu vai trò của **Chọn ngôn ngữ và phụ đề** trong pipeline nền tảng thao tác và kiểm tra animation.
...
- Dựng một scene test nhỏ cho chủ đề “Chọn ngôn ngữ và phụ đề”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Chọn ngôn ngữ và phụ đề**.
2. Dựng một scene test nhỏ cho chủ đề “Chọn ngôn ngữ và phụ đề”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
