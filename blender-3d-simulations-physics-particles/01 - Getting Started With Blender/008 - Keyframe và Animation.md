# Module 01 — Getting Started With Blender — Bài 008: Keyframe và Animation

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 11:23 |
...
- Hiểu vai trò của **Keyframe và Animation** trong pipeline nền tảng thao tác và kiểm tra animation.
...
- Dựng một scene test nhỏ cho chủ đề “Keyframe và Animation”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Keyframe và Animation**.
2. Dựng một scene test nhỏ cho chủ đề “Keyframe và Animation”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
