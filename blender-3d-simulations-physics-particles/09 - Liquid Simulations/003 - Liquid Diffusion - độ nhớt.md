# Module 09 — Liquid Simulations — Bài 003: Liquid Diffusion / độ nhớt
...
- Hiểu vai trò của **Liquid Diffusion / độ nhớt** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Liquid Diffusion / độ nhớt**.
