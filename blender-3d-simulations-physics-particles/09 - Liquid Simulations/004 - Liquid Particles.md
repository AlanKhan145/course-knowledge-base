# Module 09 — Liquid Simulations — Bài 004: Liquid Particles

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 11:20 |
...
- Hiểu vai trò của **Liquid Particles** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Liquid Particles**.
