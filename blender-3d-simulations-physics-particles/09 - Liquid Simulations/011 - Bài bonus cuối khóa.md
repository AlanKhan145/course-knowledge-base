# Module 09 — Liquid Simulations — Bài 011: Bài bonus cuối khóa

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 1:24 |
...
- Hiểu vai trò của **Bài bonus cuối khóa** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
- Dựng một scene test nhỏ cho chủ đề “Bài bonus cuối khóa”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Bài bonus cuối khóa**.
2. Dựng một scene test nhỏ cho chủ đề “Bài bonus cuối khóa”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
