# Module 09 — Liquid Simulations — Bài 008: Animation thác nước

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 22:35 |
...
- Hiểu vai trò của **Animation thác nước** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Animation thác nước**.
