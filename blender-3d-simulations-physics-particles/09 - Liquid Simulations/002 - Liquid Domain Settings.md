# Module 09 — Liquid Simulations — Bài 002: Liquid Domain Settings

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 18:59 |
...
- Hiểu vai trò của **Liquid Domain Settings** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Liquid Domain Settings**.
