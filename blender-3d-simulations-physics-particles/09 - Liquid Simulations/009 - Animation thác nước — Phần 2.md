# Module 09 — Liquid Simulations — Bài 009: Animation thác nước — Phần 2

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 18:28 |
...
- Hiểu vai trò của **Animation thác nước — Phần 2** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Animation thác nước — Phần 2**.
