# Module 09 — Liquid Simulations — Bài 005: Liquid Mesh

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 12:06 |
...
- Hiểu vai trò của **Liquid Mesh** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Liquid Mesh**.
