# Module 09 — Liquid Simulations — Bài 010: Animation thác nước — Phần 3

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 22:45 |
...
- Hiểu vai trò của **Animation thác nước — Phần 3** trong pipeline dòng chảy, độ nhớt, bề mặt chất lỏng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Animation thác nước — Phần 3**.
