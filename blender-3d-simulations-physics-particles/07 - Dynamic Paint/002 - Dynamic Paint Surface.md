# Module 07 — Dynamic Paint — Bài 002: Dynamic Paint Surface

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 24:25 |
...
- Hiểu vai trò của **Dynamic Paint Surface** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Dynamic Paint Surface**.
