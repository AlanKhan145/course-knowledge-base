# Module 07 — Dynamic Paint — Bài 007: Brush Velocity Settings
...
- Hiểu vai trò của **Brush Velocity Settings** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
- Dựng một scene test nhỏ cho chủ đề “Brush Velocity Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Brush Velocity Settings**.
2. Dựng một scene test nhỏ cho chủ đề “Brush Velocity Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
