# Module 07 — Dynamic Paint — Bài 011: Hiệu ứng giọt mưa, splash và vũng nước

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 26:29 |
...
- Hiểu vai trò của **Hiệu ứng giọt mưa, splash và vũng nước** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hiệu ứng giọt mưa, splash và vũng nước**.
