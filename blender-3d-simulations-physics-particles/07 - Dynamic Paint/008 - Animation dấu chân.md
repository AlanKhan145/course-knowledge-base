# Module 07 — Dynamic Paint — Bài 008: Animation dấu chân

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 39:36 |
...
- Hiểu vai trò của **Animation dấu chân** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Animation dấu chân**.
