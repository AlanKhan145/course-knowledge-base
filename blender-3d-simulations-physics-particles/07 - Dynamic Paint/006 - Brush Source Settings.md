# Module 07 — Dynamic Paint — Bài 006: Brush Source Settings

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 17:07 |
...
- Hiểu vai trò của **Brush Source Settings** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
- Dựng một scene test nhỏ cho chủ đề “Brush Source Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Brush Source Settings**.
2. Dựng một scene test nhỏ cho chủ đề “Brush Source Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
