# Module 07 — Dynamic Paint — Bài 003: Dynamic Paint Effects

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 9:19 |
...
- Hiểu vai trò của **Dynamic Paint Effects** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Dynamic Paint Effects**.
