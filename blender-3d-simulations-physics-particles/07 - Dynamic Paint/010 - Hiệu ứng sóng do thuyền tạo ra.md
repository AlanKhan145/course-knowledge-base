# Module 07 — Dynamic Paint — Bài 010: Hiệu ứng sóng do thuyền tạo ra

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 15:27 |
...
- Hiểu vai trò của **Hiệu ứng sóng do thuyền tạo ra** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hiệu ứng sóng do thuyền tạo ra**.
