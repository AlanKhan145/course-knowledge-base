# Module 07 — Dynamic Paint — Bài 009: Hiệu ứng cào/xước bề mặt

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 20:02 |
...
- Hiểu vai trò của **Hiệu ứng cào/xước bề mặt** trong pipeline dấu vết, màu, displacement, sóng và splash.
...
- Dựng một scene test nhỏ cho chủ đề “Hiệu ứng cào/xước bề mặt”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hiệu ứng cào/xước bề mặt**.
2. Dựng một scene test nhỏ cho chủ đề “Hiệu ứng cào/xước bề mặt”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
