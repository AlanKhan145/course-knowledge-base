# Module 02 — Rigid Body Physics — Bài 009: Damping cho Translation và Rotation

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 7:08 |
...
- Hiểu vai trò của **Damping cho Translation và Rotation** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Damping cho Translation và Rotation”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Damping cho Translation và Rotation**.
2. Dựng một scene test nhỏ cho chủ đề “Damping cho Translation và Rotation”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
