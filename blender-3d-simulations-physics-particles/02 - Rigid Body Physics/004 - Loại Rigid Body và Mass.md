# Module 02 — Rigid Body Physics — Bài 004: Loại Rigid Body và Mass
...
- Hiểu vai trò của **Loại Rigid Body và Mass** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Loại Rigid Body và Mass”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Loại Rigid Body và Mass**.
2. Dựng một scene test nhỏ cho chủ đề “Loại Rigid Body và Mass”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
