# Module 02 — Rigid Body Physics — Bài 017: Hinge Rigid Body Constraint

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 24:17 |
...
- Hiểu vai trò của **Hinge Rigid Body Constraint** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hinge Rigid Body Constraint**.
