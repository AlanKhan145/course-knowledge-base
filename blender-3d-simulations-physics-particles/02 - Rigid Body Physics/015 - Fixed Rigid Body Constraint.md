# Module 02 — Rigid Body Physics — Bài 015: Fixed Rigid Body Constraint

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 11:18 |
...
- Hiểu vai trò của **Fixed Rigid Body Constraint** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Fixed Rigid Body Constraint**.
