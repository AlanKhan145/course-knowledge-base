# Module 02 — Rigid Body Physics — Bài 006: Friction và độ nảy

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 9:34 |
...
- Hiểu vai trò của **Friction và độ nảy** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Friction và độ nảy”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Friction và độ nảy**.
2. Dựng một scene test nhỏ cho chủ đề “Friction và độ nảy”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
