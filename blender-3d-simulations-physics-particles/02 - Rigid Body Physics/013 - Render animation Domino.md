# Module 02 — Rigid Body Physics — Bài 013: Render animation Domino

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 11:57 |
...
- Hiểu vai trò của **Render animation Domino** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Render animation Domino**.
