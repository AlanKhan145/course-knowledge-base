# Module 02 — Rigid Body Physics — Bài 011: Mô phỏng Domino bằng Rigid Body

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 42:51 |
...
- Hiểu vai trò của **Mô phỏng Domino bằng Rigid Body** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng chuỗi domino, kiểm tra thứ tự va chạm và giữ nhịp chuyển động đủ rõ trong camera.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Mô phỏng Domino bằng Rigid Body**.
2. Dựng chuỗi domino, kiểm tra thứ tự va chạm và giữ nhịp chuyển động đủ rõ trong camera.
