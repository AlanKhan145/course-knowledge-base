# Module 02 — Rigid Body Physics — Bài 007: Collision Margin

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 4:26 |
...
- Hiểu vai trò của **Collision Margin** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Collision Margin”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Collision Margin**.
2. Dựng một scene test nhỏ cho chủ đề “Collision Margin”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
