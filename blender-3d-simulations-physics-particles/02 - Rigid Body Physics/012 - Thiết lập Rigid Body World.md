# Module 02 — Rigid Body Physics — Bài 012: Thiết lập Rigid Body World

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 32:30 |
...
- Hiểu vai trò của **Thiết lập Rigid Body World** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Thiết lập Rigid Body World”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Thiết lập Rigid Body World**.
2. Dựng một scene test nhỏ cho chủ đề “Thiết lập Rigid Body World”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
