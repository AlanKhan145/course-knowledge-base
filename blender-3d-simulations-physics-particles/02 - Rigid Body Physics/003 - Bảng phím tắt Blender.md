# Module 02 — Rigid Body Physics — Bài 003: Bảng phím tắt Blender

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 2:05 |
...
- Hiểu vai trò của **Bảng phím tắt Blender** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Bảng phím tắt Blender”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Bảng phím tắt Blender**.
2. Dựng một scene test nhỏ cho chủ đề “Bảng phím tắt Blender”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
