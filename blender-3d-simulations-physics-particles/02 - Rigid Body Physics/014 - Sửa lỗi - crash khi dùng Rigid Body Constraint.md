# Module 02 — Rigid Body Physics — Bài 014: Sửa lỗi/crash khi dùng Rigid Body Constraint
...
- Hiểu vai trò của **Sửa lỗi/crash khi dùng Rigid Body Constraint** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Sửa lỗi/crash khi dùng Rigid Body Constraint**.
