# Module 02 — Rigid Body Physics — Bài 027: Thêm asset vào scene

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 14:49 |
...
- Hiểu vai trò của **Thêm asset vào scene** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Thêm asset vào scene”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Thêm asset vào scene**.
2. Dựng một scene test nhỏ cho chủ đề “Thêm asset vào scene”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
