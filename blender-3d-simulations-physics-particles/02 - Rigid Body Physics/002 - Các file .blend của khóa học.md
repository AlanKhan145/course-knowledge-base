# Module 02 — Rigid Body Physics — Bài 002: Các file .blend của khóa học

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 0:10 |
...
- Hiểu vai trò của **Các file .blend của khóa học** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Các file .blend của khóa học”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Các file .blend của khóa học**.
2. Dựng một scene test nhỏ cho chủ đề “Các file .blend của khóa học”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
