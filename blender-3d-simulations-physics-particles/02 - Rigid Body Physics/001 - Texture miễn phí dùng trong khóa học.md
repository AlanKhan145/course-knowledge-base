# Module 02 — Rigid Body Physics — Bài 001: Texture miễn phí dùng trong khóa học

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 5:41 |
...
- Hiểu vai trò của **Texture miễn phí dùng trong khóa học** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Texture miễn phí dùng trong khóa học**.
