# Module 02 — Rigid Body Physics — Bài 020: Generic Rigid Body Constraint

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 45:50 |
...
- Hiểu vai trò của **Generic Rigid Body Constraint** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Generic Rigid Body Constraint**.
