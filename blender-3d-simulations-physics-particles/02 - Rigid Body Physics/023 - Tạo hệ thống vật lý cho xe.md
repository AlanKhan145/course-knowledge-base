# Module 02 — Rigid Body Physics — Bài 023: Tạo hệ thống vật lý cho xe

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 17:33 |
...
- Hiểu vai trò của **Tạo hệ thống vật lý cho xe** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Tạo hệ thống vật lý cho xe**.
