# Module 02 — Rigid Body Physics — Bài 026: Tạo đường vượt chướng ngại vật

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 15:29 |
...
- Hiểu vai trò của **Tạo đường vượt chướng ngại vật** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Tạo đường vượt chướng ngại vật”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Tạo đường vượt chướng ngại vật**.
2. Dựng một scene test nhỏ cho chủ đề “Tạo đường vượt chướng ngại vật”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
