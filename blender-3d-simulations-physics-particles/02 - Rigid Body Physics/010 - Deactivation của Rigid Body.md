# Module 02 — Rigid Body Physics — Bài 010: Deactivation của Rigid Body

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 6:24 |
...
- Hiểu vai trò của **Deactivation của Rigid Body** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Deactivation của Rigid Body”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Deactivation của Rigid Body**.
2. Dựng một scene test nhỏ cho chủ đề “Deactivation của Rigid Body”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
