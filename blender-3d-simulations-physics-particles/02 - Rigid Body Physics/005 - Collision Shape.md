# Module 02 — Rigid Body Physics — Bài 005: Collision Shape

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 19:52 |
...
- Hiểu vai trò của **Collision Shape** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
- Dựng một scene test nhỏ cho chủ đề “Collision Shape”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Collision Shape**.
2. Dựng một scene test nhỏ cho chủ đề “Collision Shape”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
