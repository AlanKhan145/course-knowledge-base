# Module 02 — Rigid Body Physics — Bài 028: Texture cho scene

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 13:36 |
...
- Hiểu vai trò của **Texture cho scene** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Texture cho scene**.
