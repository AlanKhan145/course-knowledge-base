# Module 02 — Rigid Body Physics — Bài 016: Point Rigid Body Constraint

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 32:36 |
...
- Hiểu vai trò của **Point Rigid Body Constraint** trong pipeline vật thể cứng, va chạm và cơ cấu liên kết.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Point Rigid Body Constraint**.
