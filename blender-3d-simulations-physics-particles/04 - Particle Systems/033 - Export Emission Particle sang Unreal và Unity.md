# Module 04 — Particle Systems — Bài 033: Export Emission Particle sang Unreal và Unity

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 13:38 |
...
- Hiểu vai trò của **Export Emission Particle sang Unreal và Unity** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Export Emission Particle sang Unreal và Unity**.
