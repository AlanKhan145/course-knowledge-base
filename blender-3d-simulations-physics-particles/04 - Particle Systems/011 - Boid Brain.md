# Module 04 — Particle Systems — Bài 011: Boid Brain

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 22:03 |
...
- Hiểu vai trò của **Boid Brain** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Boid Brain**.
