# Module 04 — Particle Systems — Bài 016: Thiết lập Render cho Particle

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 19:33 |
...
- Hiểu vai trò của **Thiết lập Render cho Particle** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Thiết lập Render cho Particle**.
