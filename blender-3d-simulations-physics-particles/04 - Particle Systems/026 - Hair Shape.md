# Module 04 — Particle Systems — Bài 026: Hair Shape

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 4:20 |
...
- Hiểu vai trò của **Hair Shape** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hair Shape**.
