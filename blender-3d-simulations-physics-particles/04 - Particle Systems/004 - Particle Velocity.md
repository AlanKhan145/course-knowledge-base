# Module 04 — Particle Systems — Bài 004: Particle Velocity

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 9:20 |
...
- Hiểu vai trò của **Particle Velocity** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Dựng một scene test nhỏ cho chủ đề “Particle Velocity”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Particle Velocity**.
2. Dựng một scene test nhỏ cho chủ đề “Particle Velocity”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
