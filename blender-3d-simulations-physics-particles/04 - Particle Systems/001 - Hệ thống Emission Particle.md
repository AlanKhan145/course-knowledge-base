# Module 04 — Particle Systems — Bài 001: Hệ thống Emission Particle

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 11:01 |
...
- Hiểu vai trò của **Hệ thống Emission Particle** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Dựng một scene test nhỏ cho chủ đề “Hệ thống Emission Particle”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hệ thống Emission Particle**.
2. Dựng một scene test nhỏ cho chủ đề “Hệ thống Emission Particle”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
