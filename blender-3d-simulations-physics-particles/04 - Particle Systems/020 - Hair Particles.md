# Module 04 — Particle Systems — Bài 020: Hair Particles

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 6:38 |
...
- Hiểu vai trò của **Hair Particles** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hair Particles**.
