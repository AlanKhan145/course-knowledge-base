# Module 04 — Particle Systems — Bài 007: Keyed Physics

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 13:49 |
...
- Hiểu vai trò của **Keyed Physics** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Dựng một scene test nhỏ cho chủ đề “Keyed Physics”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Keyed Physics**.
2. Dựng một scene test nhỏ cho chủ đề “Keyed Physics”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
