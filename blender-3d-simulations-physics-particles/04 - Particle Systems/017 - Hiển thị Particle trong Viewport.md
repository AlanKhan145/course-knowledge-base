# Module 04 — Particle Systems — Bài 017: Hiển thị Particle trong Viewport

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 9:26 |
...
- Hiểu vai trò của **Hiển thị Particle trong Viewport** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Hiển thị Particle trong Viewport**.
