# Module 04 — Particle Systems — Bài 023: Child Particle kiểu Simple

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 18:55 |
...
- Hiểu vai trò của **Child Particle kiểu Simple** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Child Particle kiểu Simple**.
