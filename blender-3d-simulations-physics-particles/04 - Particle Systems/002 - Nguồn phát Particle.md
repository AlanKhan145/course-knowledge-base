# Module 04 — Particle Systems — Bài 002: Nguồn phát Particle

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 15:10 |
...
- Hiểu vai trò của **Nguồn phát Particle** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Dựng một scene test nhỏ cho chủ đề “Nguồn phát Particle”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Nguồn phát Particle**.
2. Dựng một scene test nhỏ cho chủ đề “Nguồn phát Particle”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
