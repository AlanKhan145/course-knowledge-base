# Module 04 — Particle Systems — Bài 003: Particle Cache

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 9:28 |
...
- Hiểu vai trò của **Particle Cache** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Chạy thử một đoạn ngắn, lưu phiên bản setup, cache kết quả rồi xóa cache có chủ đích khi thay đổi thông số.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Particle Cache**.
2. Chạy thử một đoạn ngắn, lưu phiên bản setup, cache kết quả rồi xóa cache có chủ đích khi thay đổi thông số.
