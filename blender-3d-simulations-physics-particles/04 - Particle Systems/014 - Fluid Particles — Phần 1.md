# Module 04 — Particle Systems — Bài 014: Fluid Particles — Phần 1

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 14:19 |
...
- Hiểu vai trò của **Fluid Particles — Phần 1** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Dựng một scene test nhỏ cho chủ đề “Fluid Particles — Phần 1”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Fluid Particles — Phần 1**.
2. Dựng một scene test nhỏ cho chủ đề “Fluid Particles — Phần 1”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
