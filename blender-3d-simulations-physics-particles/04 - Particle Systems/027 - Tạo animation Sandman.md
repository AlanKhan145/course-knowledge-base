# Module 04 — Particle Systems — Bài 027: Tạo animation Sandman

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 38:58 |
...
- Hiểu vai trò của **Tạo animation Sandman** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Dựng một scene test nhỏ cho chủ đề “Tạo animation Sandman”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Tạo animation Sandman**.
2. Dựng một scene test nhỏ cho chủ đề “Tạo animation Sandman”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
