# Module 04 — Particle Systems — Bài 008: Boid Particles

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 15:17 |
...
- Hiểu vai trò của **Boid Particles** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Boid Particles**.
