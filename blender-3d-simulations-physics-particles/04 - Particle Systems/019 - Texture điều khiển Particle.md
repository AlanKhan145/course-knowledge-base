# Module 04 — Particle Systems — Bài 019: Texture điều khiển Particle

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 16:41 |
...
- Hiểu vai trò của **Texture điều khiển Particle** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Chuẩn bị một texture test rõ ràng, kiểm tra mapping và ảnh hưởng của texture ở viewport trước khi dùng trong simulation.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Texture điều khiển Particle**.
2. Chuẩn bị một texture test rõ ràng, kiểm tra mapping và ảnh hưởng của texture ở viewport trước khi dùng trong simulation.
