# Module 04 — Particle Systems — Bài 025: Child Particle kiểu Interpolated

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 6:36 |
...
- Hiểu vai trò của **Child Particle kiểu Interpolated** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Kiểm tra particle gốc và hướng sợi trước, rồi mới tăng child, kink hoặc dynamics để tránh làm viewport quá nặng.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Child Particle kiểu Interpolated**.
2. Kiểm tra particle gốc và hướng sợi trước, rồi mới tăng child, kink hoặc dynamics để tránh làm viewport quá nặng.
