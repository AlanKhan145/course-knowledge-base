# Module 04 — Particle Systems — Bài 005: Particle Rotation
...
- Hiểu vai trò của **Particle Rotation** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
- Dựng một scene test nhỏ cho chủ đề “Particle Rotation”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Particle Rotation**.
2. Dựng một scene test nhỏ cho chủ đề “Particle Rotation”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
