# Module 04 — Particle Systems — Bài 018: Thiết lập Force Field cho Particle

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 10:33 |
...
- Hiểu vai trò của **Thiết lập Force Field cho Particle** trong pipeline hệ hạt, hành vi bầy đàn và hiển thị instance.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Thiết lập Force Field cho Particle**.
