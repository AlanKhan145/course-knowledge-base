# Module 08 — Fire and Smoke — Bài 009: Flow Source và Initial Velocity

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 11:39 |
...
- Hiểu vai trò của **Flow Source và Initial Velocity** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
- Dựng một scene test nhỏ cho chủ đề “Flow Source và Initial Velocity”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Flow Source và Initial Velocity**.
2. Dựng một scene test nhỏ cho chủ đề “Flow Source và Initial Velocity”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
