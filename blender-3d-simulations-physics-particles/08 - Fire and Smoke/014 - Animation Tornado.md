# Module 08 — Fire and Smoke — Bài 014: Animation Tornado

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 22:22 |
...
- Hiểu vai trò của **Animation Tornado** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Animation Tornado**.
