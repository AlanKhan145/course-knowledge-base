# Module 08 — Fire and Smoke — Bài 006: Fire Cache
...
- Hiểu vai trò của **Fire Cache** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Fire Cache**.
