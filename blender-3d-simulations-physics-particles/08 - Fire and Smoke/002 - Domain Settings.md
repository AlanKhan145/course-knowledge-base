# Module 08 — Fire and Smoke — Bài 002: Domain Settings

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 16:25 |
...
- Hiểu vai trò của **Domain Settings** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
- Dựng một scene test nhỏ cho chủ đề “Domain Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Domain Settings**.
2. Dựng một scene test nhỏ cho chủ đề “Domain Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
