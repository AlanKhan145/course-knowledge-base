# Module 08 — Fire and Smoke — Bài 005: Guides và Collections

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 9:33 |
...
- Hiểu vai trò của **Guides và Collections** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
- Dựng một scene test nhỏ cho chủ đề “Guides và Collections”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Guides và Collections**.
2. Dựng một scene test nhỏ cho chủ đề “Guides và Collections”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
