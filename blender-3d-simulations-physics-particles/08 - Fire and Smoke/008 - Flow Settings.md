# Module 08 — Fire and Smoke — Bài 008: Flow Settings

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 10:42 |
...
- Hiểu vai trò của **Flow Settings** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
- Dựng một scene test nhỏ cho chủ đề “Flow Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Flow Settings**.
2. Dựng một scene test nhỏ cho chủ đề “Flow Settings”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
