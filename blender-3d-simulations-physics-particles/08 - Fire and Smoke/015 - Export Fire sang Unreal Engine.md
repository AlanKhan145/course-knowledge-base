# Module 08 — Fire and Smoke — Bài 015: Export Fire sang Unreal Engine

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 6:22 |
...
- Hiểu vai trò của **Export Fire sang Unreal Engine** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Export Fire sang Unreal Engine**.
