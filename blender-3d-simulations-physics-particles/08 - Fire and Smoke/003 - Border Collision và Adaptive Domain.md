# Module 08 — Fire and Smoke — Bài 003: Border Collision và Adaptive Domain

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 7:51 |
...
- Hiểu vai trò của **Border Collision và Adaptive Domain** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
- Dựng một scene test nhỏ cho chủ đề “Border Collision và Adaptive Domain”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Border Collision và Adaptive Domain**.
2. Dựng một scene test nhỏ cho chủ đề “Border Collision và Adaptive Domain”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
