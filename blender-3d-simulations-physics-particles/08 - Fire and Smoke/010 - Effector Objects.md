# Module 08 — Fire and Smoke — Bài 010: Effector Objects
...
- Hiểu vai trò của **Effector Objects** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
- Dựng một scene test nhỏ cho chủ đề “Effector Objects”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Effector Objects**.
2. Dựng một scene test nhỏ cho chủ đề “Effector Objects”, kiểm tra kết quả ở viewport rồi mới đưa vào project chính.
