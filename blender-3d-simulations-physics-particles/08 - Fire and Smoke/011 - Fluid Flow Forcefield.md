# Module 08 — Fire and Smoke — Bài 011: Fluid Flow Forcefield

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 11:50 |
...
- Hiểu vai trò của **Fluid Flow Forcefield** trong pipeline lửa, khói, khí nóng và simulation thể tích.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Fluid Flow Forcefield**.
