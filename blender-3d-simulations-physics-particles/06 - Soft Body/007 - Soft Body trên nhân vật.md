# Module 06 — Soft Body — Bài 007: Soft Body trên nhân vật

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 15:44 |
...
- Hiểu vai trò của **Soft Body trên nhân vật** trong pipeline biến dạng mềm, đàn hồi và ổn định solver.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Soft Body trên nhân vật**.
