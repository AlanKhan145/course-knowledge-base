# Module 06 — Soft Body — Bài 002: Soft Body Goal

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 10:12 |
...
- Hiểu vai trò của **Soft Body Goal** trong pipeline biến dạng mềm, đàn hồi và ổn định solver.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Soft Body Goal**.
