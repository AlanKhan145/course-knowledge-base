# Module 06 — Soft Body — Bài 004: Soft Body Self Collision

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 7:15 |
...
- Hiểu vai trò của **Soft Body Self Collision** trong pipeline biến dạng mềm, đàn hồi và ổn định solver.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Soft Body Self Collision**.
