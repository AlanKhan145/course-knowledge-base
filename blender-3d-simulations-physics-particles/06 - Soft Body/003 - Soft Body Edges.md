# Module 06 — Soft Body — Bài 003: Soft Body Edges

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 16:13 |
...
- Hiểu vai trò của **Soft Body Edges** trong pipeline biến dạng mềm, đàn hồi và ổn định solver.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Soft Body Edges**.
