# Module 06 — Soft Body — Bài 006: Tạo Jello bằng Soft Body

| Thuộc tính | Nội dung |
|---|---|
| Thời lượng tham khảo | 12:28 |
...
- Hiểu vai trò của **Tạo Jello bằng Soft Body** trong pipeline biến dạng mềm, đàn hồi và ổn định solver.
...
1. Mở file thực hành của module và tạo một scene test riêng cho bài **Tạo Jello bằng Soft Body**.
