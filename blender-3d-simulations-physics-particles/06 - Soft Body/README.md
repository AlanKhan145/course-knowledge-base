...
|---:|---|---:|---|
| 001 | Soft Body Object | 5:48 | Thêm và kiểm tra soft body |
| 002 | Soft Body Goal | 10:12 | Giữ object bám hình dạng ban đầu |
| 003 | Soft Body Edges | 16:13 | Độ cứng và liên kết cạnh |
| 004 | Soft Body Self Collision | 7:15 | Ngăn mesh tự xuyên |
| 005 | Soft Body Solver | 8:20 | Quality, step và ổn định |
| 006 | Tạo Jello bằng Soft Body | 12:28 | Project jello hoàn chỉnh |
| 007 | Soft Body trên nhân vật | 15:44 | Biến dạng mềm theo animation |
