...
```mermaid
flowchart TD
    A[Personal Spark] --> B[Story Idea]
    B --> C[Choose a Character]
    C --> D[Place Character at Center of Events]
    D --> E[Give the Character a Problem]
    E --> F[Give the Character a Desire]
    F --> G[Story Movement]
    G --> H[Character Change]
```
