...
```mermaid id="jv9u6v"
flowchart TD
    A[Character Wants Something] --> B[They Cannot Get It Immediately]
    B --> C[Obstacles Appear]
    C --> D[Character Makes Choices]
    D --> E[Conflict Increases]
    E --> F[Goal Is Reached or Lost]
    F --> G[Character Changes]
```
...
```mermaid id="y5ccv4"
flowchart TD
    A[5. Self-Actualization<br/>Purpose, creativity, full potential]
    B[4. Esteem<br/>Respect, recognition, achievement]
    C[3. Love and Belonging<br/>Relationships, family, intimacy, acceptance]
    D[2. Safety<br/>Protection, shelter, stability, survival security]
    E[1. Physiological Needs<br/>Food, water, sleep, basic survival]
