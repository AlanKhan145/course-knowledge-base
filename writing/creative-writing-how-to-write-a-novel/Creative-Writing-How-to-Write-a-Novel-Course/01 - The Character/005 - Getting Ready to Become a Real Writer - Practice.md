...
```mermaid
flowchart TD
    A[You have a story idea] --> B{Do you want to develop it seriously?}
    B -->|Yes| C[Commit to writing practice]
    B -->|Not yet| D[Use the free lessons as a starting point]
    ...
    E --> I[Build a stronger story]
    F --> I
    G --> I
    H --> I

    I --> J[Complete your novel or short story]
```
