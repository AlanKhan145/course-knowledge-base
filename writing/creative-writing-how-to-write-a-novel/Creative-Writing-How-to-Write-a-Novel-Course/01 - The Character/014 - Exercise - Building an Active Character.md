...
```mermaid id="vbe6tn"
flowchart TD
    A[Character Wants Something] --> B[Character Makes a Choice]
    B --> C[Character Takes Action]
    C --> D[Action Creates Resistance]
    D --> E[Character Adjusts or Escalates]
    E --> F[New Consequence Appears]
    F --> G[Next Scene Becomes Necessary]
```
