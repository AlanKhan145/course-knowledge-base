...
```mermaid id="rya6f5"
flowchart TD
    A[Character Personality] --> B[Word Choice]
    A --> C[Sentence Rhythm]
    A --> D[What They Say]
    A --> E[What They Avoid Saying]
    A --> F[How They React]
    B --> G[Dialogue Voice]
    C --> G
    D --> G
    E --> G
    F --> G
    G --> H[Reader Understands Character]
```
...
```mermaid id="ndrdvm"
flowchart LR
    A[What Character Thinks] --> B[What Character Hides]
    B --> C[What Character Says]
    C --> D[What Reader Notices]
    D --> E[Subtext]
    E --> F[Deeper Character Revelation]
```
