...
```mermaid id="interior-monologue-flow"
flowchart TD
    A[Scene Moment] --> B{Can action or dialogue show it?}

    B -->|Yes| C[Use action or dialogue]
    B -->|No| D[Use interior monologue]

    D --> E[Reveal hidden thought]
    D --> F[Show contradiction]
    D --> G[Deepen emotion]
    D --> H[Expose private motive]

    E --> I[Reader understands character more deeply]
    F --> I
    G --> I
    H --> I

    I --> J[Return to action or dialogue]
```
