...
```mermaid
flowchart TD
    A[Setting Description] --> B[Character Interaction]
    A --> C[Emotional Reflection]
    A --> D[Sensory Detail]
    A --> E[Plot Relevance]

    B --> B1[Move through the space]
    B --> B2[Touch or disturb objects]
    B --> B3[Discover something]

    C --> C1[Reflects mood]
    C --> C2[Contrasts with mood]
    C --> C3[Intensifies tension]
    ...
    E --> E1[Objects matter later]
    E --> E2[Atmosphere supports theme]
    E --> E3[Place reveals character]
```
