...
```mermaid id="rj83mh"
flowchart LR
    A[Midpoint Revelation] --> B[Protagonist Takes Action]
    B --> C[Progress and Setbacks]
    C --> D[Second Turning Point]
    D --> E[All Is Lost]
    E --> F[Final Internal Reckoning]
    F --> G[Act 3: Final Choice and Climax]

    D:::turning
    E:::loss

    classDef turning fill:#fecaca,stroke:#dc2626,stroke-width:2px,color:#000;
    classDef loss fill:#111827,stroke:#000,color:#fff;
```
...
```mermaid id="xw4pn7"
flowchart TD
    A[Second Turning Point] --> B[Literal Death]
    A --> C[Symbolic Death]

    B --> B1[Mentor dies]
    B --> B2[Ally sacrifices themselves]
    B --> B3[Loved one is lost]

    C --> C1[Home destroyed]
    C --> C2[Hero captured]
    C --> C3[Dream collapses]
    C --> C4[Old identity breaks]
```
...
```mermaid id="mxpmw0"
flowchart LR
    A[Second Turning Point] --> B[Protagonist Faces the Lie]
    B --> C{Choice}
    C --> D[Choose Want]
    C --> E[Choose Need]
    ...
    classDef need fill:#dcfce7,stroke:#16a34a,stroke-width:2px,color:#000;
    classDef death fill:#fee2e2,stroke:#dc2626,stroke-width:2px,color:#000;
```
...
```mermaid id="sd6jtc"
flowchart TD
    A[Apparent Progress] --> B[Catastrophic Event]
    B --> C[Worst Defeat]
    C --> D[Loss of Support, Confidence, or Safety]
    D --> E[The Lie Is Exposed]
    E --> F[Want vs. Need Choice]
    F --> G[Death of the Old Self]
    G --> H[New Plan for Act 3]
    H --> I[Final Confrontation Begins]
```
...
```mermaid id="kwc62b"
flowchart TD
    A[Old Self] --> B[Act 1: Lives by the Lie]
    B --> C[Act 2A: Enters New World]
    C --> D[Midpoint: Begins to See the Truth]
    D --> E[Act 2B: Acts with New Awareness]
    E --> F[Second Turning Point: Lie Is Severely Tested]
    F --> G[Old Self Breaks]
    G --> H[Act 3: New Self Chooses and Acts]
```
...
```mermaid id="uptlzw"
flowchart LR
    A[Act 2B Progress] --> B[Second Critical Point]
    B --> C[Renewed Push Forward]
    C --> D[Apparent Success]
    D --> E[Second Turning Point]
    E --> F[All Is Lost]
    F --> G[Death of Old Self]
    G --> H[Act 3 Begins]
    ...
    classDef turning fill:#fecaca,stroke:#dc2626,stroke-width:2px,color:#000;
    classDef loss fill:#111827,stroke:#000,color:#fff;
    classDef death fill:#fef3c7,stroke:#d97706,stroke-width:2px,color:#000;
```
