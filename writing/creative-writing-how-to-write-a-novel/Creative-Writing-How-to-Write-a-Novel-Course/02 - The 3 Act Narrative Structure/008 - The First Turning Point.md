...
```mermaid
flowchart LR
    A[Act 1: Setup] --> B[Inciting Incident]
    B --> C[Pressure Builds]
    C --> D[First Turning Point]
    D --> E[Act 2: Main Conflict]
    E --> F[Active Pursuit of the Goal]
    ...
    classDef act1 fill:#f4f4f4,stroke:#555,stroke-width:1px;
    classDef incident fill:#ffe0b2,stroke:#d35400,stroke-width:2px;
    classDef pressure fill:#e3f2fd,stroke:#1976d2,stroke-width:1px;
    classDef turning fill:#ffcdd2,stroke:#c62828,stroke-width:2px;
    classDef act2 fill:#dcedc8,stroke:#558b2f,stroke-width:1px;
    classDef goal fill:#ede7f6,stroke:#5e35b1,stroke-width:1px;
```
...
```mermaid
flowchart TD
    A[Ordinary World] --> B[Disruptive Event]
    B --> C[Protagonist Reacts]
    C --> D[Decisive Choice]
    D --> E[Door Closes Behind Them]
    E --> F[Adventure World / Act 2]
    ...
    classDef ordinary fill:#f4f4f4,stroke:#555,stroke-width:1px;
    classDef event fill:#ffe0b2,stroke:#d35400,stroke-width:1px;
    classDef reaction fill:#e3f2fd,stroke:#1976d2,stroke-width:1px;
    classDef choice fill:#ffcdd2,stroke:#c62828,stroke-width:2px;
    classDef door fill:#f8bbd0,stroke:#ad1457,stroke-width:1px;
    classDef adventure fill:#dcedc8,stroke:#558b2f,stroke-width:1px;
```
...
```mermaid
flowchart LR
    A[Event Happens] --> B[Pressure on Protagonist]
    B --> C[Protagonist Makes a Choice]
    C --> D[Story Direction Changes]
```
...
```mermaid
flowchart LR
    A[0% Opening] --> B[10-12% Inciting Incident]
    B --> C[25% First Turning Point]
    C --> D[50% Midpoint]
    D --> E[75% Second Turning Point]
    E --> F[100% Ending]
