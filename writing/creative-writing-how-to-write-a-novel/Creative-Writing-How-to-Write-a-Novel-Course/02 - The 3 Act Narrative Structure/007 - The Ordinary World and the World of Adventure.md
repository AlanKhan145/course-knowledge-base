...
flowchart LR
    ...
    B --> C[Pressure and Reaction]
    C --> D[First Turning Point]
    D --> E[World of Adventure]
    E --> F[Main Conflict and Transformation]
    ...
    classDef growth fill:#ede7f6,stroke:#5e35b1,stroke-width:1px;
```
...
```mermaid id="p3sk64"
flowchart TD
    A[Ordinary World] --> B[Protagonist's Beliefs]
    A --> C[Protagonist's Fears]
    A --> D[Protagonist's Lie]
    A --> E[Protagonist's Limitations]
    A --> F[Protagonist's Desire for Change]
...
```mermaid id="kaj5r0"
flowchart TD
    A[Ordinary World] --> B[The Protagonist's Lie or Limitation]
    B --> C[Inciting Incident]
    C --> D[Pressure Builds]
    D --> E[First Turning Point]
    E --> F[Crossing the Border]
    F --> G[World of Adventure]
    G --> H[New Rules, New Dangers, New Choices]
```
