...
flowchart LR
    ...
    B --> C[First Turning Point]
    C --> D[Act 2 Begins]
    D --> E[First Point of Crisis]
    E --> F[Adaptation and Rising Conflict]
    F --> G[Midpoint]

    E:::crisis

    classDef crisis fill:#ffcdd2,stroke:#c62828,stroke-width:2px;
```
...
```mermaid id="2dacn7"
flowchart TD
    A[Protagonist Enters Act 2] --> B[Initial Plan]
    B --> C[First Point of Crisis]
    C --> D[Antagonist Force Revealed]
    D --> E[Plan Fails or Becomes Complicated]
    E --> F[Protagonist Must Adapt]
    F --> G[New Awareness of the Conflict]
```
...
```mermaid id="9vwgig"
flowchart TD
    A[Antagonist Force] --> B[External Antagonist]
    A --> C[Internal Antagonist]

    B --> D[Villain]
    B --> E[Monster]
    B --> F[Natural Disaster]
    B --> G[Corrupt System]
    B --> H[War or Social Conflict]
