# 026 - Basic Statistical Concepts

**Hoc phan:** 01 - Prerequisites and Foundations
**Module:** Module 02 - Mathematical Foundations
**Nhom noi dung:** Statistics
**Nguon roadmap:** Mathematical Foundations / Statistics
**Loai bai:** math
...
Bai nay giai thich **Basic Statistical Concepts** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Basic Statistical Concepts bang ngon ngu cua ban.
...
- Basic Statistical Concepts is part of the Statistics topic in the Machine Learning roadmap.
- Use statistics to understand data quality, variation, confidence and model errors.
- Look at distributions and segments before trusting a single aggregate metric.
