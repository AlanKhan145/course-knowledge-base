# 019 - JSON Normalization

**Hoc phan:** 02 - Data Preparation and Feature Work
**Module:** Module 04 - Data Collection
**Nhom noi dung:** Data Ingestion Basics
**Nguon roadmap:** Data Collection / Data Ingestion Basics
**Loai bai:** lesson
...
Bai nay giai thich **JSON Normalization** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc JSON Normalization bang ngon ngu cua ban.
...
- JSON Normalization is part of the Data Ingestion Basics topic in the Machine Learning roadmap.
...
1. Write a 5-line note explaining JSON Normalization.
