...
Bai nay giai thich **Exploratory Checks** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Exploratory Checks bang ngon ngu cua ban.
...
- Exploratory Checks is part of the Data Cleaning topic in the Machine Learning roadmap.
