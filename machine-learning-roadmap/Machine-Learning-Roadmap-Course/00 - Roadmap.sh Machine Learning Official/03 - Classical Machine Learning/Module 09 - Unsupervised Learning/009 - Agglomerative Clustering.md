# 009 - Agglomerative Clustering

**Hoc phan:** 03 - Classical Machine Learning
**Module:** Module 09 - Unsupervised Learning
**Nhom noi dung:** Clustering
**Nguon roadmap:** Unsupervised Learning / Clustering
...
Bai nay giai thich **Agglomerative Clustering** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Agglomerative Clustering bang ngon ngu cua ban.
...
- Agglomerative Clustering is part of the Clustering topic in the Machine Learning roadmap.
