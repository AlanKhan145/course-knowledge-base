# 018 - Recommendation Optimization

**Hoc phan:** 03 - Classical Machine Learning
**Module:** Module 10 - Reinforcement Learning
**Nhom noi dung:** RL Algorithms
**Nguon roadmap:** Reinforcement Learning / RL Algorithms
...
Bai nay giai thich **Recommendation Optimization** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Recommendation Optimization bang ngon ngu cua ban.
...
- Recommendation Optimization is part of the RL Algorithms topic in the Machine Learning roadmap.
