...
**Nhom noi dung:** Core Concepts
**Nguon roadmap:** Reinforcement Learning / Core Concepts
...
Bai nay giai thich **What is Reinforcement Learning?** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc What is Reinforcement Learning? bang ngon ngu cua ban.
...
- What is Reinforcement Learning? is part of the Core Concepts topic in the Machine Learning roadmap.
