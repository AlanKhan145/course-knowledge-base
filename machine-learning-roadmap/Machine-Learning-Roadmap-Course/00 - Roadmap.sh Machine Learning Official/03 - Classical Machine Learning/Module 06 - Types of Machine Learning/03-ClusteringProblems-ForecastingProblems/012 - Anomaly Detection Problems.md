# 012 - Anomaly Detection Problems

**Hoc phan:** 03 - Classical Machine Learning
**Module:** Module 06 - Types of Machine Learning
**Nhom noi dung:** Problem Framing
**Nguon roadmap:** Types of Machine Learning / Problem Framing
**Loai bai:** lesson
...
Bai nay giai thich **Anomaly Detection Problems** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Anomaly Detection Problems bang ngon ngu cua ban.
...
- Anomaly Detection Problems is part of the Problem Framing topic in the Machine Learning roadmap.
...
1. Write a 5-line note explaining Anomaly Detection Problems.
