# 029 - Generative Adversarial Networks

**Hoc phan:** 04 - Evaluation, Workflow and Deep Learning
**Module:** Module 14 - Deep Learning Architectures
**Nhom noi dung:** Autoencoders and GANs
**Nguon roadmap:** Deep Learning Architectures / Autoencoders and GANs
...
Bai nay giai thich **Generative Adversarial Networks** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Generative Adversarial Networks bang ngon ngu cua ban.
...
- Generative Adversarial Networks is part of the Autoencoders and GANs topic in the Machine Learning roadmap.
