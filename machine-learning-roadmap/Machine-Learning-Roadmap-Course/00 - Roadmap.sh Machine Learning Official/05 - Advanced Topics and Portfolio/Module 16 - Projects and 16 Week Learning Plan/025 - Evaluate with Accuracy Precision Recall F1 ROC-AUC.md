# 025 - Evaluate with Accuracy Precision Recall F1 ROC-AUC
...
Bai nay giai thich **Evaluate with Accuracy Precision Recall F1 ROC-AUC** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Evaluate with Accuracy Precision Recall F1 ROC-AUC bang ngon ngu cua ban.
...
- Evaluate with Accuracy Precision Recall F1 ROC-AUC is part of the Completion Checklist topic in the Machine Learning roadmap.
...
- Choose metrics based on business cost, class balance and the type of prediction task.
