# 020 - Project 4 - Text Classification

**Hoc phan:** 05 - Advanced Topics and Portfolio
**Module:** Module 16 - Projects and 16 Week Learning Plan
**Nhom noi dung:** Practice Projects
**Nguon roadmap:** Projects and 16 Week Learning Plan / Practice Projects
**Loai bai:** project
...
Bai nay giai thich **Project 4 - Text Classification** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Project 4 - Text Classification bang ngon ngu cua ban.
...
- Project 4 - Text Classification is part of the Practice Projects topic in the Machine Learning roadmap.
- Each project should include data source, notebook/script, model comparison, metrics and README.
- Portfolio value comes from decisions and explanations, not only final score.
...
2. Write goal, dataset, method, metrics, result and next step.
