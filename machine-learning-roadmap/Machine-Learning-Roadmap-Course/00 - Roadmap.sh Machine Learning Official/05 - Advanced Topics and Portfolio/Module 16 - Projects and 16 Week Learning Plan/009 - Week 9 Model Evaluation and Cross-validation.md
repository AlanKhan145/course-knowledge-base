# 009 - Week 9 Model Evaluation and Cross-validation
...
Bai nay giai thich **Week 9 Model Evaluation and Cross-validation** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Week 9 Model Evaluation and Cross-validation bang ngon ngu cua ban.
...
- Week 9 Model Evaluation and Cross-validation is part of the 16 Week Learning Plan topic in the Machine Learning roadmap.
