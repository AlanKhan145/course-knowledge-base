# 001 - Week 1 Python Fundamentals and NumPy
...
Bai nay giai thich **Week 1 Python Fundamentals and NumPy** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Week 1 Python Fundamentals and NumPy bang ngon ngu cua ban.
...
- Week 1 Python Fundamentals and NumPy is part of the 16 Week Learning Plan topic in the Machine Learning roadmap.
