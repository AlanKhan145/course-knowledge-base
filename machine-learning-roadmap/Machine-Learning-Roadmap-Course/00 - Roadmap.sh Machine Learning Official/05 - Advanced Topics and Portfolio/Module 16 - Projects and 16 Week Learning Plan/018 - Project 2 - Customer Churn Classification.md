# 018 - Project 2 - Customer Churn Classification
...
Bai nay giai thich **Project 2 - Customer Churn Classification** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Project 2 - Customer Churn Classification bang ngon ngu cua ban.
...
- Project 2 - Customer Churn Classification is part of the Practice Projects topic in the Machine Learning roadmap.
