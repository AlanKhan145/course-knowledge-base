# 003 - Programming Languages

**Module:** Module 08 - BI Tools - Công cụ BI  
**Roadmap item:** 8.3  
**Loại nội dung:** BI tools  
...
Với BI Analyst, **Programming Languages** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Programming Languages** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 5. Bài tập thực hành
Tạo dashboard nhỏ bằng Excel, Power BI/Tableau/Looker hoặc notebook Python/R.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- Tool comparison matrix and small dashboard prototype
...
## 8. Tổng kết
**Programming Languages** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
