# 001 - Analog vs Digital Data

**Module:** Module 05 - What is Data? - Hiểu về dữ liệu  
**Roadmap item:** 5.1  
**Loại nội dung:** Data fundamentals  
...
Với BI Analyst, **Analog vs Digital Data** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Analog vs Digital Data** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 5. Bài tập thực hành
Lập inventory nguồn dữ liệu cho một business domain và phân loại structured/semi-structured/unstructured.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- Data source inventory and format comparison note
...
## 8. Tổng kết
**Analog vs Digital Data** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
