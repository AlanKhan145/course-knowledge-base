...
Với BI Analyst, **Responsibilities** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Responsibilities** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
- Phân tích KPI, metric
- Làm sạch, biến đổi và trực quan hóa dữ liệu
- Trình bày insight cho business team
...
## 5. Bài tập thực hành
Chọn một công ty/sản phẩm quen thuộc và viết BI có thể giúp quyết định kinh doanh nào tốt hơn.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- BI role map and stakeholder value note
...
## 8. Tổng kết
**Responsibilities** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
