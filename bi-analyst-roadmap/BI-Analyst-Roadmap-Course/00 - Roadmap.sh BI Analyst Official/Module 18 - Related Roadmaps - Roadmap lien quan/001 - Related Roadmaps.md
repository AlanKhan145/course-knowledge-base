...
**Module:** Module 18 - Related Roadmaps - Roadmap liên quan  
**Roadmap item:** 18.1  
**Loại nội dung:** Related learning paths  
...
Với BI Analyst, **Related Roadmaps** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Related Roadmaps** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 5. Bài tập thực hành
Chọn roadmap tiếp theo và viết kế hoạch học 30 ngày gắn với portfolio BI.
...
## 8. Tổng kết
**Related Roadmaps** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
