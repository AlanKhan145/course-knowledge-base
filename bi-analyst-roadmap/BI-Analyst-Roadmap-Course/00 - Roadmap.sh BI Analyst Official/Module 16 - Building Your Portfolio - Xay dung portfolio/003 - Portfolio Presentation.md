# 003 - Portfolio Presentation

**Module:** Module 16 - Building Your Portfolio - Xây dựng portfolio  
**Roadmap item:** 16.3  
**Loại nội dung:** Portfolio building  
**Thời lượng gợi ý:** 45-75 phút

---

## 1. Tóm tắt
Cách trình bày project

Với BI Analyst, **Portfolio Presentation** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Portfolio Presentation** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
- Đưa dashboard lên GitHub, Tableau Public hoặc Power BI Service
...
## 8. Tổng kết
**Portfolio Presentation** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
