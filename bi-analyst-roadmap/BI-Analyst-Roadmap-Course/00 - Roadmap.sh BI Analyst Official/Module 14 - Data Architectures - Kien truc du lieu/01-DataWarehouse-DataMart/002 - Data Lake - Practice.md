...
Với BI Analyst, **Data Lake** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Data Lake** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 3. Nội dung roadmap
- Lưu trữ dữ liệu thô
- Phục vụ dữ liệu lớn và phân tích linh hoạt
...
## 8. Tổng kết
**Data Lake** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
