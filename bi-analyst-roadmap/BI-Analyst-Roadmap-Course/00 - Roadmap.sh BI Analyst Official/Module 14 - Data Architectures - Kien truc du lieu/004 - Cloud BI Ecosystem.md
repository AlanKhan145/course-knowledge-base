# 004 - Cloud BI Ecosystem

**Module:** Module 14 - Data Architectures - Kiến trúc dữ liệu  
**Roadmap item:** 14.4  
**Loại nội dung:** Data architecture  
**Thời lượng gợi ý:** 45-75 phút

---

## 1. Tóm tắt
BI trên nền tảng cloud

Với BI Analyst, **Cloud BI Ecosystem** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Cloud BI Ecosystem** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 3. Nội dung roadmap
- BI trên nền tảng cloud
- Kết nối data warehouse với BI tools
...
## 6. Artifact nên tạo
- BI data model with fact/dimension tables
...
## 8. Tổng kết
**Cloud BI Ecosystem** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
