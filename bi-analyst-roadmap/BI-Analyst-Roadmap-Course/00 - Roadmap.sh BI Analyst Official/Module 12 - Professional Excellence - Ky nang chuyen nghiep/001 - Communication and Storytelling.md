# 001 - Communication & Storytelling

**Module:** Module 12 - Professional Excellence - Kỹ năng chuyên nghiệp  
**Roadmap item:** 12.1  
**Loại nội dung:** Professional excellence  
...
Với BI Analyst, **Communication & Storytelling** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Communication & Storytelling** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 5. Bài tập thực hành
Viết executive summary 1 trang từ một dashboard hoặc phân tích dữ liệu.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- Executive summary and stakeholder presentation deck outline
...
## 8. Tổng kết
**Communication & Storytelling** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
