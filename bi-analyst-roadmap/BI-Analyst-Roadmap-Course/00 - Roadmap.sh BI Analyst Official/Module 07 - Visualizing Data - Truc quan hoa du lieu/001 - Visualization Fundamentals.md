# 001 - Visualization Fundamentals

**Module:** Module 07 - Visualizing Data - Trực quan hóa dữ liệu  
**Roadmap item:** 7.1  
**Loại nội dung:** Data visualization  
...
Với BI Analyst, **Visualization Fundamentals** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Visualization Fundamentals** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 3. Nội dung roadmap
- Nguyên tắc trực quan hóa
- Chọn biểu đồ theo mục tiêu phân tích
- Tránh gây hiểu nhầm bằng biểu đồ
...
## 6. Artifact nên tạo
- Visualization style guide and dashboard critique
...
## 8. Tổng kết
**Visualization Fundamentals** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
