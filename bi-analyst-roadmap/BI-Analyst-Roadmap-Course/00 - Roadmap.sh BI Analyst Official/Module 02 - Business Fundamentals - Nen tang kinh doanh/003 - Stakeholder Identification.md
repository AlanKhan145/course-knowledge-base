...
## 1. Tóm tắt
Xác định người dùng dashboard

Với BI Analyst, **Stakeholder Identification** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Stakeholder Identification** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 5. Bài tập thực hành
Tạo KPI tree cho một phòng ban: Sales, Marketing, Finance, Operations hoặc HR.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- Metric/KPI dictionary and stakeholder map
...
## 8. Tổng kết
**Stakeholder Identification** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
