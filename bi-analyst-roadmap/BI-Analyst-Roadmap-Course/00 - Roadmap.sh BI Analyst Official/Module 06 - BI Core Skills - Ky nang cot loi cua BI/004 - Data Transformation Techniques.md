# 004 - Data Transformation Techniques

**Module:** Module 06 - BI Core Skills - Kỹ năng cốt lõi của BI  
**Roadmap item:** 6.4  
**Loại nội dung:** BI core skills  
...
Với BI Analyst, **Data Transformation Techniques** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Data Transformation Techniques** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
- Outliers
- Chuẩn hóa dữ liệu
- Biến đổi dữ liệu phục vụ phân tích
...
## 5. Bài tập thực hành
Viết SQL truy vấn KPI, làm sạch dữ liệu lỗi và tạo bảng phân tích sẵn cho dashboard.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- SQL notebook, EDA checklist and data cleaning workflow
...
## 8. Tổng kết
**Data Transformation Techniques** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
