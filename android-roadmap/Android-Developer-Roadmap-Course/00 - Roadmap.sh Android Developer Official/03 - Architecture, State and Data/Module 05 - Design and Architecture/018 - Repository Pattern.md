...
Bai nay giai thich **Repository Pattern** trong boi canh Android Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong app Android, lien quan den UI, lifecycle, state, data, network, quality hoac release nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Repository Pattern bang ngon ngu cua ban.
...
- A repository hides data source details behind a clean API.
- It may combine local database, network API, cache policy and mapping logic.
- Repositories make ViewModels easier to test and keep screens independent from storage/network details.
