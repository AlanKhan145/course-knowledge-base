...
**Nhom noi dung:** Reactive State
**Nguon roadmap:** Design and Architecture / Reactive State
**Loai bai:** async
...
Bai nay giai thich **Flow vs LiveData** trong boi canh Android Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong app Android, lien quan den UI, lifecycle, state, data, network, quality hoac release nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Flow vs LiveData bang ngon ngu cua ban.
...
- Flow vs LiveData is part of the Reactive State topic in the Android Developer roadmap.
