...
Bai nay giai thich **Unidirectional Data Flow** trong boi canh Android Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong app Android, lien quan den UI, lifecycle, state, data, network, quality hoac release nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Unidirectional Data Flow bang ngon ngu cua ban.
...
- Unidirectional Data Flow is part of the Architectural Patterns topic in the Android Developer roadmap.
...
1. Move work off the main thread.
2. Add cancellation, retry or constraint behavior where relevant.
3. Log the state transitions so you can debug the flow.
