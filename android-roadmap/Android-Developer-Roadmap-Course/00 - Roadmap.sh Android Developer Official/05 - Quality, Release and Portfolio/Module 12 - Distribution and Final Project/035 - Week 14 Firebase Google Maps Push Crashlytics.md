# 035 - Week 14 Firebase Google Maps Push Crashlytics
...
Bai nay giai thich **Week 14 Firebase Google Maps Push Crashlytics** trong boi canh Android Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong app Android, lien quan den UI, lifecycle, state, data, network, quality hoac release nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Week 14 Firebase Google Maps Push Crashlytics bang ngon ngu cua ban.
...
- Week 14 Firebase Google Maps Push Crashlytics is part of the 16 Week Learning Plan topic in the Android Developer roadmap.
