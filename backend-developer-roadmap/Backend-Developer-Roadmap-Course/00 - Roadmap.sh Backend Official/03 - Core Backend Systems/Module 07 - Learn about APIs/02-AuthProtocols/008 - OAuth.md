...
Bai nay giai thich **OAuth** trong boi canh backend hien dai. Sau bai hoc, ban nen nam khai niem, biet vi sao no quan trong va co mot bai tap nho de ap dung.

## 2. Muc tieu hoc tap

- Giai thich duoc OAuth bang ngon ngu cua ban.
- Nhan biet khi nao kien thuc nay xuat hien trong backend project.
- Thuc hanh mot vi du nho va ghi lai loi thuong gap.

## 3. Khai niem chinh

- OAuth la authorization framework de uy quyen truy cap.
- Thuong dung de login qua provider hoac cap quyen API cho app khac.
- Can hieu authorization code flow, client secret, scope va redirect URI.
...
- Toi co the giai thich **OAuth** trong 1-2 phut.
...
**OAuth** la mot moc trong lo trinh backend. Hay bien no thanh mot vi du nho, mot checklist debug, hoac mot project mini de kien thuc co cho bam.
