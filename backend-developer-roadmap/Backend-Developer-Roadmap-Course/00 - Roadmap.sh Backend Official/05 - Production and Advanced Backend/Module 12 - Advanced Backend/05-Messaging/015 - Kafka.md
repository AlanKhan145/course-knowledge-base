...
Bai nay giai thich **Kafka** trong boi canh backend hien dai. Sau bai hoc, ban nen nam khai niem, biet vi sao no quan trong va co mot bai tap nho de ap dung.

## 2. Muc tieu hoc tap

- Giai thich duoc Kafka bang ngon ngu cua ban.
- Nhan biet khi nao kien thuc nay xuat hien trong backend project.
- Thuc hanh mot vi du nho va ghi lai loi thuong gap.

## 3. Khai niem chinh

- Kafka la distributed event streaming platform.
- Phu hop event log, high-throughput messaging va stream processing.
- Can hieu topic, partition, consumer group, offset va retention.
...
- Toi co the giai thich **Kafka** trong 1-2 phut.
...
**Kafka** la mot moc trong lo trinh backend. Hay bien no thanh mot vi du nho, mot checklist debug, hoac mot project mini de kien thuc co cho bam.
