...
**Nguon roadmap:** 12. Advanced Backend / NoSQL Databases
**Loai bai:** Database
...
Bai nay giai thich **Document DBs** trong boi canh backend hien dai. Sau bai hoc, ban nen nam khai niem, biet vi sao no quan trong va co mot bai tap nho de ap dung.

## 2. Muc tieu hoc tap

- Giai thich duoc Document DBs bang ngon ngu cua ban.
- Nhan biet khi nao kien thuc nay xuat hien trong backend project.
- Thuc hanh mot vi du nho va ghi lai loi thuong gap.

## 3. Khai niem chinh

- Document DBs la mot moc kien thuc trong module Advanced Backend.
...
- Toi co the giai thich **Document DBs** trong 1-2 phut.
...
**Document DBs** la mot moc trong lo trinh backend. Hay bien no thanh mot vi du nho, mot checklist debug, hoac mot project mini de kien thuc co cho bam.
