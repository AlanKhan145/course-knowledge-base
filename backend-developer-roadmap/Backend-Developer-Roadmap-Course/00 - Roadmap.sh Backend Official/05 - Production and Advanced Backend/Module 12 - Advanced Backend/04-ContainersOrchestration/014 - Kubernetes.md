...
**Bai cha:** Container Orchestration
**Nguon roadmap:** 12. Advanced Backend / Containerization and Orchestration / Container Orchestration
**Loai bai:** Ai
...
Bai nay giai thich **Kubernetes** trong nhom **Container Orchestration** cua module **Advanced Backend**. Sau bai hoc, ban nen biet vai tro cua no va cach no xuat hien trong he thong backend.
...
- Kubernetes la platform orchestration pho bien.
- Concept cot loi gom Pod, Deployment, Service, ConfigMap, Secret va Ingress.
- Can can nhac complexity truoc khi dua vao project nho.
...
**Kubernetes** la mot moc trong lo trinh backend. Hay bien no thanh mot vi du nho, mot checklist debug, hoac mot project mini de kien thuc co cho bam.
