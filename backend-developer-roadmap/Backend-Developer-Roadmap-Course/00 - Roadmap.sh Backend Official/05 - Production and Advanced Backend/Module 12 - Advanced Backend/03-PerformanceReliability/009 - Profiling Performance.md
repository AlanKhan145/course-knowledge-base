...
Bai nay giai thich **Profiling Performance** trong boi canh backend hien dai. Sau bai hoc, ban nen nam khai niem, biet vi sao no quan trong va co mot bai tap nho de ap dung.

## 2. Muc tieu hoc tap

- Giai thich duoc Profiling Performance bang ngon ngu cua ban.
- Nhan biet khi nao kien thuc nay xuat hien trong backend project.
- Thuc hanh mot vi du nho va ghi lai loi thuong gap.

## 3. Khai niem chinh

- Profiling do thuc te thoi gian CPU, IO, query va memory.
- Dung so lieu truoc khi toi uu.
- Backend bottleneck thuong nam o database, network, serialization hoac lock.
...
- Toi co the giai thich **Profiling Performance** trong 1-2 phut.
...
**Profiling Performance** la mot moc trong lo trinh backend. Hay bien no thanh mot vi du nho, mot checklist debug, hoac mot project mini de kien thuc co cho bam.
