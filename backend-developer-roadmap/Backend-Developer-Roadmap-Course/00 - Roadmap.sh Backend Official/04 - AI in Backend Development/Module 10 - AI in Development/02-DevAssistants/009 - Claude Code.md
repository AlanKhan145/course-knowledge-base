...
**Nguon roadmap:** 10. AI in Development / AI Assisted Coding
**Loai bai:** Ai
...
Bai nay giai thich **Claude Code** trong boi canh backend hien dai. Sau bai hoc, ban nen nam khai niem, biet vi sao no quan trong va co mot bai tap nho de ap dung.

## 2. Muc tieu hoc tap

- Giai thich duoc Claude Code bang ngon ngu cua ban.
- Nhan biet khi nao kien thuc nay xuat hien trong backend project.
- Thuc hanh mot vi du nho va ghi lai loi thuong gap.

## 3. Khai niem chinh

- Claude Code la coding assistant co the lam viec voi codebase va terminal.
- Dung tot khi dua context ro, acceptance criteria va yeu cau test.
- Backend task can review ky migration, auth, billing va data change.
...
- Toi co the giai thich **Claude Code** trong 1-2 phut.
...
**Claude Code** la mot moc trong lo trinh backend. Hay bien no thanh mot vi du nho, mot checklist debug, hoac mot project mini de kien thuc co cho bam.
