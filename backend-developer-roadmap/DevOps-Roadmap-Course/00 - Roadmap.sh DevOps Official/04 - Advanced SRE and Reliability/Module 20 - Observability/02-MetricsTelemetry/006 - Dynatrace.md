...
Bai nay giai thich **Dynatrace** trong boi canh DevOps/SRE hien dai. Sau bai hoc, ban nen biet no la gi, nam o dau trong workflow van hanh va cach bien no thanh thuc hanh observability nho.

## 2. Muc tieu hoc tap

- Giai thich duoc Dynatrace bang ngon ngu cua ban.
- Nhan biet no xuat hien o dau trong DevOps workflow thuc te.
- Ap dung vao mot demo, command, config, pipeline hoac runbook nho.

## 3. Khai niem chinh

- Dynatrace giup giai thich he thong dang lam gi tu ben ngoai nhin vao.
...
- Chon 3 tin hieu can theo doi khi dung Dynatrace.
...
- Toi co the giai thich **Dynatrace** trong 1-2 phut.
...
**Dynatrace** la mot moc trong lo trinh DevOps. Hay bien no thanh mot script, mot config, mot dashboard, mot pipeline, hoac mot runbook nho de kien thuc co cho bam.
