...
Bai nay giai thich **Prometheus** trong boi canh DevOps/SRE hien dai. Sau bai hoc, ban nen biet no la gi, nam o dau trong workflow van hanh va cach bien no thanh thuc hanh observability nho.
...
- Prometheus thu thap metric theo mo hinh pull va luu time series.
- Can hieu target, scrape, label, PromQL, recording rule va alert rule.
- Metric tot can it cardinality, ten ro va gan voi SLO/SLA.
...
- Chon 3 tin hieu can theo doi khi dung Prometheus.
...
- Toi co the giai thich **Prometheus** trong 1-2 phut.
...
**Prometheus** la mot moc trong lo trinh DevOps. Hay bien no thanh mot script, mot config, mot dashboard, mot pipeline, hoac mot runbook nho de kien thuc co cho bam.
