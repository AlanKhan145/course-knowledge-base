...
Bai nay giai thich **FTP / SFTP** trong boi canh DevOps/SRE hien dai. Sau bai hoc, ban nen biet no la gi, nam o dau trong workflow van hanh va cach bien no thanh thuc hanh networking nho.

## 2. Muc tieu hoc tap

- Giai thich duoc FTP / SFTP bang ngon ngu cua ban.
- Nhan biet no xuat hien o dau trong DevOps workflow thuc te.
- Ap dung vao mot demo, command, config, pipeline hoac runbook nho.

## 3. Khai niem chinh

- FTP / SFTP la mot phan cua duong request giua user, proxy, server va service.
...
- Viet checklist debug cho loi lien quan den FTP / SFTP.
...
- Toi co the giai thich **FTP / SFTP** trong 1-2 phut.
...
**FTP / SFTP** la mot moc trong lo trinh DevOps. Hay bien no thanh mot script, mot config, mot dashboard, mot pipeline, hoac mot runbook nho de kien thuc co cho bam.
