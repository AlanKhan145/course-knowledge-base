...
Bai nay giai thich **Splunk** trong boi canh DevOps/SRE hien dai. Sau bai hoc, ban nen biet no la gi, nam o dau trong workflow van hanh va cach bien no thanh thuc hanh logging nho.

## 2. Muc tieu hoc tap

- Giai thich duoc Splunk bang ngon ngu cua ban.
- Nhan biet no xuat hien o dau trong DevOps workflow thuc te.
- Ap dung vao mot demo, command, config, pipeline hoac runbook nho.

## 3. Khai niem chinh

- Splunk giup truy vet su kien va debug loi.
...
- Chon 3 tin hieu can theo doi khi dung Splunk.
...
- Toi co the giai thich **Splunk** trong 1-2 phut.
...
**Splunk** la mot moc trong lo trinh DevOps. Hay bien no thanh mot script, mot config, mot dashboard, mot pipeline, hoac mot runbook nho de kien thuc co cho bam.
