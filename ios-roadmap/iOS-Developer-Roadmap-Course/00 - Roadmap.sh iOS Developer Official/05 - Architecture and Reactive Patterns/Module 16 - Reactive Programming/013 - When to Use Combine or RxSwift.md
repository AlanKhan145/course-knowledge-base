# 013 - When to Use Combine or RxSwift
...
Bai nay giai thich **When to Use Combine or RxSwift** trong boi canh iOS Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong app iOS, lien quan den Swift, UI, lifecycle, architecture, data, networking, testing hoac distribution nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc When to Use Combine or RxSwift bang ngon ngu cua ban.
...
- When to Use Combine or RxSwift is part of the Reactive Tools topic in the iOS Developer roadmap.
