# 005 - Backward Compatible Schema Changes

**Hoc phan:** 04 - Internals Tuning and Application Patterns
**Module:** Module 10 - Application Skills and Data Patterns
**Nhom noi dung:** Migrations
**Nguon roadmap:** Application Skills and Data Patterns / Migrations
**Loai bai:** lesson
...
Bai nay giai thich **Backward Compatible Schema Changes** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Backward Compatible Schema Changes bang ngon ngu cua ban.
...
- Backward Compatible Schema Changes is part of the Migrations topic in the PostgreSQL DBA roadmap.
...
1. Write a 5-line note explaining Backward Compatible Schema Changes.
