# 033 - Read Write Split

**Hoc phan:** 03 - Backup HA Monitoring and Automation
**Module:** Module 08 - Replication Pooling and High Availability
**Nhom noi dung:** Load Balancing and Discovery
**Nguon roadmap:** Replication Pooling and High Availability / Load Balancing and Discovery
**Loai bai:** project
...
Bai nay giai thich **Read Write Split** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Read Write Split bang ngon ngu cua ban.
...
- Read Write Split is part of the Load Balancing and Discovery topic in the PostgreSQL DBA roadmap.
