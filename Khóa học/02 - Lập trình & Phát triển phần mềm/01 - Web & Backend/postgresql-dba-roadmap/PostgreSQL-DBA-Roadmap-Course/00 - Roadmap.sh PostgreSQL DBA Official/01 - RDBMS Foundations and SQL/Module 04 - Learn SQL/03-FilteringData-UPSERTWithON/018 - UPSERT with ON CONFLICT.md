# 018 - UPSERT with ON CONFLICT

**Hoc phan:** 01 - RDBMS Foundations and SQL
**Module:** Module 04 - Learn SQL
**Nhom noi dung:** DML Queries
**Nguon roadmap:** Learn SQL / DML Queries
**Loai bai:** sql
...
Bai nay giai thich **UPSERT with ON CONFLICT** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc UPSERT with ON CONFLICT bang ngon ngu cua ban.
...
- UPSERT with ON CONFLICT is part of the DML Queries topic in the PostgreSQL DBA roadmap.
