# 017 - Unique Constraints

**Hoc phan:** 01 - RDBMS Foundations and SQL
**Module:** Module 02 - Basic RDBMS Concepts
**Nhom noi dung:** Relational Model
**Nguon roadmap:** Basic RDBMS Concepts / Relational Model
**Loai bai:** lesson
...
Bai nay giai thich **Unique Constraints** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Unique Constraints bang ngon ngu cua ban.
...
- Unique Constraints is part of the Relational Model topic in the PostgreSQL DBA roadmap.
...
1. Write a 5-line note explaining Unique Constraints.
