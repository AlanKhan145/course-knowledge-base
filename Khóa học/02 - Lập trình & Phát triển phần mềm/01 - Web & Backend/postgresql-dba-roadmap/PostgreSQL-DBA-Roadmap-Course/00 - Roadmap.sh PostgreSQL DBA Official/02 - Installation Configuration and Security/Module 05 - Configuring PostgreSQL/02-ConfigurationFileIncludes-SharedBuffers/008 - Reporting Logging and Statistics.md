# 008 - Reporting Logging and Statistics
...
Bai nay giai thich **Reporting Logging and Statistics** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Reporting Logging and Statistics bang ngon ngu cua ban.
...
- Reporting Logging and Statistics is part of the PostgreSQL Configuration topic in the PostgreSQL DBA roadmap.
