...
Bai nay giai thich **Using Docker** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Using Docker bang ngon ngu cua ban.
...
- Docker is a fast way to create disposable PostgreSQL labs.
- It is useful for learning, CI and local testing, but production requires careful storage and backup design.
- Always understand where the data directory lives before deleting containers or volumes.

## 4. Thuc hanh

1. Write a 5-line note explaining Using Docker.
