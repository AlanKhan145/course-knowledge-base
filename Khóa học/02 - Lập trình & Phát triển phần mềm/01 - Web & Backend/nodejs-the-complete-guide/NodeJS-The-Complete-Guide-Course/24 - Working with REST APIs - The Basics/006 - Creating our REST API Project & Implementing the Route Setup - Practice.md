# 006 - Creating our REST API Project & Implementing the Route Setup
...
## Main Idea
This lesson focuses on **Creating our REST API Project & Implementing the Route Setup** inside the **Working with REST APIs - The Basics** section. It is a study note generated from the provided course syllabus, so use it as a structured learning guide while you watch, code, or review the material.
...
## Review Questions
* What problem does **Creating our REST API Project & Implementing the Route Setup** solve in this section?
* Which file, route, model, view, or client behavior would you inspect first?
* How would you prove that the final behavior works?

## Summary
The goal of this lesson is to make **Creating our REST API Project & Implementing the Route Setup** practical, not just familiar. After reviewing it, you should be able to explain how it fits into Working with REST APIs - The Basics and apply the idea in a small Node.js project.
