# 030 - Week 1-2 Kotlin OOP DSA Android Studio Gradle Git
...
Bai nay giai thich **Week 1-2 Kotlin OOP DSA Android Studio Gradle Git** trong boi canh Android Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong app Android, lien quan den UI, lifecycle, state, data, network, quality hoac release nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Week 1-2 Kotlin OOP DSA Android Studio Gradle Git bang ngon ngu cua ban.
...
- Week 1-2 Kotlin OOP DSA Android Studio Gradle Git is part of the 16 Week Learning Plan topic in the Android Developer roadmap.
