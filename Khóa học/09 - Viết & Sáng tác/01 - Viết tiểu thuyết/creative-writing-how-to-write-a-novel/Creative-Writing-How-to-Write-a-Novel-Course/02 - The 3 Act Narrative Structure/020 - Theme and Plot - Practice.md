...
```mermaid id="u9cnx2"
flowchart LR
    A[Strong Plot] --> C[Powerful Story]
    B[Clear Theme] --> C
```
...
```mermaid id="sn7yxc"
flowchart TD
    A[Theme: Hope Can Set You Free] --> B[Andy Keeps Hope Alive]
    B --> C[Andy Plans His Escape]
    C --> D[Andy Escapes Prison]
    D --> E[Theme Is Proven]
```
...
```mermaid id="eyh8q4"
flowchart LR
    A[Theme] --> B[Character's Lie]
    B --> C[Internal Conflict]
    C --> D[External Choices]
    D --> E[Character Arc]
```
...
```mermaid id="u6vryj"
flowchart TD
    A[External Conflict] --> B[Character Must Choose]
    B --> C[Choice Reveals Values]
    C --> D[Values Express Theme]
```
...
```mermaid id="nhpj5p"
flowchart TD
    A[Scene Goal] --> B[Conflict]
    B --> C[Character Choice]
    C --> D[Consequence]
    D --> E[Thematic Meaning]
```
...
```mermaid id="m7q0by"
flowchart TD
    A[Act 1] --> B[Introduce Character]
    B --> C[Show the Lie or Problem]
    C --> D[Introduce Thematic Question]
```
...
```mermaid id="lkp4mf"
flowchart TD
    A[Act 2] --> B[Conflict Escalates]
    B --> C[Theme Is Tested]
    C --> D[Character Makes Choices]
    D --> E[Consequences Reveal Meaning]
```
...
```mermaid id="zp4rw7"
flowchart TD
    A[Act 3] --> B[Final Choice]
    B --> C[Climactic Action]
    C --> D[Plot Resolution]
    D --> E[Theme Is Proven]
```
...
```mermaid id="teqy81"
flowchart LR
    A[Theme = Argument] --> B[Plot = Evidence]
    B --> C[Character Arc = Demonstration]
    C --> D[Climax = Proof]
```
