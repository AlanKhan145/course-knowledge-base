...
```mermaid id="whxcee"
flowchart TD
    A[Character performs an action] --> B[Reader observes behavior]
    B --> C[Reader forms an impression]
    C --> D[Reader predicts future choices]
    D --> E[Reader keeps reading to see what happens]
```
