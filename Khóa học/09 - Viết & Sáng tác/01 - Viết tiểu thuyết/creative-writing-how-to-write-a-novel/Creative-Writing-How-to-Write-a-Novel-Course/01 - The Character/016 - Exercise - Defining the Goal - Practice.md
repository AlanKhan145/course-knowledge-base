...
```mermaid id="bsk4qn"
flowchart TD
    A[Main Story Goal] --> B[Scene Goal 1]
    A --> C[Scene Goal 2]
    A --> D[Scene Goal 3]
    A --> E[Scene Goal 4]
    A --> F[Scene Goal 5]
...
```mermaid id="f3q4yt"
flowchart LR
    A[Character A Wants the Truth] --> C[Scene Conflict]
    B[Character B Wants to Hide the Truth] --> C
    C --> D[Argument / Manipulation / Action]
    D --> E[Consequence]
```
...
flowchart TD
    ...
    G --> H[Obstacle 3]
    H --> I[Consequence 3]
    I --> J[Main Goal Becomes Clearer or Harder]
```
