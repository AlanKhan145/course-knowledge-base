# 001 - Wi-Fi và mạng không dây

**Module:** Module 13 - Wireless Networking  
**Roadmap item:** Bài 26  
**Loại nội dung:** Wireless networking  
...
Với Network Engineer, **Wi-Fi và mạng không dây** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **Wi-Fi và mạng không dây** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 5. Bài tập thực hành
Thiết kế Wi-Fi cho văn phòng nhỏ: SSID, bảo mật, access point placement và guest network.

Sau đó viết 5-7 dòng trả lời: nếu mạng gặp lỗi, chủ đề này giúp bạn kiểm tra điều gì trước?

## 6. Artifact nên tạo
- Wireless network design and security checklist
...
## 8. Tổng kết
**Wi-Fi và mạng không dây** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
