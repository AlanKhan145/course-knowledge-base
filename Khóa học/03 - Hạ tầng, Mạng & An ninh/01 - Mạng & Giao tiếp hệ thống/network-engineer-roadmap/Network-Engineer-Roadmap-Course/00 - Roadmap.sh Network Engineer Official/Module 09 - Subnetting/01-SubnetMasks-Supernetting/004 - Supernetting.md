...
**Module:** Module 09 - Subnetting  
**Roadmap item:** Bài 16  
**Loại nội dung:** Subnetting  
...
Với Network Engineer, **Supernetting** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **Supernetting** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 6. Artifact nên tạo
- Subnetting workbook with CIDR/VLSM exercises
...
## 8. Tổng kết
**Supernetting** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
