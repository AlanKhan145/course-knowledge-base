# 003 - Off-chain Transaction

**Hoc phan:** 04 - dApps Oracles Security and Scaling
**Module:** Module 14 - Building for Scale
**Nhom noi dung:** Channels
**Nguon roadmap:** Building for Scale / Channels
**Loai bai:** scaling
...
Bai nay giai thich **Off-chain Transaction** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Off-chain Transaction bang ngon ngu cua ban.
...
- Off-chain Transaction is part of the Channels topic in the Blockchain Developer roadmap.
