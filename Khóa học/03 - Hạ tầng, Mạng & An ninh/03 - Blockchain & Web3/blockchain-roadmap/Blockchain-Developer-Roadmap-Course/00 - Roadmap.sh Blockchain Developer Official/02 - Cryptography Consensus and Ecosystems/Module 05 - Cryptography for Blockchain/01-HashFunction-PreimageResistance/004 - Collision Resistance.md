# 004 - Collision Resistance

**Hoc phan:** 02 - Cryptography Consensus and Ecosystems
**Module:** Module 05 - Cryptography for Blockchain
**Nhom noi dung:** Hashing
**Nguon roadmap:** Cryptography for Blockchain / Hashing
...
Bai nay giai thich **Collision Resistance** trong boi canh Blockchain Developer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong blockchain, smart contract, dApp, security, oracle, scaling hoac portfolio workflow.

## 2. Muc tieu hoc tap

- Giai thich duoc Collision Resistance bang ngon ngu cua ban.
...
- Collision Resistance is part of the Hashing topic in the Blockchain Developer roadmap.
