...
![Các nguồn thực phẩm giàu protein gồm thịt gà, trứng, hạnh nhân và đậu lăng](https://upload.wikimedia.org/wikipedia/commons/e/e8/Protein-rich_Foods.jpg)
...
![Sơ đồ cấu tạo thận và nephron](https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/KidneyAndNephron-v4_Antares42.svg/960px-KidneyAndNephron-v4_Antares42.svg.png)
...
```mermaid
flowchart TD
    A[Muốn tăng lượng protein] --> B{Có bệnh thận hoặc xét nghiệm thận bất thường?}
    B -->|Không| C[Ước tính nhu cầu theo cân nặng và vận động]
    C --> D[Phân bổ protein trong ngày]
    D --> E[Theo dõi tổng calorie và chất lượng thực phẩm]
    B -->|Có hoặc không chắc chắn| F[Trao đổi với bác sĩ hoặc chuyên gia dinh dưỡng]
    F --> G[Áp dụng mức protein cá nhân hóa]
```
...
![Quá trình hủy xương và hình thành xương mới](https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Bone_remodeling_01.svg/960px-Bone_remodeling_01.svg.png)
