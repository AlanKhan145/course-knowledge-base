...
[![Athlete Diet: The Best, Simple, Proven 7-Day Meal Plan - Liv Hospital](https://images.openai.com/static-rsc-4/S1xU39IMeATguEBwoxeWh7LEjjA6Wd0fwvyEs_wHioX03Ez7y-icsf7BopO8EoetdOAccdKOzHxYN3DLtjC5Qg4vG2BadHauSFLItXNe5UTHiTaAhWBbqNbd8NSkW-wHmDWQ7dE5koWJTK8GAzLUhMZzsQXDBmj2iQ8PTRivQYk?purpose=inline)](https://int.livhospital.com/athlete-diet/?utm_source=chatgpt.com)
| Thuộc tính       | Nội dung                                   |
| ---------------- | ------------------------------------------ |
...
```mermaid
flowchart TD
    A[Mục tiêu: tăng cơ, giảm mỡ hoặc duy trì sức khỏe] --> B[Đánh giá điểm xuất phát]
    B --> C[Cân bằng năng lượng]
    C --> D[Protein, carbohydrate và chất béo]
    D --> E[Chất lượng nguồn thực phẩm]
    E --> F[Phân bổ bữa ăn phù hợp lịch sống]
    F --> G[Supplement khi thực sự cần]
    G --> H[Chương trình, sách và thiết bị hỗ trợ]
...
![Minh họa chuẩn bị kế hoạch bữa ăn](https://livhospital.b-cdn.net/wp-content/uploads/2025/11/26232820/image-8385-1024x683.png)
...
![Biểu đồ nghiên cứu về creatine và sức mạnh thân dưới](https://mdpi-res.com/d_attachment/nutrients/nutrients-16-03665/article_deploy/html/images/nutrients-16-03665-g004.png)
...
![Minh họa creatine dạng bột](https://bioglan.com.au/media/wysiwyg/different-types-of-creatine.jpg)
...
```mermaid
flowchart LR
    A[Bạn đang thiếu điều gì?] --> B{Không đạt protein?}
    B -->|Có| C[Điều chỉnh thực phẩm hoặc dùng protein powder]
    B -->|Không| D{Hiệu suất tập cường độ cao?}
    D -->|Muốn tối ưu| E[Cân nhắc creatine monohydrate]
    D -->|Không| F{Thiếu kiến thức lập thực đơn?}
    F -->|Có| G[Đọc Nutrient Priorities Cheat Sheet]
    F -->|Không| H{Không có chương trình tập?}
    H -->|Có| I[Chọn một chương trình phù hợp]
    H -->|Không| J[Tiếp tục theo dõi và tăng tiến]
```
