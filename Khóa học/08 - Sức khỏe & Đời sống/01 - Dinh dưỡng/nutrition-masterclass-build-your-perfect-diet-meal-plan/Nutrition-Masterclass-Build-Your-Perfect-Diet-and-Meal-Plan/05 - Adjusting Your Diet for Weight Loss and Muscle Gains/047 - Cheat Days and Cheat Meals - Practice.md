[![Healthy Plate: 50% Veggies & Fruits, 25% Lean Protein, 25% Whole Grains | AI Art Generator | Easy-Peasy.AI](https://images.openai.com/static-rsc-4/xXRSVWq82hrhCXFyjOls1kpGvdg8xj2CAmAIxRYwzjyWvaypaid5I9LZD4RFNXeqyEUF1dRiWcwgKGAOPz2unQ-nCD9eRBY1pU1ibKacHnC6n9DzJBztwyDXnBKCnt6HerBzNtAv7UdJ0rWP7vJgi0kwTZus7mVYxcHhgehCvIE?purpose=inline)](https://easy-peasy.ai/ai-image-generator/images/well-balanced-meal-vegetables-fruits-lean-proteins-whole-grains?utm_source=chatgpt.com)
...
![Bữa ăn cân bằng gồm cá hồi, rau củ, khoai tây và trái cây](https://commons.wikimedia.org/wiki/Special\:FilePath/Healthy_meal.jpg?width=1200)
...
```mermaid
pie showData
    title Cấu trúc chế độ ăn linh hoạt
    "Thực phẩm giàu dinh dưỡng" : 85
    "Thực phẩm linh hoạt" : 15
```
...
![So sánh lựa chọn giàu dinh dưỡng với lựa chọn thông thường](https://cdn.ncbi.nlm.nih.gov/pmc/blobs/38b2/8713704/428fcb48fe06/nt-56-287-g004.jpg)
...
```mermaid
flowchart LR
    A["6 ngày × thâm hụt 500 kcal"] --> B["Tổng thâm hụt: 3.000 kcal"]
    B --> C{"Ngày thứ 7 ăn bao nhiêu?"}
    C -->|"Ăn ở mức duy trì"| D["Giữ gần như toàn bộ thâm hụt"]
    C -->|"Dư 1.500 kcal"| E["Mất một nửa thâm hụt"]
    C -->|"Dư 3.000 kcal"| F["Thâm hụt tuần ≈ 0"]
```
...
![Hamburger — món thường xuất hiện trong các bữa ăn tự do](https://commons.wikimedia.org/wiki/Special\:FilePath/Cheeseburger_on_Plate.jpg?width=1200)
