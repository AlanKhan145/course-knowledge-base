...
![Các thực phẩm làm từ lúa mì thường chứa gluten](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Wheat_and_wheat_based_foods.jpg?width=1200)
...
![Mô phỏng niêm mạc và nhung mao ruột bị tổn thương trong bệnh celiac](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Inflammed_mucous_layer_of_the_intestinal_villi_depicting_Celiac_disease.jpg?width=1200)
...
```mermaid
flowchart TD
    A[Ăn thực phẩm chứa lúa mì] --> B{Xuất hiện triệu chứng?}
    B -- Không --> C[Không cần tự loại bỏ gluten]
    B -- Có --> D[Tiếp tục ăn gluten và đi khám]
    D --> E[Xét nghiệm bệnh celiac]
    D --> F[Đánh giá dị ứng lúa mì]
    E --> G{Celiac?}
    G -- Có --> H[Ăn không gluten nghiêm ngặt suốt đời]
    G -- Không --> I{Dị ứng lúa mì?}
    I -- Có --> J[Loại bỏ lúa mì theo hướng dẫn dị ứng]
    I -- Không --> K[Đánh giá NCGS, IBS, fructan/FODMAP và nguyên nhân khác]
```
