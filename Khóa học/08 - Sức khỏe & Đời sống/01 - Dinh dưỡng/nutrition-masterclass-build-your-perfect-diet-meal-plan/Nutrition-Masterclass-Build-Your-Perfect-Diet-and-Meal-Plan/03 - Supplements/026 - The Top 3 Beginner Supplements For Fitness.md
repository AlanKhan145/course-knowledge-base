...
![Protein powder, creatine và dầu cá là ba loại thực phẩm bổ sung được đề cập trong bài](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Whey_Protein_Scoop_%2849935767168%29.jpg/960px-Whey_Protein_Scoop_%2849935767168%29.jpg)
...
```mermaid
flowchart TD
    A[Mục tiêu rõ ràng] --> B[Calorie phù hợp]
    B --> C[Đủ protein và chất béo thiết yếu]
    C --> D[Thực phẩm đa dạng và đủ vi chất]
    D --> E[Chương trình tập có progressive overload]
    E --> F[Ngủ và phục hồi]
    F --> G[Thực phẩm bổ sung khi có khoảng trống]
```
...
![Một muỗng whey protein](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Whey_Protein_Scoop_%2849935767168%29.jpg/960px-Whey_Protein_Scoop_%2849935767168%29.jpg)
...
```mermaid
flowchart LR
    A[Đạt đủ protein?] -->|Chưa| B[Chọn loại dễ tiêu hóa]
    B --> C[Phù hợp ngân sách]
    C --> D[Mùi vị có thể duy trì]
    D --> E[Thành phần và lượng protein rõ ràng]
    E --> F[Kiểm nghiệm độc lập nếu có]
```
...
![Creatine monohydrate dạng bột](https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Creatine_monohydrate_powder.jpg/960px-Creatine_monohydrate_powder.jpg)
...
```mermaid
flowchart LR
    ATP[ATP] -->|Giải phóng năng lượng| ADP[ADP]
    PCr[Phosphocreatine] -->|Cho nhóm phosphate| ADP
    ADP -->|Tái tạo nhanh| ATP
    ATP --> C[Co cơ và thực hiện động tác]
```

### Hình nghiên cứu: hệ creatine–phosphocreatine

![Mô hình hệ creatine kinase và phosphocreatine giúp vận chuyển, tái tạo năng lượng ATP](https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs12970-017-0173-z/MediaObjects/12970_2017_173_Fig2_HTML.gif)
...
![Biểu đồ dự trữ creatine toàn phần trong cơ](https://media.springernature.com/lw685/springer-static/image/art%3A10.1186%2Fs12970-017-0173-z/MediaObjects/12970_2017_173_Fig4_HTML.gif)
...
![Viên dầu cá omega-3](https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Fish_Oil_Capsules.jpg/960px-Fish_Oil_Capsules.jpg)
...
```mermaid
flowchart TD
    A[Bạn đang định mua supplement] --> B{Nó giải quyết vấn đề gì?}

    B -->|Thiếu protein| C[Điều chỉnh thức ăn trước]
    C --> D{Vẫn khó đạt mục tiêu?}
    D -->|Có| E[Cân nhắc protein powder]
    D -->|Không| Z[Không cần mua]

    B -->|Muốn tăng hiệu suất tập nặng| F{Đã tập đều và có progressive overload?}
    F -->|Có| G[Cân nhắc creatine monohydrate]
    F -->|Không| H[Sửa chương trình tập trước]

    B -->|Không ăn cá| I[Đánh giá lượng EPA/DHA]
    I --> J{Có thể thêm cá hoặc dầu tảo?}
    J -->|Có| K[Ưu tiên thực phẩm]
    J -->|Không| L[Cân nhắc fish oil hoặc algae oil]

    B -->|Muốn tăng cơ thần tốc| M[Không có supplement hợp pháp nào thay thế tập và ăn]
```
