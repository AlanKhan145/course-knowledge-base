...
![Chuẩn bị nhiều bữa ăn có cấu trúc](https://commons.wikimedia.org/wiki/Special\:FilePath/Healthy_Meal_Prep_%28Unsplash%29.jpg)
...
```mermaid
flowchart TD
    A[Đã xác định tổng calorie và macro] --> B[Chọn số bữa ăn]
    B --> C[Phân phối protein]
    C --> D[Phân phối carbohydrate]
    D --> E[Phân phối chất béo]
    E --> F[Phân bổ phần calorie còn lại]
    F --> G[Điều chỉnh theo lịch sống và cảm giác cơ thể]
```
...
![Biểu đồ phân phối protein giữa các bữa](https://www.mdpi.com/nutrients/nutrients-12-02057/article_deploy/html/images/nutrients-12-02057-g001.png)
...
```mermaid
flowchart TD
    A[Ăn theo kế hoạch trong 1–2 tuần] --> B{Tập luyện có thoải mái không?}
    B -- Có --> C{Cân nặng và hiệu suất đúng mục tiêu?}
    B -- Không --> D[Điều chỉnh kích thước hoặc thời điểm bữa trước tập]
    D --> A
    C -- Có --> E[Giữ nguyên cấu trúc]
    C -- Không --> F[Điều chỉnh tổng calorie hoặc macro]
    F --> A
```
