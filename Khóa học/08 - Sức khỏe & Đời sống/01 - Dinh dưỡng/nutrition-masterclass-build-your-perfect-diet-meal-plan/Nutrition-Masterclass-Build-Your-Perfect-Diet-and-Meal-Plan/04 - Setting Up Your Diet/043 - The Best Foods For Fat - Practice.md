...
![Các nguồn chất béo lành mạnh gồm cá hồi, quả bơ, dầu ô liu, hạt và quả hạch](https://www.bupasalud.com/sites/default/files/inline-images/grasas-saludables.jpg)
...
```mermaid
flowchart TD
    A[Chọn nguồn chất béo] --> B{Loại chất béo chiếm ưu thế?}

    B --> C[Không bão hòa]
    B --> D[Bão hòa]
    B --> E[Chuyển hóa công nghiệp]

    C --> C1[Ưu tiên thường xuyên]
    C1 --> C2[Cá béo]
    C1 --> C3[Quả bơ]
    C1 --> C4[Dầu thực vật không nhiệt đới]
    C1 --> C5[Quả hạch và các loại hạt]

    D --> D1[Ăn có kiểm soát]
    D1 --> D2[Thịt nhiều mỡ]
    D1 --> D3[Bơ và sữa nguyên kem]
    D1 --> D4[Dầu dừa và dầu cọ]

    E --> E1[Giảm tối đa hoặc tránh]
    E1 --> E2[Dầu hydro hóa một phần]
    E1 --> E3[Một số đồ chiên và bánh đóng gói]
```
...
![Bốn cách bổ sung chất béo tốt theo American Heart Association](https://www.heart.org/-/media/AHA/H4GM/Infographics/4_Ways_Get_Good_Fats_infographic.jpg?sc_lang=en)
