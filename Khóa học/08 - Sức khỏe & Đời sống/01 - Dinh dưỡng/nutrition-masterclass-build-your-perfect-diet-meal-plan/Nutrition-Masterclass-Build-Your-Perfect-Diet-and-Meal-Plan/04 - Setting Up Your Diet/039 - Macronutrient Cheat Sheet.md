[![A systematic review, meta-analysis and meta-regression of the effect of protein supplementation ...](https://tse4.mm.bing.net/th/id/OIP.F-jVbLArjgQNG2cpRrBtKwHaFN?r=0\&pid=Api)](https://bjsm.bmj.com/content/52/6/376?utm_source=chatgpt.com)
...
![Bữa ăn cân bằng gồm nhiều nhóm thực phẩm](https://commons.wikimedia.org/wiki/Special\:FilePath/Dinner_meal_MyPlate_20210810-FNS-UNC-0016.jpg)
...
```mermaid
flowchart TD
    A[Xác định tổng calorie mỗi ngày] --> B[Xác định cân nặng và đơn vị kg hoặc lb]
    B --> C[Chọn lượng protein theo mục tiêu]
    C --> D[Chọn tỷ lệ chất béo trong khoảng phù hợp]
    D --> E[Tính lượng carbohydrate]
    E --> F[Tính tổng calorie từ protein, fat và carb]
    F --> G{Đã đạt mục tiêu calorie?}
    G -- Còn thiếu calorie --> H[Thêm carbohydrate và/hoặc chất béo]
    G -- Vượt calorie --> I[Giảm carbohydrate và/hoặc chất béo]
    G -- Đã khớp --> J[Hoàn thành kế hoạch macro]
    H --> F
    I --> F
```
...
![Biểu đồ thành phần chất dinh dưỡng của một số thực phẩm](https://commons.wikimedia.org/wiki/Special\:FilePath/Nutrient_composition.png)
