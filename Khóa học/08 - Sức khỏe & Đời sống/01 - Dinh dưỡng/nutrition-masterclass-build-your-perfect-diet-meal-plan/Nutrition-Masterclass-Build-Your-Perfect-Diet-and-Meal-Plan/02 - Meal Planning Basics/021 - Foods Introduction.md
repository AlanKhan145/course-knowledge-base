...
![Lập kế hoạch bữa ăn với thực phẩm tươi](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Healthy_meal_planning_with_fresh_fruits_and_vegetables_in_a_bright_kitchen_setting.jpg?width=1200)
...
```mermaid
flowchart TD
    A[Mục tiêu thể hình] --> B[1. Tổng calorie]
    B --> C[2. Lượng protein, carbohydrate và chất béo]
    C --> D[3. Phân bố bữa ăn và thời điểm ăn]
    D --> E[4. Nguồn thực phẩm]
    E --> F[5. Thực phẩm bổ sung nếu cần]

    B -. quyết định hướng tăng hoặc giảm cân .-> G[Kết quả hình thể]
    C -. hỗ trợ cơ bắp và hiệu suất .-> G
    D -. giúp tập luyện và duy trì kế hoạch .-> G
    E -. hỗ trợ sức khỏe, độ no và vi chất .-> G
```
...
![Bữa ăn gồm thịt gà, cơm, khoai tây và rau](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Liat_Portal_for_Foodie_Disorder_-_Grilled_chicken_with_rice,_potatoes_and_vegetables.jpg?width=1200)
...
```mermaid
pie showData
    title Gợi ý phân chia một đĩa ăn cân bằng
    "Rau củ và trái cây" : 50
    "Nguồn carbohydrate giàu chất xơ" : 25
    "Nguồn protein" : 25
```
