...
![Bữa ăn trước tập với yến mạch và chuối](https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Banana_oatmeal.jpg/960px-Banana_oatmeal.jpg)
...
```mermaid
flowchart LR
    A[Carbohydrate trong bữa ăn] --> B[Glucose trong máu]
    B --> C[Năng lượng sử dụng ngay]
    B --> D[Bổ sung glycogen]
    C --> E[Cơ bắp và hoạt động hằng ngày]
    D --> F[Gan và cơ bắp]
    B --> G[Dự trữ năng lượng]
    G --> H[Tăng mỡ đáng kể khi dư calorie kéo dài]
```
...
```mermaid
flowchart LR
    A[Bữa trước tập<br>Carb + protein] --> B[Tập luyện]
    B --> C[Sử dụng glucose<br>và glycogen]
    C --> D[Bữa sau tập<br>Carb + protein]
    D --> E[Bổ sung glycogen<br>và hỗ trợ phục hồi]
```
...
```mermaid
timeline
    title Ví dụ phân bổ carbohydrate trong ngày
    Buổi sáng : Bữa sáng có carb
    Buổi trưa : Bữa chính cân bằng
    Trước tập : Một phần carb phù hợp
    Buổi tập : Sử dụng glucose và glycogen
    Sau tập : Carb kết hợp protein
    Buổi tối : Điều chỉnh theo lượng carb còn lại
```
...
![Bữa ăn sau tập với cơm và thịt gà](https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Chicken_and_rice.jpg/960px-Chicken_and_rice.jpg)
