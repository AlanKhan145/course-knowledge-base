[![The Role of Vitamin K and Calcium in Coagulation Cascade](https://tse2.mm.bing.net/th/id/OIP.W1-HhfCrwKJIq2DIY-jHCgHaHi?r=0\&pid=Api)](https://www.uniqcret.com/post/vitamin-k-and-calcium-in-coagulation-cascade?utm_source=chatgpt.com)
...
![Cấu trúc vitamin K1, MK-4 và MK-7](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Vitamin_K_structures.svg)
...
```mermaid
flowchart LR
    A[Thực phẩm chứa vitamin K] --> B[Hấp thu tại ruột]
    B --> C[Vitamin K được gan và các mô sử dụng]
    C --> D[Hoạt hóa protein đông máu]
    C --> E[Hỗ trợ protein liên quan đến xương]
    D --> F[Hình thành cục máu đông khi cần]
    F --> G[Hạn chế chảy máu]
    E --> H[Duy trì sức khỏe xương]
```
...
![Cải xoăn – nguồn vitamin K1 nổi bật](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Kale-Bundle.jpg)
