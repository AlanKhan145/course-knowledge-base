...
![Các thực phẩm màu cam giàu carotenoid tiền vitamin A: bí đỏ, cà rốt và khoai lang](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Pumpkins%2C_carrots%2C_and_sweet_potatoes_in_the_market.jpg?width=1200)
...
```mermaid
flowchart LR
    A[Thực phẩm động vật] --> B[Retinol và retinyl ester]
    C[Rau củ và trái cây] --> D[Carotenoid tiền vitamin A]
    D -->|Chuyển đổi trong cơ thể| E[Retinol]
    B --> E
    E --> F[Gan dự trữ]
    E --> G[Retinal]
    E --> H[Retinoic acid]
    G --> I[Thị giác và thích nghi với bóng tối]
    H --> J[Điều hòa gen, tăng trưởng và biệt hóa tế bào]
```
...
![Sơ đồ chu trình thị giác phụ thuộc vitamin A trong võng mạc](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Visual_cycle.svg?width=1200)
...
![Mô phỏng sự khác biệt về thị giác ở người bị quáng gà](https://commons.wikimedia.org/wiki/Special\:Redirect/file/Depiction_of_vision_of_a_person_suffering_from_night_blindness.png?width=1200)
