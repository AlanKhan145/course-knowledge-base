# 002 - Cloud Data Warehouses

**Module:** Module 09 - Cloud Computing - Điện toán đám mây cho BI  
**Roadmap item:** 9.2  
**Loại nội dung:** Cloud BI  
...
Với BI Analyst, **Cloud Data Warehouses** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Cloud Data Warehouses** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 5. Bài tập thực hành
Vẽ kiến trúc cloud BI từ data source tới data warehouse và BI tool.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- Cloud BI architecture sketch
...
## 8. Tổng kết
**Cloud Data Warehouses** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
