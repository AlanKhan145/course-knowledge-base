# 004 - Algorithmic Bias

**Module:** Module 13 - Data Governance & Ethics - Quản trị và đạo đức dữ liệu  
**Roadmap item:** 13.4  
**Loại nội dung:** Data governance and ethics  
...
Với BI Analyst, **Algorithmic Bias** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Algorithmic Bias** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
- Công bằng trong phân tích dữ liệu
...
## 5. Bài tập thực hành
Review một dataset theo data quality, privacy, lineage và bias risk.

Sau đó viết 5-7 dòng trả lời: insight nào có thể giúp stakeholder ra quyết định tốt hơn?

## 6. Artifact nên tạo
- Data quality checklist and ethics review note
...
## 8. Tổng kết
**Algorithmic Bias** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
