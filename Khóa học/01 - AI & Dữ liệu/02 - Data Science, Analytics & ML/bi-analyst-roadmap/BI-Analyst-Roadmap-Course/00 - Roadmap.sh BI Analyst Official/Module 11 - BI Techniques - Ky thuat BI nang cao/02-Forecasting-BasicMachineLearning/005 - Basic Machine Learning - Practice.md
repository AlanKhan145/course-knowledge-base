# 005 - Basic Machine Learning

**Module:** Module 11 - BI Techniques - Kỹ thuật BI nâng cao  
**Roadmap item:** 11.5  
**Loại nội dung:** Advanced BI techniques  
...
Với BI Analyst, **Basic Machine Learning** cần được gắn với một câu hỏi kinh doanh rõ: ai cần quyết định, dữ liệu nào được dùng, metric nào quan trọng và insight sẽ dẫn tới hành động nào.

## 2. Mục tiêu học tập
- Giải thích được **Basic Machine Learning** bằng ngôn ngữ dễ hiểu cho stakeholder không chuyên về dữ liệu.
...
## 6. Artifact nên tạo
- Advanced analysis notebook or experiment brief
...
## 8. Tổng kết
**Basic Machine Learning** là một phần trong năng lực biến dữ liệu thành quyết định. Hãy kết thúc bài học bằng artifact có thể đưa vào dashboard, report hoặc portfolio BI Analyst.
