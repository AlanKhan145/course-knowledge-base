# 004 - Data Preparation Step

**Hoc phan:** 04 - Evaluation, Workflow and Deep Learning
**Module:** Module 12 - Machine Learning Workflow
**Nhom noi dung:** Workflow Steps
**Nguon roadmap:** Machine Learning Workflow / Workflow Steps
**Loai bai:** lesson
...
Bai nay giai thich **Data Preparation Step** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Data Preparation Step bang ngon ngu cua ban.
...
- Data Preparation Step is part of the Workflow Steps topic in the Machine Learning roadmap.
...
1. Write a 5-line note explaining Data Preparation Step.
