# 021 - Stratified Split

**Hoc phan:** 02 - Data Preparation and Feature Work
**Module:** Module 05 - Data Cleaning and Preprocessing
**Nhom noi dung:** Train-Test Data
**Nguon roadmap:** Data Cleaning and Preprocessing / Train-Test Data
**Loai bai:** data prep
...
Bai nay giai thich **Stratified Split** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Stratified Split bang ngon ngu cua ban.
...
- Stratified Split is part of the Train-Test Data topic in the Machine Learning roadmap.
