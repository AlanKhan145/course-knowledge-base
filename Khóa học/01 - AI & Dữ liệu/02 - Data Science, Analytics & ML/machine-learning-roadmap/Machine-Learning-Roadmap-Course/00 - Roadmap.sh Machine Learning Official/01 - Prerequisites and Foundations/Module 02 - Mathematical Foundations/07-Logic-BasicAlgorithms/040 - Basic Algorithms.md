# 040 - Basic Algorithms

**Hoc phan:** 01 - Prerequisites and Foundations
**Module:** Module 02 - Mathematical Foundations
**Nhom noi dung:** Probability and Discrete Mathematics
**Nguon roadmap:** Mathematical Foundations / Probability and Discrete Mathematics
**Loai bai:** math
...
Bai nay giai thich **Basic Algorithms** trong boi canh Machine Learning Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong quy trinh ML, lien quan den data, feature, model, training, evaluation, deployment hoac portfolio nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Basic Algorithms bang ngon ngu cua ban.
...
- Basic Algorithms is part of the Probability and Discrete Mathematics topic in the Machine Learning roadmap.
