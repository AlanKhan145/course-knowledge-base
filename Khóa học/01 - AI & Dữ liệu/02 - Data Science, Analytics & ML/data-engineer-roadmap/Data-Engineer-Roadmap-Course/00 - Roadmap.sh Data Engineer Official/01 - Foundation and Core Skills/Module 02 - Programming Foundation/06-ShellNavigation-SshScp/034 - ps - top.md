...
Bai nay giai thich **ps / top** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc ps / top bang ngon ngu cua ban.
...
- ps / top is part of the Linux Basics topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining ps / top.
