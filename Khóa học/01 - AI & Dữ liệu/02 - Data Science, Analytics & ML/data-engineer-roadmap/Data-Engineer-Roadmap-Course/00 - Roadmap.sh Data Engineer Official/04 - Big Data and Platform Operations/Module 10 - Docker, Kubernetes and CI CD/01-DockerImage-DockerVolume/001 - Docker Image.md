...
Bai nay giai thich **Docker Image** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Docker Image bang ngon ngu cua ban.
...
- Docker Image is part of the Docker topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining Docker Image.
