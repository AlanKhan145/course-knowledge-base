# 024 - Advanced SQL and PostgreSQL
...
Bai nay giai thich **Advanced SQL and PostgreSQL** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Advanced SQL and PostgreSQL bang ngon ngu cua ban.
...
- Advanced SQL and PostgreSQL is part of the Optimized Learning Order topic in the Data Engineer roadmap.
...
2. Write one query that demonstrates Advanced SQL and PostgreSQL.
