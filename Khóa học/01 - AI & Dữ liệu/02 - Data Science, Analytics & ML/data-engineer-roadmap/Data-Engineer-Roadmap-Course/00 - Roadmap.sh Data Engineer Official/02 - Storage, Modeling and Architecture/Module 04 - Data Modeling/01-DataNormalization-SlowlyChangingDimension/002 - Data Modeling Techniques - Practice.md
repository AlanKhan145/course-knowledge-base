# 002 - Data Modeling Techniques

**Hoc phan:** 02 - Storage, Modeling and Architecture
**Module:** Module 04 - Data Modeling
**Nhom noi dung:** Database Fundamentals
**Nguon roadmap:** Data Modeling / Database Fundamentals
...
Bai nay giai thich **Data Modeling Techniques** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Data Modeling Techniques bang ngon ngu cua ban.
...
- Data Modeling Techniques is part of the Database Fundamentals topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining Data Modeling Techniques.
