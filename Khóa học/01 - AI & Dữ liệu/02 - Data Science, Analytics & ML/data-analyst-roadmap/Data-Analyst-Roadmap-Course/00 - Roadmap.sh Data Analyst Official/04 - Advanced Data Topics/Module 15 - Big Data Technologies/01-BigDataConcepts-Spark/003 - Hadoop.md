...
Bai nay giai thich **Hadoop** trong boi canh Data Analyst hien dai. Sau bai hoc, ban nen biet topic nay giup tra loi cau hoi data nao, nam o dau trong workflow va co the bien thanh query, spreadsheet, notebook, chart, dashboard hoac portfolio artifact.

## 2. Muc tieu hoc tap

- Giai thich duoc Hadoop bang ngon ngu cua ban.
...
- Hadoop la he sinh thai big data gan voi HDFS va MapReduce.
- Ngay nay co the gap trong legacy data platform.
- Can hieu luu tru phan tan va batch processing o muc khai niem.
...
- Toi co the giai thich **Hadoop** trong 1-2 phut.
...
**Hadoop** la mot moc trong lo trinh Data Analyst. Hay bien no thanh mot bang tinh, query, notebook, chart, dashboard hoac portfolio note de kien thuc co cho bam.
