...
Bai nay giai thich **Tableau** trong boi canh Data Analyst hien dai. Sau bai hoc, ban nen biet topic nay giup tra loi cau hoi data nao, nam o dau trong workflow va co the bien thanh query, spreadsheet, notebook, chart, dashboard hoac portfolio artifact.

## 2. Muc tieu hoc tap

- Giai thich duoc Tableau bang ngon ngu cua ban.
...
- Tableau la BI tool de tao dashboard va interactive report.
- Can hieu data source, calculated field, filter, parameter va dashboard layout.
- Dashboard tot nen tra loi cau hoi business ro rang.

## 4. Vi du / Demo

```text
Dashboard layout:
KPI row -> trend chart -> segment breakdown -> filter panel -> notes/source
```
...
- Toi co the giai thich **Tableau** trong 1-2 phut.
...
**Tableau** la mot moc trong lo trinh Data Analyst. Hay bien no thanh mot bang tinh, query, notebook, chart, dashboard hoac portfolio note de kien thuc co cho bam.
