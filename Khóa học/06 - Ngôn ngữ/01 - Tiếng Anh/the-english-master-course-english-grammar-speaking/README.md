...
- **Cấu trúc cục bộ:** 147 module / 718 bài học được lập chỉ mục
...
Kho cục bộ chỉ giữ các module có bài học cụ thể. Các phần hướng dẫn nhập môn, thông báo nâng cấp, mục quảng bá và những section chưa công khai tên bài giảng riêng đã được loại bỏ khỏi cấu trúc ghi chú.

## Điều hướng

- [COURSE_INDEX.md](<./COURSE_INDEX.md>) — danh sách đầy đủ 153 module và tất cả bài học
