# Lesson 316 - Academic Task 1: Live Class (Part 2)
...
- giải thích mục tiêu của bài **Academic Task 1: Live Class (Part 2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Academic Task 1: Live Class (Part 2)** trong module **Live (2018)) Academic Writing Task 1 Class 1**.
