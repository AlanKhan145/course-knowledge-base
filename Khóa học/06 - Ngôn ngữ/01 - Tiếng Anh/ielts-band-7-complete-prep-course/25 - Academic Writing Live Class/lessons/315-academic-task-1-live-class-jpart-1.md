# Lesson 315 - Academic Task 1: Live Class (JPart 1)

> Module 25: Live (2018)) Academic Writing Task 1 Class 1  
> Loại bài: Ôn tập qua lớp học trực tuyến  
...
- giải thích mục tiêu của bài **Academic Task 1: Live Class (JPart 1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Academic Task 1: Live Class (JPart 1)** trong module **Live (2018)) Academic Writing Task 1 Class 1**.
