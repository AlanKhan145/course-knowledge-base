# Lesson 318 - Academic Task 1: Live Class (Part 4)
...
- giải thích mục tiêu của bài **Academic Task 1: Live Class (Part 4)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Academic Task 1: Live Class (Part 4)** trong module **Live (2018)) Academic Writing Task 1 Class 1**.
