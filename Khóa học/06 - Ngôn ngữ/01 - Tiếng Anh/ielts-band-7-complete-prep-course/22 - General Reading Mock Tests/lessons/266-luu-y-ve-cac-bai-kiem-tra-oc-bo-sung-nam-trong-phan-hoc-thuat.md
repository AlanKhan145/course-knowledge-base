# Lesson 266 - Lưu ý về (Các) Bài kiểm tra Đọc Bổ sung nằm trong Phần Học thuật
...
- giải thích mục tiêu của bài **Lưu ý về (Các) Bài kiểm tra Đọc Bổ sung nằm trong Phần Học thuật** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Lưu ý về (Các) Bài kiểm tra Đọc Bổ sung nằm trong Phần Học thuật** trong module **Bài thi Thử Đọc Tổng quát chính thức (6 bài)**.
