# Lesson 303 - Sử dụng ChatGpt để Tự đánh giá Bài viết Task 1
...
- giải thích mục tiêu của bài **Sử dụng ChatGpt để Tự đánh giá Bài viết Task 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Sử dụng ChatGpt để Tự đánh giá Bài viết Task 1** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
