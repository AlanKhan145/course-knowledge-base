# Lesson 308 - Sơ đồ (Bản đồ) Mở bài, Tổng quan Chung, Các Đoạn Chi tiết Cụ thể
...
- giải thích mục tiêu của bài **Sơ đồ (Bản đồ) Mở bài, Tổng quan Chung, Các Đoạn Chi tiết Cụ thể** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Sơ đồ (Bản đồ) Mở bài, Tổng quan Chung, Các Đoạn Chi tiết Cụ thể** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
