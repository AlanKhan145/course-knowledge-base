# Lesson 310 - Diagram (Process) Specific Details (Paragraphs 3 and 4)
...
- giải thích mục tiêu của bài **Diagram (Process) Specific Details (Paragraphs 3 and 4)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Diagram (Process) Specific Details (Paragraphs 3 and 4)** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
