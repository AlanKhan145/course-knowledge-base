# Lesson 311 - IElTS Writing Task 1 Real Time Example 2
...
- giải thích mục tiêu của bài **IElTS Writing Task 1 Real Time Example 2** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **IElTS Writing Task 1 Real Time Example 2** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
