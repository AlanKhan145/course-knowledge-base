# Lesson 291 - Kiến thức Cơ bản về IELTS Writing Task 1
...
- giải thích mục tiêu của bài **Kiến thức Cơ bản về IELTS Writing Task 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Kiến thức Cơ bản về IELTS Writing Task 1** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
