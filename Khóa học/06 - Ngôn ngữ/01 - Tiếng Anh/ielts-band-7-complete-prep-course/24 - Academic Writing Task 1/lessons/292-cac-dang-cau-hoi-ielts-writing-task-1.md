# Lesson 292 - Các dạng câu hỏi IELTS Writing Task 1
...
- giải thích mục tiêu của bài **Các dạng câu hỏi IELTS Writing Task 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Các dạng câu hỏi IELTS Writing Task 1** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
