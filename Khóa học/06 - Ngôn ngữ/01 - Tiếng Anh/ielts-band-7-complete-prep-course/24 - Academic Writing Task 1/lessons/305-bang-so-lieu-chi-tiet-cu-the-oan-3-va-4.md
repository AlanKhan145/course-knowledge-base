# Lesson 305 - Bảng số liệu: Chi tiết Cụ thể (Đoạn 3 và 4)
...
- giải thích mục tiêu của bài **Bảng số liệu: Chi tiết Cụ thể (Đoạn 3 và 4)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Bảng số liệu: Chi tiết Cụ thể (Đoạn 3 và 4)** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
