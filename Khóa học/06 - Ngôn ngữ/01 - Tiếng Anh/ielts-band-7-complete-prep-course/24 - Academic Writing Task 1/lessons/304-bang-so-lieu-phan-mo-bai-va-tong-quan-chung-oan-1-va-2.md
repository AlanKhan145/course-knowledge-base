# Lesson 304 - Bảng số liệu: Phần Mở bài và Tổng quan Chung (Đoạn 1 và 2)
...
- giải thích mục tiêu của bài **Bảng số liệu: Phần Mở bài và Tổng quan Chung (Đoạn 1 và 2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Bảng số liệu: Phần Mở bài và Tổng quan Chung (Đoạn 1 và 2)** trong module **Chiến lược và Kỹ thuật Viết IELTS Học thuật Task 1**.
