# Lesson 203 - Ví dụ của Giáo viên về Scanning để Ghép từ vựng (Tổng quát)
...
- giải thích mục tiêu của bài **Ví dụ của Giáo viên về Scanning để Ghép từ vựng (Tổng quát)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Ví dụ của Giáo viên về Scanning để Ghép từ vựng (Tổng quát)** trong module **Đọc Tổng quát: Kỹ thuật Scanning cho Phần Ghép từ vựng**.
