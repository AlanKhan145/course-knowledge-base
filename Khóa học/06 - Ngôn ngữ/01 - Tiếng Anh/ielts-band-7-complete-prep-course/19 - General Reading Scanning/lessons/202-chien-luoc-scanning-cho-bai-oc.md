# Lesson 202 - Chiến lược Scanning cho Bài đọc
...
- giải thích mục tiêu của bài **Chiến lược Scanning cho Bài đọc** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Chiến lược Scanning cho Bài đọc** trong module **Đọc Tổng quát: Kỹ thuật Scanning cho Phần Ghép từ vựng**.
