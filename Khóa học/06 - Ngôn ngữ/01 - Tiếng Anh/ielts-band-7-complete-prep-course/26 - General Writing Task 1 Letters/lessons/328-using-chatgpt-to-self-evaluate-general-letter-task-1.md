# Lesson 328 - Using ChatGpt to Self-Evaluate General Letter Task 1
...
- giải thích mục tiêu của bài **Using ChatGpt to Self-Evaluate General Letter Task 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Using ChatGpt to Self-Evaluate General Letter Task 1** trong module **General Exam Task 1 Letter Lectures (How to do Task 1 General Letter)**.
