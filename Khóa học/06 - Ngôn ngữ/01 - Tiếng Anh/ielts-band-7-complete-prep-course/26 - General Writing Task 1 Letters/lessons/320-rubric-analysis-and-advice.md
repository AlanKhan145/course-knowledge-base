# Lesson 320 - Rubric Analysis and Advice
...
- giải thích mục tiêu của bài **Rubric Analysis and Advice** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Rubric Analysis and Advice** trong module **General Exam Task 1 Letter Lectures (How to do Task 1 General Letter)**.
