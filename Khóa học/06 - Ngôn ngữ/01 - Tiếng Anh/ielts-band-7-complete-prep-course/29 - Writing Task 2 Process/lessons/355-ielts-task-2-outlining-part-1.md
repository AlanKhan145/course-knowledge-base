# Lesson 355 - IELTS Task 2 Outlining (Part 1)
...
- giải thích mục tiêu của bài **IELTS Task 2 Outlining (Part 1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **IELTS Task 2 Outlining (Part 1)** trong module **IELTS Writing Task 2 Writing Process and Tactics (Academic and General)**.
