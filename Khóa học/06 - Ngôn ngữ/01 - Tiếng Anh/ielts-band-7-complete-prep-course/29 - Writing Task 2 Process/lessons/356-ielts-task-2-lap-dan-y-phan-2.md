# Lesson 356 - IELTS Task 2: Lập Dàn Ý (Phần 2)
...
- giải thích mục tiêu của bài **IELTS Task 2: Lập Dàn Ý (Phần 2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **IELTS Task 2: Lập Dàn Ý (Phần 2)** trong module **IELTS Writing Task 2 Writing Process and Tactics (Academic and General)**.
