# Lesson 352 - IELTS Task 2: Question Analysis (Part 1)
...
- giải thích mục tiêu của bài **IELTS Task 2: Question Analysis (Part 1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **IELTS Task 2: Question Analysis (Part 1)** trong module **IELTS Writing Task 2 Writing Process and Tactics (Academic and General)**.
