# Lesson 354 - IELTS Task 2: Question Analysis (Part 3)
...
- giải thích mục tiêu của bài **IELTS Task 2: Question Analysis (Part 3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **IELTS Task 2: Question Analysis (Part 3)** trong module **IELTS Writing Task 2 Writing Process and Tactics (Academic and General)**.
