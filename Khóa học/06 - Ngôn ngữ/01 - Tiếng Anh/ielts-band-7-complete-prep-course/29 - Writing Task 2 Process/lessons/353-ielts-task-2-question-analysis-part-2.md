# Lesson 353 - IELTS Task 2: Question Analysis (Part 2)
...
- giải thích mục tiêu của bài **IELTS Task 2: Question Analysis (Part 2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **IELTS Task 2: Question Analysis (Part 2)** trong module **IELTS Writing Task 2 Writing Process and Tactics (Academic and General)**.
