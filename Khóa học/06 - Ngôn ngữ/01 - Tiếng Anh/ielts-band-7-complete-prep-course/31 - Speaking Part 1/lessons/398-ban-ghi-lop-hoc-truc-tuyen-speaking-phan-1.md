# Lesson 398 - Bản Ghi Lớp Học Trực Tuyến Speaking Phần 1
...
- giải thích mục tiêu của bài **Bản Ghi Lớp Học Trực Tuyến Speaking Phần 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Bản Ghi Lớp Học Trực Tuyến Speaking Phần 1** trong module **Phần 1 Speaking: Phỏng Vấn**.
