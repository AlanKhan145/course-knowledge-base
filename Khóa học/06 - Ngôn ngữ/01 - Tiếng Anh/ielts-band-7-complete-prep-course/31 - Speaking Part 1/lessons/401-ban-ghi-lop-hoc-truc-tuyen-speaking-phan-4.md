# Lesson 401 - Bản Ghi Lớp Học Trực Tuyến Speaking Phần 4
...
- giải thích mục tiêu của bài **Bản Ghi Lớp Học Trực Tuyến Speaking Phần 4** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Bản Ghi Lớp Học Trực Tuyến Speaking Phần 4** trong module **Phần 1 Speaking: Phỏng Vấn**.
