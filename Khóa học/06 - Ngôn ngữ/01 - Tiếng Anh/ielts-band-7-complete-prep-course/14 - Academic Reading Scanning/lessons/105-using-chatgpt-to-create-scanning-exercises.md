# Lesson 105 - Using ChatGPT to Create Scanning Exercises
...
- giải thích mục tiêu của bài **Using ChatGPT to Create Scanning Exercises** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Using ChatGPT to Create Scanning Exercises** trong module **Đọc Học Thuật: Kỹ Năng Quét Tìm Từ Vựng Khớp**.
