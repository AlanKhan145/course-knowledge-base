# Lesson 106 - Teacher Example of Scanning for Matching Vocabulary (Academic)
...
- giải thích mục tiêu của bài **Teacher Example of Scanning for Matching Vocabulary (Academic)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Teacher Example of Scanning for Matching Vocabulary (Academic)** trong module **Đọc Học Thuật: Kỹ Năng Quét Tìm Từ Vựng Khớp**.
