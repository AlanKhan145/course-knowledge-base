# Lesson 108 - Test 2: Scanning for Matching Vocabulary Language (Academic)
...
- giải thích mục tiêu của bài **Test 2: Scanning for Matching Vocabulary Language (Academic)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Test 2: Scanning for Matching Vocabulary Language (Academic)** trong module **Đọc Học Thuật: Kỹ Năng Quét Tìm Từ Vựng Khớp**.
