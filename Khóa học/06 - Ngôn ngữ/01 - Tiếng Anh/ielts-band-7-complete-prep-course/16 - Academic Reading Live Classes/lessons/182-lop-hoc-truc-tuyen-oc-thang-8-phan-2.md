# Lesson 182 - Lớp học Trực tuyến: Đọc (Tháng 8) Phần 2
...
- giải thích mục tiêu của bài **Lớp học Trực tuyến: Đọc (Tháng 8) Phần 2** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Lớp học Trực tuyến: Đọc (Tháng 8) Phần 2** trong module **Bản ghi Lớp học Trực tuyến Ứng dụng Chiến lược Đọc (Tài liệu Học thuật)**.
