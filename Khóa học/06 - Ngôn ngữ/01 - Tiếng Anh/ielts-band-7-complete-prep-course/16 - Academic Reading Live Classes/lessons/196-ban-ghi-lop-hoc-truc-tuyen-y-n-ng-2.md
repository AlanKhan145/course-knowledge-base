# Lesson 196 - Bản ghi Lớp học Trực tuyến (Y-N-NG) 2
...
- giải thích mục tiêu của bài **Bản ghi Lớp học Trực tuyến (Y-N-NG) 2** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Bản ghi Lớp học Trực tuyến (Y-N-NG) 2** trong module **Bản ghi Lớp học Trực tuyến Ứng dụng Chiến lược Đọc (Tài liệu Học thuật)**.
