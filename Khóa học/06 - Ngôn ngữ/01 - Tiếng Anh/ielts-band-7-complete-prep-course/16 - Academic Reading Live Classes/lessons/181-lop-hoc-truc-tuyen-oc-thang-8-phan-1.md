# Lesson 181 - Lớp học Trực tuyến: Đọc (Tháng 8) Phần 1
...
- giải thích mục tiêu của bài **Lớp học Trực tuyến: Đọc (Tháng 8) Phần 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Lớp học Trực tuyến: Đọc (Tháng 8) Phần 1** trong module **Bản ghi Lớp học Trực tuyến Ứng dụng Chiến lược Đọc (Tài liệu Học thuật)**.
