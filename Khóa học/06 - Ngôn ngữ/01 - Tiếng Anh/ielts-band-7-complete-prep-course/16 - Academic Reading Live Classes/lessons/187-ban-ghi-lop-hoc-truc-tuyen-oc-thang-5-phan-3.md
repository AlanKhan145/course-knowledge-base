# Lesson 187 - Bản ghi Lớp học Trực tuyến: Đọc (Tháng 5) Phần 3
...
- giải thích mục tiêu của bài **Bản ghi Lớp học Trực tuyến: Đọc (Tháng 5) Phần 3** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Bản ghi Lớp học Trực tuyến: Đọc (Tháng 5) Phần 3** trong module **Bản ghi Lớp học Trực tuyến Ứng dụng Chiến lược Đọc (Tài liệu Học thuật)**.
