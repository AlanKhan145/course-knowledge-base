# Lesson 127 - (Fill-Blank) Strategy Application 1 + Analysis (B.10 T2)
...
- giải thích mục tiêu của bài **(Fill-Blank) Strategy Application 1 + Analysis (B.10 T2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Fill-Blank) Strategy Application 1 + Analysis (B.10 T2)** trong module **Academic Reading Specific Question Strategy and Tactics**.
