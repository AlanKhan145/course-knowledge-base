# Lesson 152 - (Sentence Completion) Strategy Application 3 + Analysis (B.15 T3 P3)
...
- giải thích mục tiêu của bài **(Sentence Completion) Strategy Application 3 + Analysis (B.15 T3 P3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Sentence Completion) Strategy Application 3 + Analysis (B.15 T3 P3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
