# Lesson 177 - #2 Ôn tập toàn bộ Câu hỏi Phần Đọc Phần 4
...
- giải thích mục tiêu của bài **#2 Ôn tập toàn bộ Câu hỏi Phần Đọc Phần 4** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **#2 Ôn tập toàn bộ Câu hỏi Phần Đọc Phần 4** trong module **Academic Reading Specific Question Strategy and Tactics**.
