# Lesson 114 - True, False, Not Given Example and Analysis 2
...
- giải thích mục tiêu của bài **True, False, Not Given Example and Analysis 2** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **True, False, Not Given Example and Analysis 2** trong module **Academic Reading Specific Question Strategy and Tactics**.
