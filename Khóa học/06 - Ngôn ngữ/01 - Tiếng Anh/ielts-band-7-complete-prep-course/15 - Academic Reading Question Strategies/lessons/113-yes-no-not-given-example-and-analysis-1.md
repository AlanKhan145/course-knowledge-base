# Lesson 113 - Yes, No, Not Given Example and Analysis 1
...
- giải thích mục tiêu của bài **Yes, No, Not Given Example and Analysis 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Yes, No, Not Given Example and Analysis 1** trong module **Academic Reading Specific Question Strategy and Tactics**.
