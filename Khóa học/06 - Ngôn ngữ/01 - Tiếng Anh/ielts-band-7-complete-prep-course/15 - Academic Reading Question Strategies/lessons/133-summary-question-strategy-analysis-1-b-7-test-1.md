# Lesson 133 - Summary Question Strategy Analysis 1 (B.7.Test.1)
...
- giải thích mục tiêu của bài **Summary Question Strategy Analysis 1 (B.7.Test.1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Summary Question Strategy Analysis 1 (B.7.Test.1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
