# Lesson 167 - (Headings) Strategy Application 2 + Analysis (Cambridge 2014 T2)
...
- giải thích mục tiêu của bài **(Headings) Strategy Application 2 + Analysis (Cambridge 2014 T2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Headings) Strategy Application 2 + Analysis (Cambridge 2014 T2)** trong module **Academic Reading Specific Question Strategy and Tactics**.
