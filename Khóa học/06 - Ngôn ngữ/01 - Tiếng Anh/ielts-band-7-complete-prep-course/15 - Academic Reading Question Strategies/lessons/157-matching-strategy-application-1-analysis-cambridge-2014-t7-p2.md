# Lesson 157 - (Matching) Strategy Application 1 + Analysis (Cambridge 2014 T7 P2)
...
- giải thích mục tiêu của bài **(Matching) Strategy Application 1 + Analysis (Cambridge 2014 T7 P2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Matching) Strategy Application 1 + Analysis (Cambridge 2014 T7 P2)** trong module **Academic Reading Specific Question Strategy and Tactics**.
