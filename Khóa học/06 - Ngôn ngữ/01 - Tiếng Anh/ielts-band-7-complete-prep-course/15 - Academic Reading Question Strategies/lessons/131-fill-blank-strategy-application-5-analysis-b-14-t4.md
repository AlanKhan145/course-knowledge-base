# Lesson 131 - (Fill-Blank) Strategy Application 5 + Analysis (B.14 T4)
...
- giải thích mục tiêu của bài **(Fill-Blank) Strategy Application 5 + Analysis (B.14 T4)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Fill-Blank) Strategy Application 5 + Analysis (B.14 T4)** trong module **Academic Reading Specific Question Strategy and Tactics**.
