# Lesson 118 - (Y-N-NG) Strategy Application 4 + Analysis (B.15 T2 P3)
...
- giải thích mục tiêu của bài **(Y-N-NG) Strategy Application 4 + Analysis (B.15 T2 P3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Y-N-NG) Strategy Application 4 + Analysis (B.15 T2 P3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
