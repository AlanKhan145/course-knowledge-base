# Lesson 155 - (MCQ Pick 2-5) Strategy Application 2 + Analysis (B 14 T1 P1)
...
- giải thích mục tiêu của bài **(MCQ Pick 2-5) Strategy Application 2 + Analysis (B 14 T1 P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(MCQ Pick 2-5) Strategy Application 2 + Analysis (B 14 T1 P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
