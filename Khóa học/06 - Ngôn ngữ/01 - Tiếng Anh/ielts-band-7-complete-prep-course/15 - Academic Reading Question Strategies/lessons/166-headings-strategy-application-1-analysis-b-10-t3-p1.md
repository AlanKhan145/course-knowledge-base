# Lesson 166 - (Headings) Strategy Application 1 + Analysis (B.10 T3 P1)
...
- giải thích mục tiêu của bài **(Headings) Strategy Application 1 + Analysis (B.10 T3 P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Headings) Strategy Application 1 + Analysis (B.10 T3 P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
