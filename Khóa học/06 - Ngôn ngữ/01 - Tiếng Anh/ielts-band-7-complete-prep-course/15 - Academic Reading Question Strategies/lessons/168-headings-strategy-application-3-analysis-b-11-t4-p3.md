# Lesson 168 - (Headings) Strategy Application 3 + Analysis (B.11 T4 P3)
...
- giải thích mục tiêu của bài **(Headings) Strategy Application 3 + Analysis (B.11 T4 P3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Headings) Strategy Application 3 + Analysis (B.11 T4 P3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
