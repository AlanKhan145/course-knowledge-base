# Lesson 161 - (Paragraph Location) Strategy Application 2 + Analysis (B.12 T6 P3)
...
- giải thích mục tiêu của bài **(Paragraph Location) Strategy Application 2 + Analysis (B.12 T6 P3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Paragraph Location) Strategy Application 2 + Analysis (B.12 T6 P3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
