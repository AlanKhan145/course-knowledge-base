# Lesson 117 - (Y-N-NG) Strategy Application 3 + Analysis (B.12 T5)
...
- giải thích mục tiêu của bài **(Y-N-NG) Strategy Application 3 + Analysis (B.12 T5)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Y-N-NG) Strategy Application 3 + Analysis (B.12 T5)** trong module **Academic Reading Specific Question Strategy and Tactics**.
