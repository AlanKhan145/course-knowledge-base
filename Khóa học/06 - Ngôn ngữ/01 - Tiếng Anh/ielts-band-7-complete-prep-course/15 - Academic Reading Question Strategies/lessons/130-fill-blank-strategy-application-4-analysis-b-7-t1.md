# Lesson 130 - (Fill-Blank) Strategy Application 4 + Analysis (B.7 T1)
...
- giải thích mục tiêu của bài **(Fill-Blank) Strategy Application 4 + Analysis (B.7 T1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Fill-Blank) Strategy Application 4 + Analysis (B.7 T1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
