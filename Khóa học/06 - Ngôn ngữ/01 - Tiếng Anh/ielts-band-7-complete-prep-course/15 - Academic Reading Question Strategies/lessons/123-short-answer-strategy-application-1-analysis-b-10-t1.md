# Lesson 123 - (Short Answer) Strategy Application 1 + Analysis (B.10 T1)
...
- giải thích mục tiêu của bài **(Short Answer) Strategy Application 1 + Analysis (B.10 T1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Short Answer) Strategy Application 1 + Analysis (B.10 T1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
