# Lesson 160 - (Paragraph Location) Strategy Application 1 + Analysis (B.8 T1)
...
- giải thích mục tiêu của bài **(Paragraph Location) Strategy Application 1 + Analysis (B.8 T1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Paragraph Location) Strategy Application 1 + Analysis (B.8 T1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
