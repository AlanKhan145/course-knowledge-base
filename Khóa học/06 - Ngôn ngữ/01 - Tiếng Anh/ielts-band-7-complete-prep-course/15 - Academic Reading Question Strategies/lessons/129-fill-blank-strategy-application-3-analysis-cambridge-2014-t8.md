# Lesson 129 - (Fill-Blank) Strategy Application 3 + Analysis (Cambridge 2014 T8)
...
- giải thích mục tiêu của bài **(Fill-Blank) Strategy Application 3 + Analysis (Cambridge 2014 T8)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Fill-Blank) Strategy Application 3 + Analysis (Cambridge 2014 T8)** trong module **Academic Reading Specific Question Strategy and Tactics**.
