# Lesson 148 - (MCQ Standard) Strategy Application 4 + Analysis (B.11 T4 P2)
...
- giải thích mục tiêu của bài **(MCQ Standard) Strategy Application 4 + Analysis (B.11 T4 P2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(MCQ Standard) Strategy Application 4 + Analysis (B.11 T4 P2)** trong module **Academic Reading Specific Question Strategy and Tactics**.
