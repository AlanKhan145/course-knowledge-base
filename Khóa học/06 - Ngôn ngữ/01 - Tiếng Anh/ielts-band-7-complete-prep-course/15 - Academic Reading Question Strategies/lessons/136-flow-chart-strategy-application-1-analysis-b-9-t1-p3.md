# Lesson 136 - (Flow Chart) Strategy Application 1 + Analysis (B.9 T1 P3)
...
- giải thích mục tiêu của bài **(Flow Chart) Strategy Application 1 + Analysis (B.9 T1 P3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Flow Chart) Strategy Application 1 + Analysis (B.9 T1 P3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
