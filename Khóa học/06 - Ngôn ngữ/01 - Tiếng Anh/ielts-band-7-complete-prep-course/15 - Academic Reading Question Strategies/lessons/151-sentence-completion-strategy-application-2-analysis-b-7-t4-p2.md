# Lesson 151 - (Sentence Completion) Strategy Application 2 + Analysis (B.7 T4 P2)
...
- giải thích mục tiêu của bài **(Sentence Completion) Strategy Application 2 + Analysis (B.7 T4 P2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Sentence Completion) Strategy Application 2 + Analysis (B.7 T4 P2)** trong module **Academic Reading Specific Question Strategy and Tactics**.
