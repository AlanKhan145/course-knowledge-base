# Lesson 146 - (MCQ Standard) Strategy Application 2 + Analysis (B.9 T4 P3)
...
- giải thích mục tiêu của bài **(MCQ Standard) Strategy Application 2 + Analysis (B.9 T4 P3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(MCQ Standard) Strategy Application 2 + Analysis (B.9 T4 P3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
