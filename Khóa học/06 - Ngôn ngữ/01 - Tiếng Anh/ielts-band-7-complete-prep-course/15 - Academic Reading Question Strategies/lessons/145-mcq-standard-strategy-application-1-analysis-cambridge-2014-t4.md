# Lesson 145 - (MCQ Standard) Strategy Application 1 + Analysis (Cambridge 2014 T4)
...
- giải thích mục tiêu của bài **(MCQ Standard) Strategy Application 1 + Analysis (Cambridge 2014 T4)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(MCQ Standard) Strategy Application 1 + Analysis (Cambridge 2014 T4)** trong module **Academic Reading Specific Question Strategy and Tactics**.
