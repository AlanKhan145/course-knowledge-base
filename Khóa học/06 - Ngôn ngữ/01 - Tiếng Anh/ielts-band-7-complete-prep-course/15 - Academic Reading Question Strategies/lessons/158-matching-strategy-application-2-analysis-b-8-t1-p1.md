# Lesson 158 - (Matching) Strategy Application 2 + Analysis (B.8 T1 P1)
...
- giải thích mục tiêu của bài **(Matching) Strategy Application 2 + Analysis (B.8 T1 P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Matching) Strategy Application 2 + Analysis (B.8 T1 P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
