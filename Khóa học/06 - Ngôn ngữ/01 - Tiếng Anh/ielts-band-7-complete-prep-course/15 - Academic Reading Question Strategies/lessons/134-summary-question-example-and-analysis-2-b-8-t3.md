# Lesson 134 - Summary Question Example and Analysis 2 (B.8 T3)
...
- giải thích mục tiêu của bài **Summary Question Example and Analysis 2 (B.8 T3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Summary Question Example and Analysis 2 (B.8 T3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
