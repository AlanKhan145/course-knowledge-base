# Lesson 150 - (Sentence Completion) Strategy Application 1 + Analysis (Cambridge 2014 T3 P1)

> Module 15: Academic Reading Specific Question Strategy and Tactics  
> Loại bài: Kiến thức và chiến lược  
...
- giải thích mục tiêu của bài **(Sentence Completion) Strategy Application 1 + Analysis (Cambridge 2014 T3 P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Sentence Completion) Strategy Application 1 + Analysis (Cambridge 2014 T3 P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
