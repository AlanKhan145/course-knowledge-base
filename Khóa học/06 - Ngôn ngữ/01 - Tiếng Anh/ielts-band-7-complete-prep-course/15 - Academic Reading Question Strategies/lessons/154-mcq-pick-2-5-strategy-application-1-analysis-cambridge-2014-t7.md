# Lesson 154 - (MCQ Pick 2-5) Strategy Application 1 + Analysis (Cambridge 2014 T7)
...
- giải thích mục tiêu của bài **(MCQ Pick 2-5) Strategy Application 1 + Analysis (Cambridge 2014 T7)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(MCQ Pick 2-5) Strategy Application 1 + Analysis (Cambridge 2014 T7)** trong module **Academic Reading Specific Question Strategy and Tactics**.
