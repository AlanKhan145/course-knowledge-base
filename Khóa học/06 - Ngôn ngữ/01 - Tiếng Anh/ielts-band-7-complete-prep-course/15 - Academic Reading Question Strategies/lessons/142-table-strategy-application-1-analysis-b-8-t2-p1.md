# Lesson 142 - (Table) Strategy Application 1 + Analysis (B.8 T2 P1)
...
- giải thích mục tiêu của bài **(Table) Strategy Application 1 + Analysis (B.8 T2 P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Table) Strategy Application 1 + Analysis (B.8 T2 P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
