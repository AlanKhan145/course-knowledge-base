# Lesson 124 - (Short Answer) Strategy Application 2 + Analysis (Cambridge Official 2014 T1)
...
- giải thích mục tiêu của bài **(Short Answer) Strategy Application 2 + Analysis (Cambridge Official 2014 T1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Short Answer) Strategy Application 2 + Analysis (Cambridge Official 2014 T1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
