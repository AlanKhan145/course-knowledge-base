# Lesson 115 - (Y-N-NG) Strategy Application 1 + Analysis (B.10 T1)
...
- giải thích mục tiêu của bài **(Y-N-NG) Strategy Application 1 + Analysis (B.10 T1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Y-N-NG) Strategy Application 1 + Analysis (B.10 T1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
