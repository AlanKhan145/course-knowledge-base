# Lesson 171 - #1 Ôn tập toàn bộ Bài đọc Phần 1 (Cambridge General Book 12 test 8)
...
- giải thích mục tiêu của bài **#1 Ôn tập toàn bộ Bài đọc Phần 1 (Cambridge General Book 12 test 8)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **#1 Ôn tập toàn bộ Bài đọc Phần 1 (Cambridge General Book 12 test 8)** trong module **Academic Reading Specific Question Strategy and Tactics**.
