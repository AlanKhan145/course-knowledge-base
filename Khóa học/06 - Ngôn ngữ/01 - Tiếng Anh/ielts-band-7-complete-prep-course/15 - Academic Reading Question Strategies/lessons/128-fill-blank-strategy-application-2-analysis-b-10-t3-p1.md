# Lesson 128 - (Fill-Blank) Strategy Application 2 + Analysis (B.10 T3 P1)
...
- giải thích mục tiêu của bài **(Fill-Blank) Strategy Application 2 + Analysis (B.10 T3 P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Fill-Blank) Strategy Application 2 + Analysis (B.10 T3 P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
