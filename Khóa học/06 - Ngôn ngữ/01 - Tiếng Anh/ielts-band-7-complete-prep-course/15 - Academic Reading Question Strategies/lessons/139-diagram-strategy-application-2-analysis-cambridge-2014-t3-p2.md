# Lesson 139 - (Diagram) Strategy Application 2 + Analysis (Cambridge 2014 T3 P2)
...
- giải thích mục tiêu của bài **(Diagram) Strategy Application 2 + Analysis (Cambridge 2014 T3 P2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Diagram) Strategy Application 2 + Analysis (Cambridge 2014 T3 P2)** trong module **Academic Reading Specific Question Strategy and Tactics**.
