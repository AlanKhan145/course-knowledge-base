# Lesson 138 - (Diagram) Strategy Application 1 + Analysis (B.8 T1 P1)
...
- giải thích mục tiêu của bài **(Diagram) Strategy Application 1 + Analysis (B.8 T1 P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Diagram) Strategy Application 1 + Analysis (B.8 T1 P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
