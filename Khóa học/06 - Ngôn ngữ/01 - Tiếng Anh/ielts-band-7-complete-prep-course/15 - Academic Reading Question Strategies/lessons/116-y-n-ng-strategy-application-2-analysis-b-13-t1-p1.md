# Lesson 116 - (Y-N-NG) Strategy Application 2 + Analysis (B.13.T1.P1)
...
- giải thích mục tiêu của bài **(Y-N-NG) Strategy Application 2 + Analysis (B.13.T1.P1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(Y-N-NG) Strategy Application 2 + Analysis (B.13.T1.P1)** trong module **Academic Reading Specific Question Strategy and Tactics**.
