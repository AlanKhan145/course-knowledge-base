# Lesson 147 - (MCQ Standard) Strategy Application 3 + Analysis (B.15 T2 P3)
...
- giải thích mục tiêu của bài **(MCQ Standard) Strategy Application 3 + Analysis (B.15 T2 P3)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **(MCQ Standard) Strategy Application 3 + Analysis (B.15 T2 P3)** trong module **Academic Reading Specific Question Strategy and Tactics**.
