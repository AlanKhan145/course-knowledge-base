# Lesson 153 - Choose 2-5 From List (Question Strategy)
...
- giải thích mục tiêu của bài **Choose 2-5 From List (Question Strategy)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Choose 2-5 From List (Question Strategy)** trong module **Academic Reading Specific Question Strategy and Tactics**.
