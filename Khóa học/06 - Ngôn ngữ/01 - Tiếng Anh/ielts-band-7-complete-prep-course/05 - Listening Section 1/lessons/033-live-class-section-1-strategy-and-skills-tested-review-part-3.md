# Lesson 033 - Live Class: Section 1 (Strategy and Skills Tested Review) Part 3
...
- giải thích mục tiêu của bài **Live Class: Section 1 (Strategy and Skills Tested Review) Part 3** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Live Class: Section 1 (Strategy and Skills Tested Review) Part 3** trong module **Chiến Lược Phần Nghe 1 (Phần 1) (Áp Dụng Cho Cả Hình Thức Tổng Quát và Học Thuật)**.
