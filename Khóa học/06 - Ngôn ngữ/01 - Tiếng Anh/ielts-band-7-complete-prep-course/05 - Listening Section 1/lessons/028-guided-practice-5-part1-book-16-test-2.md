# Lesson 028 - Guided Practice #5: (Part1) (Book 16 Test 2)
...
- giải thích mục tiêu của bài **Guided Practice #5: (Part1) (Book 16 Test 2)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Guided Practice #5: (Part1) (Book 16 Test 2)** trong module **Chiến Lược Phần Nghe 1 (Phần 1) (Áp Dụng Cho Cả Hình Thức Tổng Quát và Học Thuật)**.
