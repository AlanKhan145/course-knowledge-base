# Lesson 020 - Listening Section 1 Answer and Question Recognition
...
- giải thích mục tiêu của bài **Listening Section 1 Answer and Question Recognition** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Listening Section 1 Answer and Question Recognition** trong module **Chiến Lược Phần Nghe 1 (Phần 1) (Áp Dụng Cho Cả Hình Thức Tổng Quát và Học Thuật)**.
