# Lesson 288 - Trên máy tính : Đọc Tổng quát: True, False, Not Given
...
- giải thích mục tiêu của bài **Trên máy tính : Đọc Tổng quát: True, False, Not Given** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Trên máy tính : Đọc Tổng quát: True, False, Not Given** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
