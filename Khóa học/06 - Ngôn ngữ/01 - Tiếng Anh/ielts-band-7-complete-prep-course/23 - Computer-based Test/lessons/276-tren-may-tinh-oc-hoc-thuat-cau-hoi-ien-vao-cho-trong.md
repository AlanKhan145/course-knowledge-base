# Lesson 276 - Trên máy tính : Đọc Học thuật: Câu hỏi Điền vào chỗ trống
...
- giải thích mục tiêu của bài **Trên máy tính : Đọc Học thuật: Câu hỏi Điền vào chỗ trống** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Trên máy tính : Đọc Học thuật: Câu hỏi Điền vào chỗ trống** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
