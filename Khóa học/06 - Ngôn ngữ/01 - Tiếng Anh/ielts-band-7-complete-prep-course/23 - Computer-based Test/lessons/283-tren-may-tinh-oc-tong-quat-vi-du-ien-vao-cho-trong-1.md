# Lesson 283 - Trên máy tính : Đọc Tổng quát: Ví dụ Điền vào chỗ trống 1
...
- giải thích mục tiêu của bài **Trên máy tính : Đọc Tổng quát: Ví dụ Điền vào chỗ trống 1** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Trên máy tính : Đọc Tổng quát: Ví dụ Điền vào chỗ trống 1** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
