# Lesson 272 - Trên máy tính : Nghe: Trắc nghiệm/Nhiều khả năng lựa chọn
...
- giải thích mục tiêu của bài **Trên máy tính : Nghe: Trắc nghiệm/Nhiều khả năng lựa chọn** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Trên máy tính : Nghe: Trắc nghiệm/Nhiều khả năng lựa chọn** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
