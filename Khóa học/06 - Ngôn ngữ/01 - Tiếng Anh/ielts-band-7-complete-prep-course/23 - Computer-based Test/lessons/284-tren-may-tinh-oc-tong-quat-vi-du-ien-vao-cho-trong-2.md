# Lesson 284 - Trên máy tính : Đọc Tổng quát: Ví dụ Điền vào chỗ trống 2
...
- giải thích mục tiêu của bài **Trên máy tính : Đọc Tổng quát: Ví dụ Điền vào chỗ trống 2** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Trên máy tính : Đọc Tổng quát: Ví dụ Điền vào chỗ trống 2** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
