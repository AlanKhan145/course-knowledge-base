# Lesson 270 - Trên máy tính : Nghe: Bản đồ/Sơ đồ
...
- giải thích mục tiêu của bài **Trên máy tính : Nghe: Bản đồ/Sơ đồ** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Trên máy tính : Nghe: Bản đồ/Sơ đồ** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
