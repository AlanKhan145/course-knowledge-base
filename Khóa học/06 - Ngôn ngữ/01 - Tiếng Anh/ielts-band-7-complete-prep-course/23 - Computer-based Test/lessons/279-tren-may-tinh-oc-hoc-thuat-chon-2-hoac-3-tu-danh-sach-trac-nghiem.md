# Lesson 279 - Trên máy tính : Đọc Học thuật: Chọn 2 hoặc 3 từ Danh sách (Trắc nghiệm)
...
- giải thích mục tiêu của bài **Trên máy tính : Đọc Học thuật: Chọn 2 hoặc 3 từ Danh sách (Trắc nghiệm)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Trên máy tính : Đọc Học thuật: Chọn 2 hoặc 3 từ Danh sách (Trắc nghiệm)** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
