# Lesson 280 - Đọc Học thuật: Hoàn thành Câu
...
- giải thích mục tiêu của bài **Đọc Học thuật: Hoàn thành Câu** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Đọc Học thuật: Hoàn thành Câu** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
