# Lesson 267 - Hỏi đáp Cơ bản về Khóa học trên máy tính
...
- giải thích mục tiêu của bài **Hỏi đáp Cơ bản về Khóa học trên máy tính** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Hỏi đáp Cơ bản về Khóa học trên máy tính** trong module **Tổng quan về cách vận hành Bài thi trên máy tính**.
