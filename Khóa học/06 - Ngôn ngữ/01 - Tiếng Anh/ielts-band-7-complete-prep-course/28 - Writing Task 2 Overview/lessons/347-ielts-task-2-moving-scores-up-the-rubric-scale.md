# Lesson 347 - IELTS Task 2: Moving Scores up the Rubric Scale
...
- giải thích mục tiêu của bài **IELTS Task 2: Moving Scores up the Rubric Scale** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **IELTS Task 2: Moving Scores up the Rubric Scale** trong module **Writing IELTS Task 2 Overview (General and Academic Exam Takers)**.
