...
- giải thích mục tiêu của bài **Task 2 Vocabulary** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Task 2 Vocabulary** trong module **Writing IELTS Task 2 Overview (General and Academic Exam Takers)**.
