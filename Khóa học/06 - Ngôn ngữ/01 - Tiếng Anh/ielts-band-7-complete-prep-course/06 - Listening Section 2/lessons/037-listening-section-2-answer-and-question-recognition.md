# Lesson 037 - Listening Section 2 Answer and Question Recognition
...
- giải thích mục tiêu của bài **Listening Section 2 Answer and Question Recognition** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Listening Section 2 Answer and Question Recognition** trong module **Chiến Lược Phần Nghe 2 (Phần 2) (Áp Dụng Cho Cả Hình Thức Tổng Quát và Học Thuật)**.
