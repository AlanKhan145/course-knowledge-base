# Lesson 051 - Section 2 Map Practices 4 to 6
...
- giải thích mục tiêu của bài **Section 2 Map Practices 4 to 6** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Section 2 Map Practices 4 to 6** trong module **Chiến Lược Phần Nghe 2 (Phần 2) (Áp Dụng Cho Cả Hình Thức Tổng Quát và Học Thuật)**.
