# Lesson 052 - Section 2 Map Practices 7 to 9
...
- giải thích mục tiêu của bài **Section 2 Map Practices 7 to 9** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Section 2 Map Practices 7 to 9** trong module **Chiến Lược Phần Nghe 2 (Phần 2) (Áp Dụng Cho Cả Hình Thức Tổng Quát và Học Thuật)**.
