# Lesson 048 - Listening Map Labeling Terminology (Part 1)
...
- giải thích mục tiêu của bài **Listening Map Labeling Terminology (Part 1)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Listening Map Labeling Terminology (Part 1)** trong module **Chiến Lược Phần Nghe 2 (Phần 2) (Áp Dụng Cho Cả Hình Thức Tổng Quát và Học Thuật)**.
