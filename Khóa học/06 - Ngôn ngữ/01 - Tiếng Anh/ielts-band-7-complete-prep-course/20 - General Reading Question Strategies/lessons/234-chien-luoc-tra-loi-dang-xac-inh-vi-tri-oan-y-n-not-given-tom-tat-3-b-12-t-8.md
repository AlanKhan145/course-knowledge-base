# Lesson 234 - Chiến lược Trả lời Dạng Xác định vị trí Đoạn, Y-N-Not Given, & Tóm tắt (3) ( (B.12 T.8)
...
- giải thích mục tiêu của bài **Chiến lược Trả lời Dạng Xác định vị trí Đoạn, Y-N-Not Given, & Tóm tắt (3) ( (B.12 T.8)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Chiến lược Trả lời Dạng Xác định vị trí Đoạn, Y-N-Not Given, & Tóm tắt (3) ( (B.12 T.8)** trong module **Chiến lược Trả lời Dạng câu hỏi Cụ thể trong Đọc Tổng quát**.
