# Lesson 241 - Chiến lược và Kỹ thuật Dạng câu Ghép nối
...
- giải thích mục tiêu của bài **Chiến lược và Kỹ thuật Dạng câu Ghép nối** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Chiến lược và Kỹ thuật Dạng câu Ghép nối** trong module **Chiến lược Trả lời Dạng câu hỏi Cụ thể trong Đọc Tổng quát**.
