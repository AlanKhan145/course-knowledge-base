# Lesson 216 - Phân tích Câu hỏi Y, N, NG Phần 3 (Cambridge B.12 Test 5)
...
- giải thích mục tiêu của bài **Phân tích Câu hỏi Y, N, NG Phần 3 (Cambridge B.12 Test 5)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Phân tích Câu hỏi Y, N, NG Phần 3 (Cambridge B.12 Test 5)** trong module **Chiến lược Trả lời Dạng câu hỏi Cụ thể trong Đọc Tổng quát**.
