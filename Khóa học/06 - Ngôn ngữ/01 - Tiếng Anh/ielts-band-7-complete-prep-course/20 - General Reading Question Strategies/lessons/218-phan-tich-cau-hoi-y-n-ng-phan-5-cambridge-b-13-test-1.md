# Lesson 218 - Phân tích Câu hỏi Y, N, NG Phần 5 ((Cambridge B.13 Test 1))
...
- giải thích mục tiêu của bài **Phân tích Câu hỏi Y, N, NG Phần 5 ((Cambridge B.13 Test 1))** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Phân tích Câu hỏi Y, N, NG Phần 5 ((Cambridge B.13 Test 1))** trong module **Chiến lược Trả lời Dạng câu hỏi Cụ thể trong Đọc Tổng quát**.
