# Lesson 233 - Chiến lược Xác định vị trí Đoạn, Yes-No-Not Given, & Tóm tắt (2) ( ( (B.12 T.8)
...
- giải thích mục tiêu của bài **Chiến lược Xác định vị trí Đoạn, Yes-No-Not Given, & Tóm tắt (2) ( ( (B.12 T.8)** bằng ngôn ngữ của mình;
...
- Bối cảnh và vai trò của bài **Chiến lược Xác định vị trí Đoạn, Yes-No-Not Given, & Tóm tắt (2) ( ( (B.12 T.8)** trong module **Chiến lược Trả lời Dạng câu hỏi Cụ thể trong Đọc Tổng quát**.
