...
```mermaid
flowchart TD
    A[Numbers] --> B[Cardinal numbers<br/>Số đếm]
    A --> C[Ordinal numbers<br/>Số thứ tự]

    B --> D[0–9<br/>Đơn vị]
    B --> E[10–99<br/>Chục]
    B --> F[100<br/>Hundred]
    B --> G[1,000<br/>Thousand]
    B --> H[1,000,000<br/>Million]
...
flowchart LR
    ...
    B --> D[three hundred]
    C --> E[forty-eight]
    D --> F[three hundred and forty-eight]
    E --> F
```
...
```mermaid
flowchart LR
    A[Số cần đọc] --> B{Độ lớn}

    B -->|0–9| C[Đơn vị]
    B -->|10–99| D[Chục + đơn vị]
    B -->|100–999| E[Hundred]
    B -->|1,000+| F[Thousand]
    B -->|1,000,000+| G[Million]
