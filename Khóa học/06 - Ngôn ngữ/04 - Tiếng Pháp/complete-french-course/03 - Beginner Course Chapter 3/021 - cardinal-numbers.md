...
- [ ] Đọc số rõ ràng.
- [ ] Hỏi và trả lời giờ.
- [ ] Nói ngày, tháng và số thứ tự.

## Trọng tâm bài học

Số đếm và cách dùng trong thời gian, ngày tháng, lịch hẹn và thông tin cá nhân.
...
Viết một đoạn 80–120 từ hoặc ghi âm 1–2 phút về chủ đề **Cardinal Numbers**. Cố gắng sử dụng ít nhất 5 từ khóa mới và một cấu trúc ngữ pháp đã học ở mô-đun trước.
