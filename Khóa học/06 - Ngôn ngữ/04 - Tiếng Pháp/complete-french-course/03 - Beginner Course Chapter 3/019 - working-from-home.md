...
- [ ] Gọi tên đồ vật.
- [ ] Mô tả vị trí.
- [ ] Nói về căn phòng của mình.

## Trọng tâm bài học

Từ vựng nhà ở và cách mô tả không gian, đồ vật, vị trí và thói quen trong nhà.
...
Viết một đoạn 80–120 từ hoặc ghi âm 1–2 phút về chủ đề **Working from Home**. Cố gắng sử dụng ít nhất 5 từ khóa mới và một cấu trúc ngữ pháp đã học ở mô-đun trước.
