# 043 - Going on a Trip: Accommodation
...
- [ ] Hỏi và chỉ đường.
- [ ] Mua vé và chọn phương tiện.
- [ ] Đặt phòng hoặc xác nhận lịch trình.

## Trọng tâm bài học

Giao tiếp khi di chuyển và du lịch: hỏi đường, phương tiện, đặt chỗ và xử lý tình huống.
...
Viết một đoạn 80–120 từ hoặc ghi âm 1–2 phút về chủ đề **Going on a Trip: Accommodation**. Cố gắng sử dụng ít nhất 5 từ khóa mới và một cấu trúc ngữ pháp đã học ở mô-đun trước.
