# 033 - Past Participle for Pronominal Verbs
...
- [ ] Nhận diện chủ ngữ.
- [ ] Chia động từ thường gặp.
- [ ] Đặt câu khẳng định và phủ định.

## Trọng tâm bài học

Các động từ nền tảng và cách dùng chúng để tạo câu đơn giản ở thì hiện tại.
...
Viết một đoạn 80–120 từ hoặc ghi âm 1–2 phút về chủ đề **Past Participle for Pronominal Verbs**. Cố gắng sử dụng ít nhất 5 từ khóa mới và một cấu trúc ngữ pháp đã học ở mô-đun trước.
