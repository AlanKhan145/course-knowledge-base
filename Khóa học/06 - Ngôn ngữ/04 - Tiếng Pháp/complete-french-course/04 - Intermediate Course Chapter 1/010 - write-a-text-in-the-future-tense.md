# 010 - Write a Text in the Future Tense
...
- [ ] Dùng cấu trúc tương lai.
- [ ] Nói về kế hoạch cá nhân.
- [ ] Hỏi và trả lời về dự định.

## Trọng tâm bài học

Cách nói về kế hoạch, dự đoán, dự định và ước mơ trong tương lai.
...
Viết một đoạn 80–120 từ hoặc ghi âm 1–2 phút về chủ đề **Write a Text in the Future Tense**. Cố gắng sử dụng ít nhất 5 từ khóa mới và một cấu trúc ngữ pháp đã học ở mô-đun trước.
