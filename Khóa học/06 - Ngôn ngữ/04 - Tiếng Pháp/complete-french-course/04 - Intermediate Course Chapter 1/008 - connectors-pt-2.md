...
- [ ] Nối hai ý ngắn.
- [ ] Sắp xếp lập luận.
- [ ] Nói và viết mạch lạc hơn.

## Trọng tâm bài học

Từ nối giúp diễn đạt nguyên nhân, kết quả, đối lập, thời gian, ví dụ và kết luận.
...
Viết một đoạn 80–120 từ hoặc ghi âm 1–2 phút về chủ đề **Connectors Pt. 2**. Cố gắng sử dụng ít nhất 5 từ khóa mới và một cấu trúc ngữ pháp đã học ở mô-đun trước.
