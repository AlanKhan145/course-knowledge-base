...
## 1. Tóm tắt
Bài này tập trung vào **Vì sao phải đo lường UX?** trong lộ trình UX Design. Sau bài học, bạn nên hiểu ý nghĩa của khái niệm, biết khi nào dùng nó và tạo được một artifact nhỏ để áp dụng vào project cuối khóa.

## 2. Mục tiêu học tập
- Đo được tác động của **Vì sao phải đo lường UX?** thay vì chỉ dựa vào cảm giác.
...
- Tôi có thể giải thích **Vì sao phải đo lường UX?** cho một người mới học UX không?
...
## 7. Tổng kết
**Vì sao phải đo lường UX?** là một mảnh trong quy trình UX từ hiểu người dùng đến đo lường tác động. Hãy gắn bài học với một artifact cụ thể để kiến thức không dừng ở lý thuyết.
