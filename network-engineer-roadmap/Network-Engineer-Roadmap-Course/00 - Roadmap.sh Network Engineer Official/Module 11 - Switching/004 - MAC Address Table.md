# 004 - MAC Address Table

**Module:** Module 11 - Switching  
**Roadmap item:** Bài 23  
**Loại nội dung:** Switching  
...
Với Network Engineer, **MAC Address Table** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **MAC Address Table** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 6. Artifact nên tạo
- Switching lab plan with VLAN/STP/MAC table observations
...
## 8. Tổng kết
**MAC Address Table** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
