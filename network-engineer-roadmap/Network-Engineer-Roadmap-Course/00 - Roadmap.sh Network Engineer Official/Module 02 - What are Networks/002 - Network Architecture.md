# 002 - Network Architecture

**Module:** Module 02 - What are Networks?  
**Roadmap item:** Bài 3  
**Loại nội dung:** Network fundamentals  
...
Với Network Engineer, **Network Architecture** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **Network Architecture** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 6. Artifact nên tạo
- Network type comparison table and sample topology
...
## 8. Tổng kết
**Network Architecture** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
