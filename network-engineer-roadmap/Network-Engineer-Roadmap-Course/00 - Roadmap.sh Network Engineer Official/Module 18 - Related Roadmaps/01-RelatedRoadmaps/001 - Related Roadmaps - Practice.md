...
**Roadmap item:** Resource  
**Loại nội dung:** Related roadmaps  
...
Với Network Engineer, **Related Roadmaps** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **Related Roadmaps** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 5. Bài tập thực hành
Chọn 2 roadmap liên quan và viết kế hoạch học 30 ngày gắn với lab networking.

Sau đó viết 5-7 dòng trả lời: nếu mạng gặp lỗi, chủ đề này giúp bạn kiểm tra điều gì trước?

## 6. Artifact nên tạo
- Personal next-roadmap learning plan
...
## 8. Tổng kết
**Related Roadmaps** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
