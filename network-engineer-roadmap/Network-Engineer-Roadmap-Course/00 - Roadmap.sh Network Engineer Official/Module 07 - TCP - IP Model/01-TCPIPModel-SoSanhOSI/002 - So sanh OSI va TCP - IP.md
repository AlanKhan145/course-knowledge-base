# 002 - So sánh OSI và TCP/IP

**Module:** Module 07 - TCP/IP Model  
**Roadmap item:** Bài 10  
**Loại nội dung:** TCP/IP model  
...
Với Network Engineer, **So sánh OSI và TCP/IP** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **So sánh OSI và TCP/IP** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 6. Artifact nên tạo
- OSI vs TCP/IP comparison matrix
...
## 8. Tổng kết
**So sánh OSI và TCP/IP** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
