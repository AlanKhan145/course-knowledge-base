# 002 - Khi nào dùng QoS?

**Module:** Module 15 - QoS - Quality of Service  
**Roadmap item:** Bài 31  
**Loại nội dung:** Quality of Service  
...
Với Network Engineer, **Khi nào dùng QoS?** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **Khi nào dùng QoS?** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 6. Artifact nên tạo
- QoS policy sketch and traffic prioritization matrix
...
## 8. Tổng kết
**Khi nào dùng QoS?** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
