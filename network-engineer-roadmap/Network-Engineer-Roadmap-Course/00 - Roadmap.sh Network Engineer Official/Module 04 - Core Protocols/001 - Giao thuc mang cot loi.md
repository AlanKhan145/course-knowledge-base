# 001 - Giao thức mạng cốt lõi

**Module:** Module 04 - Core Protocols  
**Roadmap item:** Bài 5  
**Loại nội dung:** Core protocols  
...
Với Network Engineer, **Giao thức mạng cốt lõi** cần được gắn với topology, packet flow, security, reliability và khả năng troubleshooting. Mục tiêu không chỉ là thuộc khái niệm, mà là dùng nó để thiết kế hoặc xử lý sự cố mạng tốt hơn.

## 2. Mục tiêu học tập
- Giải thích được **Giao thức mạng cốt lõi** bằng ngôn ngữ rõ ràng cho engineer, IT support hoặc stakeholder kỹ thuật.
...
## 6. Artifact nên tạo
- Protocol cheat sheet and port/service map
...
## 8. Tổng kết
**Giao thức mạng cốt lõi** là một phần trong năng lực thiết kế và vận hành mạng. Hãy biến bài học thành lab note, sơ đồ, checklist hoặc báo cáo troubleshooting có thể đưa vào portfolio Network Engineer.
