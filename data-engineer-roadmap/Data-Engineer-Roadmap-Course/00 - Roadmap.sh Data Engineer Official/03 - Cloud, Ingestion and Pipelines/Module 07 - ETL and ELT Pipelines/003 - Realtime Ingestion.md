# 003 - Realtime Ingestion

**Hoc phan:** 03 - Cloud, Ingestion and Pipelines
**Module:** Module 07 - ETL and ELT Pipelines
**Nhom noi dung:** Ingestion Types
**Nguon roadmap:** ETL and ELT Pipelines / Ingestion Types
**Loai bai:** lesson
...
Bai nay giai thich **Realtime Ingestion** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Realtime Ingestion bang ngon ngu cua ban.
...
- Realtime Ingestion is part of the Ingestion Types topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining Realtime Ingestion.
