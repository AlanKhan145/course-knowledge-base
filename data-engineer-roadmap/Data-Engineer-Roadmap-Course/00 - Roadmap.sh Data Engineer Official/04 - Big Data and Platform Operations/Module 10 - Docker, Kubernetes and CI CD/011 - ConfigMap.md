...
Bai nay giai thich **ConfigMap** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc ConfigMap bang ngon ngu cua ban.
...
- ConfigMap is part of the Kubernetes topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining ConfigMap.
