...
Bai nay giai thich **Apache Kafka** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Apache Kafka bang ngon ngu cua ban.
...
- Kafka is a distributed event streaming platform built around topics, partitions and consumer groups.
- It is useful when events must be processed continuously or replayed by multiple consumers.
- Design Kafka pipelines around schemas, offsets, retention, idempotency and monitoring.
