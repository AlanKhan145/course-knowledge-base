...
**Nhom noi dung:** Messaging Tools
**Nguon roadmap:** Streaming and Messaging Systems / Messaging Tools
**Loai bai:** cloud
...
Bai nay giai thich **AWS SNS** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc AWS SNS bang ngon ngu cua ban.
...
- AWS SNS is part of the Messaging Tools topic in the Data Engineer roadmap.
