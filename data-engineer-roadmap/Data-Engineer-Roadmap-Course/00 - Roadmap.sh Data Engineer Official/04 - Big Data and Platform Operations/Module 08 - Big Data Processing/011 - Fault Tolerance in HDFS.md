# 011 - Fault Tolerance in HDFS

**Hoc phan:** 04 - Big Data and Platform Operations
**Module:** Module 08 - Big Data Processing
**Nhom noi dung:** Hadoop Ecosystem
**Nguon roadmap:** Big Data Processing / Hadoop Ecosystem
**Loai bai:** big data
...
Bai nay giai thich **Fault Tolerance in HDFS** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Fault Tolerance in HDFS bang ngon ngu cua ban.
...
- Fault Tolerance in HDFS is part of the Hadoop Ecosystem topic in the Data Engineer roadmap.
