...
Bai nay giai thich **Kubernetes for Compute** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Kubernetes for Compute bang ngon ngu cua ban.
...
- Kubernetes for Compute is part of the Cluster Computing topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining Kubernetes for Compute.
