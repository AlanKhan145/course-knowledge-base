# 006 - Apache Hadoop YARN

**Hoc phan:** 04 - Big Data and Platform Operations
**Module:** Module 08 - Big Data Processing
**Nhom noi dung:** Cluster Computing
**Nguon roadmap:** Big Data Processing / Cluster Computing
**Loai bai:** big data
...
Bai nay giai thich **Apache Hadoop YARN** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Apache Hadoop YARN bang ngon ngu cua ban.
...
- Apache Hadoop YARN is part of the Cluster Computing topic in the Data Engineer roadmap.
