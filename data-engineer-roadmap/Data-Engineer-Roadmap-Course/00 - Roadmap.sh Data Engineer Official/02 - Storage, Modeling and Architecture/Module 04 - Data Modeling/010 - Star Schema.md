...
Bai nay giai thich **Star Schema** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Star Schema bang ngon ngu cua ban.
...
- Star Schema is part of the Dimensional Modeling topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining Star Schema.
