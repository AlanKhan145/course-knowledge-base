# 015 - Sales Analytics Model

**Hoc phan:** 02 - Storage, Modeling and Architecture
**Module:** Module 04 - Data Modeling
**Nhom noi dung:** Dimensional Modeling
**Nguon roadmap:** Data Modeling / Dimensional Modeling
...
Bai nay giai thich **Sales Analytics Model** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Sales Analytics Model bang ngon ngu cua ban.
...
- Sales Analytics Model is part of the Dimensional Modeling topic in the Data Engineer roadmap.
- Always define grain before choosing facts, dimensions and keys.
- Model from business questions backward, not from source tables forward.
...
1. Write a 5-line note explaining Sales Analytics Model.
