# 018 - Lakehouse Architecture

**Hoc phan:** 02 - Storage, Modeling and Architecture
**Module:** Module 05 - Data Warehouse and Data Lake
**Nhom noi dung:** Lakehouse and Modern Architecture
**Nguon roadmap:** Data Warehouse and Data Lake / Lakehouse and Modern Architecture
...
Bai nay giai thich **Lakehouse Architecture** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Lakehouse Architecture bang ngon ngu cua ban.
...
- A lakehouse combines data lake storage with warehouse-like reliability and table management.
- It often uses open table formats, ACID transactions, schema evolution and metadata layers.
- The goal is to reduce duplicate storage while serving BI, ML and batch processing.

## 4. Thuc hanh

1. Write a 5-line note explaining Lakehouse Architecture.
