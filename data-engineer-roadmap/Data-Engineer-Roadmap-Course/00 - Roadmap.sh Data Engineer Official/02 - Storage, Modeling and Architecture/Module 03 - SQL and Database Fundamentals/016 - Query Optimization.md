# 016 - Query Optimization

**Hoc phan:** 02 - Storage, Modeling and Architecture
**Module:** Module 03 - SQL and Database Fundamentals
**Nhom noi dung:** Relational Database Fundamentals
**Nguon roadmap:** SQL and Database Fundamentals / Relational Database Fundamentals
...
Bai nay giai thich **Query Optimization** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Query Optimization bang ngon ngu cua ban.
...
- Query Optimization is part of the Relational Database Fundamentals topic in the Data Engineer roadmap.
- Connect the concept to correctness, performance and operational safety.
- Use EXPLAIN plans and small schemas to see behavior instead of guessing.
...
1. Write a 5-line note explaining Query Optimization.
