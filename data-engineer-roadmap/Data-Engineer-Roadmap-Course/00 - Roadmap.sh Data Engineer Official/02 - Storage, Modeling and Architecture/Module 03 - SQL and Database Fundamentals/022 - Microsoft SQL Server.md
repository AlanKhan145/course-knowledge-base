# 022 - Microsoft SQL Server

**Hoc phan:** 02 - Storage, Modeling and Architecture
**Module:** Module 03 - SQL and Database Fundamentals
**Nhom noi dung:** Relational Database Tools
**Nguon roadmap:** SQL and Database Fundamentals / Relational Database Tools
...
Bai nay giai thich **Microsoft SQL Server** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Microsoft SQL Server bang ngon ngu cua ban.
...
- Microsoft SQL Server is part of the Relational Database Tools topic in the Data Engineer roadmap.
...
2. Write one query that demonstrates Microsoft SQL Server.
