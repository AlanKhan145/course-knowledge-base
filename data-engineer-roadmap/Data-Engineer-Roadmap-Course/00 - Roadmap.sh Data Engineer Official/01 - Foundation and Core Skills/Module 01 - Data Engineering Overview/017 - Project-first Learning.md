# 017 - Project-first Learning

**Hoc phan:** 01 - Foundation and Core Skills
**Module:** Module 01 - Data Engineering Overview
**Nhom noi dung:** Roadmap Strategy
**Nguon roadmap:** Data Engineering Overview / Roadmap Strategy
**Loai bai:** project
...
Bai nay giai thich **Project-first Learning** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Project-first Learning bang ngon ngu cua ban.
...
- Project-first Learning is part of the Roadmap Strategy topic in the Data Engineer roadmap.
