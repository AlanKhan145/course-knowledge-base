# 046 - Scale Up vs Scale Out

**Hoc phan:** 01 - Foundation and Core Skills
**Module:** Module 02 - Programming Foundation
**Nhom noi dung:** Distributed Systems Basics
**Nguon roadmap:** Programming Foundation / Distributed Systems Basics
**Loai bai:** lesson
...
Bai nay giai thich **Scale Up vs Scale Out** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Scale Up vs Scale Out bang ngon ngu cua ban.
...
- Scale Up vs Scale Out is part of the Distributed Systems Basics topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining Scale Up vs Scale Out.
