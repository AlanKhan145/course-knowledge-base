# 031 - Shell Navigation

**Hoc phan:** 01 - Foundation and Core Skills
**Module:** Module 02 - Programming Foundation
**Nhom noi dung:** Linux Basics
**Nguon roadmap:** Programming Foundation / Linux Basics
**Loai bai:** lesson
...
Bai nay giai thich **Shell Navigation** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Shell Navigation bang ngon ngu cua ban.
...
- Shell Navigation is part of the Linux Basics topic in the Data Engineer roadmap.
...
1. Write a 5-line note explaining Shell Navigation.
