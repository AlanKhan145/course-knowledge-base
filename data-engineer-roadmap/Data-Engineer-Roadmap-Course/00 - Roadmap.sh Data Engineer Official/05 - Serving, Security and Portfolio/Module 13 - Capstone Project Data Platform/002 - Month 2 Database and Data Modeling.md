# 002 - Month 2 Database and Data Modeling
...
Bai nay giai thich **Month 2 Database and Data Modeling** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Month 2 Database and Data Modeling bang ngon ngu cua ban.
...
- Month 2 Database and Data Modeling is part of the Six Month Roadmap topic in the Data Engineer roadmap.
...
- Document grain, keys, expected columns and downstream consumers.
