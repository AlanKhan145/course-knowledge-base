# 022 - Data Quality Report

**Hoc phan:** 05 - Serving, Security and Portfolio
**Module:** Module 13 - Capstone Project Data Platform
**Nhom noi dung:** Capstone Deliverables
**Nguon roadmap:** Capstone Project Data Platform / Capstone Deliverables
**Loai bai:** project
...
Bai nay giai thich **Data Quality Report** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Data Quality Report bang ngon ngu cua ban.
...
- Data Quality Report is part of the Capstone Deliverables topic in the Data Engineer roadmap.
...
- Turn the concept into a repeatable check that can fail a pipeline before bad data is served.
