...
**Nhom noi dung:** Core Security
**Nguon roadmap:** Security and Data Governance / Core Security
**Loai bai:** security
...
Bai nay giai thich **Authentication vs Authorization** trong boi canh Data Engineer Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong pipeline, anh huong den storage/processing/serving nhu the nao va co the bien thanh artifact trong portfolio.

## 2. Muc tieu hoc tap

- Giai thich duoc Authentication vs Authorization bang ngon ngu cua ban.
...
- Authentication vs Authorization is part of the Core Security topic in the Data Engineer roadmap.
- Security decisions should be visible in architecture, code, cloud configuration and documentation.
- Limit access by role, encrypt sensitive data and avoid leaking secrets into logs.
