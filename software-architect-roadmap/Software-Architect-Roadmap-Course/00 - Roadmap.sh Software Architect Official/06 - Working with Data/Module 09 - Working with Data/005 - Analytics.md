...
Bai nay giai thich **Analytics** trong boi canh Software Architecture hien dai. Sau bai hoc, ban nen nam khai niem, biet vi sao no quan trong doi voi Architect va co mot bai tap nho de ap dung.

Analytics tren du lieu gom descriptive, diagnostic, predictive va prescriptive. Architect phai thiet ke data pipeline va reporting layer phu hop.

## 2. Muc tieu hoc tap

- Giai thich duoc **Analytics** bang ngon ngu cua ban trong 1-2 phut.
- Nhan biet khi nao kien thuc nay anh huong den quyet dinh kien truc.
- Thuc hanh vi du nho va ghi lai cac diem can luu y.

## 3. Khai niem chinh

- BI tools: Tableau, Power BI, Looker cho visualization
- Apache Spark va Hadoop cho large-scale analytics
- Data Lake vs Data Warehouse: raw data vs processed data
- Real-time analytics: Kafka Streams, Apache Flink

## 4. Vi du / Demo

```text
Tinh huong: Ban dang thiet ke mot he thong moi va can quyet dinh ve Analytics.
...
- Toi co the giai thich **Analytics** trong 1-2 phut khong can nhin tai lieu.
...
**Analytics** la mot kiem kien thuc quan trong trong hanh trang cua Software Architect. Hay bien no thanh vi du cu the, so do hoac checklist de kien thuc co cho bam vung trong thuc te.
