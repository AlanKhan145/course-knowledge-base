...
Bai nay giai thich **GraphQL** trong boi canh Software Architecture hien dai. Sau bai hoc, ban nen nam khai niem, biet vi sao no quan trong doi voi Architect va co mot bai tap nho de ap dung.

GraphQL la query language cho API, cho phep client yeu cau chinh xac data no can, giam over-fetching va under-fetching.

## 2. Muc tieu hoc tap

- Giai thich duoc **GraphQL** bang ngon ngu cua ban trong 1-2 phut.
- Nhan biet khi nao kien thuc nay anh huong den quyet dinh kien truc.
- Thuc hanh vi du nho va ghi lai cac diem can luu y.

## 3. Khai niem chinh

- Schema-first: dinh nghia types va queries trong SDL
- Resolver function xu ly moi field trong query
- N+1 problem can giai quyet bang DataLoader (batching)
- Phu hop cho complex UIs voi nhieu data requirements khac nhau

## 4. Vi du / Demo

```text
Tinh huong: Ban dang thiet ke mot he thong moi va can quyet dinh ve GraphQL.
...
- Toi co the giai thich **GraphQL** trong 1-2 phut khong can nhin tai lieu.
...
**GraphQL** la mot kiem kien thuc quan trong trong hanh trang cua Software Architect. Hay bien no thanh vi du cu the, so do hoac checklist de kien thuc co cho bam vung trong thuc te.
