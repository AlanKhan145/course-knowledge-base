# 036 - Procedures and Functions

**Hoc phan:** 01 - RDBMS Foundations and SQL
**Module:** Module 04 - Learn SQL
**Nhom noi dung:** Advanced SQL Topics
**Nguon roadmap:** Learn SQL / Advanced SQL Topics
...
Bai nay giai thich **Procedures and Functions** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Procedures and Functions bang ngon ngu cua ban.
...
- Procedures and Functions is part of the Advanced SQL Topics topic in the PostgreSQL DBA roadmap.
- Advanced SQL is a DBA tool for investigation, migration and safe operations.
- Write small examples before using the pattern in production migrations.
