# 001 - What are Relational Databases?

**Hoc phan:** 01 - RDBMS Foundations and SQL
**Module:** Module 01 - Introduction to PostgreSQL DBA
**Nhom noi dung:** Introduction
**Nguon roadmap:** Introduction to PostgreSQL DBA / Introduction
**Loai bai:** lesson
...
Bai nay giai thich **What are Relational Databases?** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc What are Relational Databases? bang ngon ngu cua ban.
...
- Relational databases organize data into relations, commonly represented as tables with rows and columns.
- They are built around schemas, constraints and SQL queries.
- A DBA must understand both the logical model and the physical system running underneath it.

## 4. Thuc hanh

1. Write a 5-line note explaining What are Relational Databases?.
