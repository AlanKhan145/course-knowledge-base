# 013 - PostgreSQL Community

**Hoc phan:** 01 - RDBMS Foundations and SQL
**Module:** Module 01 - Introduction to PostgreSQL DBA
**Nhom noi dung:** Roadmap Context
**Nguon roadmap:** Introduction to PostgreSQL DBA / Roadmap Context
**Loai bai:** lesson
...
Bai nay giai thich **PostgreSQL Community** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc PostgreSQL Community bang ngon ngu cua ban.
...
- PostgreSQL Community is part of the Roadmap Context topic in the PostgreSQL DBA roadmap.
...
1. Write a 5-line note explaining PostgreSQL Community.
