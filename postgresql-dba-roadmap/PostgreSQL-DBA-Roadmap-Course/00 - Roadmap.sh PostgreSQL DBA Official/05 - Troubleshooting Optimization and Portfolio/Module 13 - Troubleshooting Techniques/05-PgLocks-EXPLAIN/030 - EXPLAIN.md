...
Bai nay giai thich **EXPLAIN** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc EXPLAIN bang ngon ngu cua ban.
...
- EXPLAIN shows the query plan PostgreSQL chooses.
- EXPLAIN ANALYZE runs the query and reports actual execution behavior.
- DBAs use it to compare estimates, join strategies, index usage, buffers and plan regressions.
