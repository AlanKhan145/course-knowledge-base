# 008 - Function on Indexed Column
...
Bai nay giai thich **Function on Indexed Column** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Function on Indexed Column bang ngon ngu cua ban.
...
- Function on Indexed Column is part of the Design Patterns and Antipatterns topic in the PostgreSQL DBA roadmap.
