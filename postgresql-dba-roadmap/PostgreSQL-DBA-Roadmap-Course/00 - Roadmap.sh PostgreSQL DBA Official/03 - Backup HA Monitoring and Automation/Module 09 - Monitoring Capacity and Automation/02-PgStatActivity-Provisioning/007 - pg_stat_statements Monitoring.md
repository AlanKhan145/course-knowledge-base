# 007 - pg_stat_statements Monitoring
...
Bai nay giai thich **pg_stat_statements Monitoring** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc pg_stat_statements Monitoring bang ngon ngu cua ban.
...
- pg_stat_statements Monitoring is part of the Monitoring Tools topic in the PostgreSQL DBA roadmap.
- Monitoring should answer operational questions, not just display many graphs.
- Every alert needs a threshold, owner and runbook.
