# 006 - Autovacuum Per Table

**Hoc phan:** 04 - Internals Tuning and Application Patterns
**Module:** Module 12 - Fine-Grained Tuning
**Nhom noi dung:** Fine-Grained Settings
**Nguon roadmap:** Fine-Grained Tuning / Fine-Grained Settings
**Loai bai:** tuning
...
Bai nay giai thich **Autovacuum Per Table** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Autovacuum Per Table bang ngon ngu cua ban.
...
- Autovacuum Per Table is part of the Fine-Grained Settings topic in the PostgreSQL DBA roadmap.
