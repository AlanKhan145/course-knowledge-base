# 022 - log_min_duration_statement
...
Bai nay giai thich **log_min_duration_statement** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc log_min_duration_statement bang ngon ngu cua ban.
...
- log_min_duration_statement is part of the Operational Configuration topic in the PostgreSQL DBA roadmap.
