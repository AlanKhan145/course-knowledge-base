...
Bai nay giai thich **effective_cache_size** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc effective_cache_size bang ngon ngu cua ban.
...
- effective_cache_size is part of the Core Config Areas topic in the PostgreSQL DBA roadmap.
...
1. Write a 5-line note explaining effective_cache_size.
