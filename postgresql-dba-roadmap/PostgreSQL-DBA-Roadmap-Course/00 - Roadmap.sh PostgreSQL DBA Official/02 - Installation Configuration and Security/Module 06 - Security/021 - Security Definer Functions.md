# 021 - Security Definer Functions

**Hoc phan:** 02 - Installation Configuration and Security
**Module:** Module 06 - Security
**Nhom noi dung:** Advanced Security
**Nguon roadmap:** Security / Advanced Security
**Loai bai:** security
...
Bai nay giai thich **Security Definer Functions** trong boi canh PostgreSQL DBA Roadmap 2026. Sau bai hoc, ban nen biet topic nay nam o dau trong van hanh PostgreSQL, lien quan den SQL, cau hinh, bao mat, backup, HA, monitoring, tuning hoac troubleshooting nhu the nao.

## 2. Muc tieu hoc tap

- Giai thich duoc Security Definer Functions bang ngon ngu cua ban.
...
- Security Definer Functions is part of the Advanced Security topic in the PostgreSQL DBA roadmap.
