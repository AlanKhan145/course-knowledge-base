# 004 - Thiết kế packet format

**Module:** Module 08 - Serialization & Network Protocol Design
**Roadmap item:** Bài 30
...
## 1. Tóm tắt
Nội dung này tập trung vào **Thiết kế packet format** trong lộ trình Server-Side Game Developer. Sau phần này, bạn nên hiểu vai trò của chủ đề trong game backend và tạo được một artifact kỹ thuật nhỏ.

## 2. Mục tiêu học tập
- Giải thích được **Thiết kế packet format** trong luồng kết nối client-server của game online.
...
- Tôi có thể giải thích **Thiết kế packet format** trong kiến trúc game backend không?
...
## 7. Tổng kết
**Thiết kế packet format** nên được học bằng cách thiết kế, code thử, đo đạc và ghi lại trade-off. Hãy biến bài học thành một demo, diagram hoặc README có thể review.
