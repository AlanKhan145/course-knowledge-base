# 002 - Chọn protocol cho từng hệ thống game

**Module:** Module 05 - TCP vs UDP
**Roadmap item:** Bài 15
...
## 1. Tóm tắt
Nội dung này tập trung vào **Chọn protocol cho từng hệ thống game** trong lộ trình Server-Side Game Developer. Sau phần này, bạn nên hiểu vai trò của chủ đề trong game backend và tạo được một artifact kỹ thuật nhỏ.

## 2. Mục tiêu học tập
- Giải thích được **Chọn protocol cho từng hệ thống game** trong luồng kết nối client-server của game online.
...
- Tôi có thể giải thích **Chọn protocol cho từng hệ thống game** trong kiến trúc game backend không?
...
## 7. Tổng kết
**Chọn protocol cho từng hệ thống game** nên được học bằng cách thiết kế, code thử, đo đạc và ghi lại trade-off. Hãy biến bài học thành một demo, diagram hoặc README có thể review.
